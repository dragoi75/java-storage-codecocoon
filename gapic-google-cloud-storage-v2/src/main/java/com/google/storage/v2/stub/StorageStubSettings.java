...
public class StorageStubSettings extends StubSettings<StorageStubSettings> {
    ...
    private final PagedCallSettings<ListBucketsRequest, ListBucketsResponse, ListBucketsPagedResponse> listBucketsSettings;
    ...
    private final PagedCallSettings<ListNotificationsRequest, ListNotificationsResponse, ListNotificationsPagedResponse> listNotificationsSettings;
    ...
    private final PagedCallSettings<ListObjectsRequest, ListObjectsResponse, ListObjectsPagedResponse> listObjectsSettings;
    ...
    private final PagedCallSettings<ListHmacKeysRequest, ListHmacKeysResponse, ListHmacKeysPagedResponse> listHmacKeysSettings;
    ...
    private static final PagedListDescriptor<ListBucketsRequest, ListBucketsResponse, Bucket> LIST_BUCKETS_PAGE_STR_DESC = new PagedListDescriptor<ListBucketsRequest, ListBucketsResponse, Bucket>() {
        ...
        public Iterable<Bucket> extractResources(ListBucketsResponse payload) {
            return null == payload.getBucketsList() ? ImmutableList.<Bucket>of() : payload.getBucketsList();
        }
    };
    ...
    private static final PagedListDescriptor<ListNotificationsRequest, ListNotificationsResponse, Notification> LIST_NOTIFICATIONS_PAGE_STR_DESC = new PagedListDescriptor<ListNotificationsRequest, ListNotificationsResponse, Notification>() {
        ...
        public Iterable<Notification> extractResources(ListNotificationsResponse payload) {
            return null == payload.getNotificationsList() ? ImmutableList.<Notification>of() : payload.getNotificationsList();
        }
    };
    ...
    private static final PagedListDescriptor<ListObjectsRequest, ListObjectsResponse, Object> LIST_OBJECTS_PAGE_STR_DESC = new PagedListDescriptor<ListObjectsRequest, ListObjectsResponse, Object>() {
        ...
        public Iterable<Object> extractResources(ListObjectsResponse payload) {
            return null == payload.getObjectsList() ? ImmutableList.<Object>of() : payload.getObjectsList();
        }
    };
    ...
    private static final PagedListDescriptor<ListHmacKeysRequest, ListHmacKeysResponse, HmacKeyMetadata> LIST_HMAC_KEYS_PAGE_STR_DESC = new PagedListDescriptor<ListHmacKeysRequest, ListHmacKeysResponse, HmacKeyMetadata>() {
        ...
        public Iterable<HmacKeyMetadata> extractResources(ListHmacKeysResponse payload) {
            return null == payload.getHmacKeysList() ? ImmutableList.<HmacKeyMetadata>of() : payload.getHmacKeysList();
        }
    };

    private static final PagedListResponseFactory<ListBucketsRequest, ListBucketsResponse, ListBucketsPagedResponse> LIST_BUCKETS_PAGE_STR_FACT = new PagedListResponseFactory<ListBucketsRequest, ListBucketsResponse, ListBucketsPagedResponse>() {

        @Override
        public ApiFuture<ListBucketsPagedResponse> getFuturePagedResponse(UnaryCallable<ListBucketsRequest, ListBucketsResponse> callable, ListBucketsRequest request, ApiCallContext context, ApiFuture<ListBucketsResponse> futureResponse) {
    ...
    private static final PagedListResponseFactory<ListNotificationsRequest, ListNotificationsResponse, ListNotificationsPagedResponse> LIST_NOTIFICATIONS_PAGE_STR_FACT = new PagedListResponseFactory<ListNotificationsRequest, ListNotificationsResponse, ListNotificationsPagedResponse>() {

        @Override
        public ApiFuture<ListNotificationsPagedResponse> getFuturePagedResponse(UnaryCallable<ListNotificationsRequest, ListNotificationsResponse> callable, ListNotificationsRequest request, ApiCallContext context, ApiFuture<ListNotificationsResponse> futureResponse) {
            PageContext<ListNotificationsRequest, ListNotificationsResponse, Notification> pageContext = PageContext.create(callable, LIST_NOTIFICATIONS_PAGE_STR_DESC, request, context);
            return ListNotificationsPagedResponse.createAsync(pageContext, futureResponse);
        }
    };

    private static final PagedListResponseFactory<ListObjectsRequest, ListObjectsResponse, ListObjectsPagedResponse> LIST_OBJECTS_PAGE_STR_FACT = new PagedListResponseFactory<ListObjectsRequest, ListObjectsResponse, ListObjectsPagedResponse>() {

        @Override
        public ApiFuture<ListObjectsPagedResponse> getFuturePagedResponse(UnaryCallable<ListObjectsRequest, ListObjectsResponse> callable, ListObjectsRequest request, ApiCallContext context, ApiFuture<ListObjectsResponse> futureResponse) {
    ...
    private static final PagedListResponseFactory<ListHmacKeysRequest, ListHmacKeysResponse, ListHmacKeysPagedResponse> LIST_HMAC_KEYS_PAGE_STR_FACT = new PagedListResponseFactory<ListHmacKeysRequest, ListHmacKeysResponse, ListHmacKeysPagedResponse>() {

        @Override
        public ApiFuture<ListHmacKeysPagedResponse> getFuturePagedResponse(UnaryCallable<ListHmacKeysRequest, ListHmacKeysResponse> callable, ListHmacKeysRequest request, ApiCallContext context, ApiFuture<ListHmacKeysResponse> futureResponse) {
            PageContext<ListHmacKeysRequest, ListHmacKeysResponse, HmacKeyMetadata> pageContext = PageContext.create(callable, LIST_HMAC_KEYS_PAGE_STR_DESC, request, context);
    ...
    public static class Builder extends StubSettings.Builder<StorageStubSettings, Builder> {
        ...
        private final PagedCallSettings.Builder<ListBucketsRequest, ListBucketsResponse, ListBucketsPagedResponse> listBucketsSettings;
        ...
        private final PagedCallSettings.Builder<ListNotificationsRequest, ListNotificationsResponse, ListNotificationsPagedResponse> listNotificationsSettings;
        ...
        private final PagedCallSettings.Builder<ListObjectsRequest, ListObjectsResponse, ListObjectsPagedResponse> listObjectsSettings;
        ...
        private final PagedCallSettings.Builder<ListHmacKeysRequest, ListHmacKeysResponse, ListHmacKeysPagedResponse> listHmacKeysSettings;
        ...
        static {
            ...
            definitions.put("retry_policy_0_codes", ImmutableSet.copyOf(Lists.<StatusCode.Code>newArrayList(StatusCode.Code.DEADLINE_EXCEEDED, StatusCode.Code.UNAVAILABLE)));
        ...
        static {
            ...
            settings = RetrySettings.newBuilder().setInitialRetryDelay(Duration.ofMillis(1000L)).setRetryDelayMultiplier(2.0).setMaxRetryDelay(Duration.ofMillis(60000L)).setInitialRpcTimeout(Duration.ofMillis(60000L)).setRpcTimeoutMultiplier(1.0).setMaxRpcTimeout(Duration.ofMillis(60000L)).setTotalTimeout(Duration.ofMillis(60000L)).build();
        ...
        private static Builder initDefaults(Builder builder) {
            builder.deleteBucketSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.getBucketSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.createBucketSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.listBucketsSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.lockBucketRetentionPolicySettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            ...
            builder.setIamPolicySettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.testIamPermissionsSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.updateBucketSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.deleteNotificationSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.getNotificationSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.createNotificationSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.listNotificationsSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.composeObjectSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.deleteObjectSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.getObjectSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.readObjectSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.updateObjectSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.listObjectsSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.rewriteObjectSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.startResumableWriteSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.queryWriteStatusSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.getServiceAccountSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.createHmacKeySettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.deleteHmacKeySettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.getHmacKeySettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.listHmacKeysSettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            builder.updateHmacKeySettings().setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes")).setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"));
            return builder;
        }
