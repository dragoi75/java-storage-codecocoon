...
public class StorageClient implements BackgroundResource {
    ...
    public final void deleteBucket(BucketName name) {
        DeleteBucketRequest request = DeleteBucketRequest.newBuilder().setName(null == name ? null : name.toString()).build();
    ...
    public final Bucket getBucket(BucketName name) {
        GetBucketRequest request = GetBucketRequest.newBuilder().setName(null == name ? null : name.toString()).build();
    ...
    public final Bucket createBucket(ProjectName parent, Bucket bucket, String bucketId) {
        CreateBucketRequest request = CreateBucketRequest.newBuilder().setParent(null == parent ? null : parent.toString()).setBucket(bucket).setBucketId(bucketId).build();
    ...
    public final ListBucketsPagedResponse listBuckets(ProjectName parent) {
        ListBucketsRequest request = ListBucketsRequest.newBuilder().setParent(null == parent ? null : parent.toString()).build();
    ...
    public final Bucket lockBucketRetentionPolicy(BucketName bucket) {
        LockBucketRetentionPolicyRequest request = LockBucketRetentionPolicyRequest.newBuilder().setBucket(null == bucket ? null : bucket.toString()).build();
    ...
    public final Policy getIamPolicy(ResourceName resource) {
        GetIamPolicyRequest request = GetIamPolicyRequest.newBuilder().setResource(null == resource ? null : resource.toString()).build();
    ...
    public final Policy setIamPolicy(ResourceName resource, Policy policy) {
        SetIamPolicyRequest request = SetIamPolicyRequest.newBuilder().setResource(null == resource ? null : resource.toString()).setPolicy(policy).build();
    ...
    public final TestIamPermissionsResponse testIamPermissions(ResourceName resource, List<String> permissions) {
        TestIamPermissionsRequest request = TestIamPermissionsRequest.newBuilder().setResource(null == resource ? null : resource.toString()).addAllPermissions(permissions).build();
    ...
    public final void deleteNotification(NotificationName name) {
        DeleteNotificationRequest request = DeleteNotificationRequest.newBuilder().setName(null == name ? null : name.toString()).build();
    ...
    public final void deleteNotification(String name) {
        DeleteNotificationRequest request = DeleteNotificationRequest.newBuilder().setName(name).build();
        deleteNotification(request);
    }
    ...
    public final Notification getNotification(BucketName name) {
        GetNotificationRequest request = GetNotificationRequest.newBuilder().setName(null == name ? null : name.toString()).build();
    ...
    public final Notification createNotification(ProjectName parent, Notification notification) {
        CreateNotificationRequest request = CreateNotificationRequest.newBuilder().setParent(null == parent ? null : parent.toString()).setNotification(notification).build();
    ...
    public final Notification createNotification(String parent, Notification notification) {
        CreateNotificationRequest request = CreateNotificationRequest.newBuilder().setParent(parent).setNotification(notification).build();
        return createNotification(request);
    }
    ...
    public final ListNotificationsPagedResponse listNotifications(ProjectName parent) {
        ListNotificationsRequest request = ListNotificationsRequest.newBuilder().setParent(null == parent ? null : parent.toString()).build();
    ...
    public final ListObjectsPagedResponse listObjects(ProjectName parent) {
        ListObjectsRequest request = ListObjectsRequest.newBuilder().setParent(null == parent ? null : parent.toString()).build();
    ...
    public final ServiceAccount getServiceAccount(ProjectName project) {
        GetServiceAccountRequest request = GetServiceAccountRequest.newBuilder().setProject(null == project ? null : project.toString()).build();
    ...
    public final CreateHmacKeyResponse createHmacKey(ProjectName project, String serviceAccountEmail) {
        CreateHmacKeyRequest request = CreateHmacKeyRequest.newBuilder().setProject(null == project ? null : project.toString()).setServiceAccountEmail(serviceAccountEmail).build();
    ...
    public final void deleteHmacKey(String accessId, ProjectName project) {
        DeleteHmacKeyRequest request = DeleteHmacKeyRequest.newBuilder().setAccessId(accessId).setProject(null == project ? null : project.toString()).build();
    ...
    public final HmacKeyMetadata getHmacKey(String accessId, ProjectName project) {
        GetHmacKeyRequest request = GetHmacKeyRequest.newBuilder().setAccessId(accessId).setProject(null == project ? null : project.toString()).build();
    ...
    public final ListHmacKeysPagedResponse listHmacKeys(ProjectName project) {
        ListHmacKeysRequest request = ListHmacKeysRequest.newBuilder().setProject(null == project ? null : project.toString()).build();
    ...
    public static class ListBucketsPagedResponse extends AbstractPagedListResponse<ListBucketsRequest, ListBucketsResponse, Bucket, ListBucketsPage, ListBucketsFixedSizeCollection> {
        ...
        public static ApiFuture<ListBucketsPagedResponse> createAsync(PageContext<ListBucketsRequest, ListBucketsResponse, Bucket> context, ApiFuture<ListBucketsResponse> futureResponse) {
            ...
            return ApiFutures.transform(futurePage, input -> new ListBucketsPagedResponse(input), MoreExecutors.directExecutor());
        }
    ...
    public static class ListNotificationsPagedResponse extends AbstractPagedListResponse<ListNotificationsRequest, ListNotificationsResponse, Notification, ListNotificationsPage, ListNotificationsFixedSizeCollection> {
        ...
        public static ApiFuture<ListNotificationsPagedResponse> createAsync(PageContext<ListNotificationsRequest, ListNotificationsResponse, Notification> context, ApiFuture<ListNotificationsResponse> futureResponse) {
            ...
            return ApiFutures.transform(futurePage, input -> new ListNotificationsPagedResponse(input), MoreExecutors.directExecutor());
        }
    ...
    public static class ListObjectsPagedResponse extends AbstractPagedListResponse<ListObjectsRequest, ListObjectsResponse, Object, ListObjectsPage, ListObjectsFixedSizeCollection> {
        ...
        public static ApiFuture<ListObjectsPagedResponse> createAsync(PageContext<ListObjectsRequest, ListObjectsResponse, Object> context, ApiFuture<ListObjectsResponse> futureResponse) {
            ...
            return ApiFutures.transform(futurePage, input -> new ListObjectsPagedResponse(input), MoreExecutors.directExecutor());
        }
    ...
    public static class ListHmacKeysPagedResponse extends AbstractPagedListResponse<ListHmacKeysRequest, ListHmacKeysResponse, HmacKeyMetadata, ListHmacKeysPage, ListHmacKeysFixedSizeCollection> {
        ...
        public static ApiFuture<ListHmacKeysPagedResponse> createAsync(PageContext<ListHmacKeysRequest, ListHmacKeysResponse, HmacKeyMetadata> context, ApiFuture<ListHmacKeysResponse> futureResponse) {
            ...
            return ApiFutures.transform(futurePage, input -> new ListHmacKeysPagedResponse(input), MoreExecutors.directExecutor());
        }
