...
public class GetObjectMetadata {
    ...
    public static void getObjectMetadata(String projectId, String bucketName, String blobName) throws StorageException {
        ...
        Boolean temporaryHoldIsEnabled = (null != blob.getTemporaryHold() && blob.getTemporaryHold());
        System.out.println("temporaryHold: " + (temporaryHoldIsEnabled ? "enabled" : "disabled"));
        Boolean eventBasedHoldIsEnabled = (null != blob.getEventBasedHold() && blob.getEventBasedHold());
        System.out.println("eventBasedHold: " + (eventBasedHoldIsEnabled ? "enabled" : "disabled"));
        if (null != blob.getRetentionExpirationTime()) {
