...
public class GetDefaultEventBasedHold {
    ...
    public static void getDefaultEventBasedHold(String projectId, String bucketName) throws StorageException {
        ...
        Bucket bucket = storage.get(bucketName, Storage.BucketGetOption.fields(Storage.BucketField.DEFAULT_EVENT_BASED_HOLD));
        if (null == bucket.getDefaultEventBasedHold() || !bucket.getDefaultEventBasedHold()) {
