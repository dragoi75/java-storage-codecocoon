...
public final class StorageOperationException extends BaseHttpServiceException {
    ...
    private static final Set<Error> TRANSIENT_ERRORS = ImmutableSet.of(new Error(504, null), new Error(503, null), new Error(502, null), new Error(500, null), new Error(429, null), new Error(408, null), new Error(null, SYSTEM_FAILURE), new Error(null, STREAM_CLOSED_EARLY));
