...
public interface StorageService extends Service<StorageSettings> {
  ...
  class BucketGetOptions extends AbstractOption {
    ...
    public static BucketGetOptions selectFields(BucketMetadataField... selectedMetadata) {
      return new BucketGetOptions(
          StorageRpcClient.StorageOption.FIELDS, Helper.selector(BucketMetadataField.MANDATORY_SELECTORS, selectedMetadata));
    }
  }
  ...
  class BlobUploadOption extends AbstractOption {
    ...
    static Tuple<BlobMetadata, BlobUploadOption[]> toTargetOptions(BlobMetadata blobMetadata, BlobWriteOptions... writeOptions) {
      ...
      return Tuple.of(
          objectBuilder.buildObject(), destinationOptions.toArray(new BlobUploadOption[destinationOptions.size()]));
    }
  }
  ...
  class BlobWriteOptions implements Serializable {
    ...
    public boolean equals(Object other) {
      ...
      return this.writeOption == that.writeOption && Objects.equals(this.paramObject, that.paramObject);
    }
  ...
  class BlobGetOptions extends AbstractOption {
    ...
    public static BlobGetOptions selectFields(BlobMetadataField... selectedMetadata) {
      return new BlobGetOptions(
          StorageRpcClient.StorageOption.FIELDS, Helper.selector(BlobMetadataField.MANDATORY_SELECTORS, selectedMetadata));
    }
  ...
  class BucketListOptions extends AbstractOption {
    ...
    public static BucketListOptions selectFields(BucketMetadataField... selectedMetadata) {
      return new BucketListOptions(
          ...
          Helper.listSelector("items", BucketMetadataField.MANDATORY_SELECTORS, selectedMetadata));
    }
  }
  ...
  class BlobListOptions extends AbstractOption {
    ...
    public static BlobListOptions selectFields(BlobMetadataField... selectedMetadata) {
      return new BlobListOptions(
          StorageRpcClient.StorageOption.FIELDS,
          Helper.listSelector(TOP_LEVEL_ATTRIBUTES, "items", BlobMetadataField.MANDATORY_SELECTORS, selectedMetadata));
    }
  }
  ...
  class UrlSigningOption implements Serializable {
    ...
    public static UrlSigningOption withBucketBoundHostname(
            String bucketHost, UriSchemeType uriProtocol) {
      return new UrlSigningOption(
          HttpRequestOption.BUCKET_BOUND_HOST_NAME, uriProtocol.getScheme() + "://" + bucketHost);
    }
  ...
  class CopyOperationRequest implements Serializable {
    ...
    public static CopyOperationRequest from(String originContainer, String originObject, String destinationBlobName) {
      return CopyOperationRequest.newCopyBuilder()
  ...
  List<Boolean> testIamPermissions(
          String containerName, List<String> requestedActions, BucketRequestOption... writeOptions);
