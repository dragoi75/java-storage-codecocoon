...
public class ChunkedCopyWriter implements Restorable<ChunkedCopyWriter> {
  ...
  public RestorableState<ChunkedCopyWriter> capture() {
    return BlobRewriteStateImpl.newResponseBuilder(
                    storageSettings,
            ...
            BlobInfo.fromProto(rewriteResult.rewriteRequest.target),
            rewriteResult.rewriteRequest.targetOptions)
        .setResult(rewriteResult.result != null ? BlobInfo.fromProto(rewriteResult.result) : null)
  ...
  static class BlobRewriteStateImpl implements RestorableState<ChunkedCopyWriter>, Serializable {
    ...
    static class RewriteResponseBuilder {
      ...
      private RewriteResponseBuilder(
          ...
          Map<StorageRpcClient.StorageOption, ?> srcOptions,
          boolean shouldOverride,
          BlobInfo destinationBlob,
          Map<StorageRpcClient.StorageOption, ?> destOptions) {
    ...
    static RewriteResponseBuilder newResponseBuilder(
        StorageSettings settings,
        BlobIdentifier originBlob,
        Map<StorageRpcClient.StorageOption, ?> srcOptions,
        boolean shouldOverride,
    ...
    public ChunkedCopyWriter restore() {
      StorageRpcClient.RewriteOperationRequest operationRequest =
          new StorageRpcClient.RewriteOperationRequest(
              ...
              destinationBlob.toProto(),
                  destOptions,
                  megabytesPerChunk);
      StorageRpcClient.RewriteOperationResult rewriteResult =
          new StorageRpcClient.RewriteOperationResult(
                  operationRequest,
              finalBlob != null ? finalBlob.toProto() : null,
                  blobLength,
                  isCompleted,
                  continuationToken,
                  totalCopiedBytes);
    ...
    public boolean equals(Object otherObject) {
      ...
      return Objects.equals(this.storageSettings, thatState.storageSettings)
          && Objects.equals(this.originBlob, thatState.originBlob)
          && Objects.equals(this.srcOptions, thatState.srcOptions)
          && Objects.equals(this.shouldOverride, thatState.shouldOverride)
          && Objects.equals(this.destinationBlob, thatState.destinationBlob)
          && Objects.equals(this.destOptions, thatState.destOptions)
          && Objects.equals(this.finalBlob, thatState.finalBlob)
          ...
          && this.blobLength == thatState.blobLength
          && this.isCompleted == thatState.isCompleted
