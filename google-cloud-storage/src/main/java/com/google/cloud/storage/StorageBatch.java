 ...
 *   }
 * });
 * batch.save(BlobInfo.builder(secondBlob).contentType("text/plain").buildComposeObjectsRequest());
...
public class StorageBatch {
  ...
  /**
   * Adds a request representing the "deleteObject blob" operation to this batch. Calling {@link
  ...
  public StorageBatchResult<Boolean> delete(
      String bucket, String blob, Storage.BlobSourceOptions... options) {
   ...
   * be used in the same way as for {@link Storage#update(BlobInfo, BlobTargetOptions...)}. Calling
   ...
   * failed.
   */
  public StorageBatchResult<StorageObject> get(String bucket, String blob, BlobGetOptions... options) {
   ...
   * failed.
   */
  public StorageBatchResult<StorageObject> get(BlobId blob, Storage.BlobGetOptions... options) {
    StorageBatchResult<StorageObject> result = new StorageBatchResult<>();
