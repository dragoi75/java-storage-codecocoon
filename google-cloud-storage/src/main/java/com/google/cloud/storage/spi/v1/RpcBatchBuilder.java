...
public interface RpcBatchBuilder {
  ...
  interface ResultCallback<T> {
    ...
    void addFetch(
        ...
        ResultCallback<StorageObject> callback,
     ...
     */
    void addDeletion(
            StorageObject storageObject, ResultCallback<Void> callback, Map<StorageRpcClient.StorageOption, ?> options);
