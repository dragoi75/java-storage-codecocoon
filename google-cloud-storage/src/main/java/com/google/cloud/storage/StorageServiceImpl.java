...
final class StorageServiceImpl extends BaseService<StorageClientOptions> implements CloudStorageClient {
   ...
   */
    ...
    public BlobRewriteWriter copy(final CopyOperationRequest copyReq) {
        ...
        try {
            RewriteResult rewriteResult = runWithRetries(new Callable<StorageRpcClient.RewriteResult>() {
    ...
    @Override
    public S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobMetadata, long expiryDuration, TimeUnit timeMeasure, S3PostPolicyV4.PostFieldsMapV4 formFields, PostConditionsVersion4 postConditions, PostPolicyV4FormField... clientConfig) {
        EnumMap<UrlSigningOption.RequestOption, Object> optionsLookup = Maps.newEnumMap(UrlSigningOption.RequestOption.class);
        ...
        S3PostPolicyV4.PostConditionsVersion4 version4Conditions = policyBuilder.addBucket(S3PostPolicyV4.ConditionV4Kind.MATCHES, blobMetadata.getBucket()).addKey(S3PostPolicyV4.ConditionV4Kind.MATCHES, blobMetadata.getName()).addCustom(S3PostPolicyV4.ConditionV4Kind.MATCHES, "x-goog-date", formattedDate).addCustom(S3PostPolicyV4.ConditionV4Kind.MATCHES, "x-goog-credential", signingKey).addCustom(S3PostPolicyV4.ConditionV4Kind.MATCHES, "x-goog-algorithm", "GOOG4-RSA-SHA256").buildConditions();
    ...
    public S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobMetadata, long expiryDuration, TimeUnit timeMeasure, S3PostPolicyV4.PostFieldsMapV4 formFields, PostPolicyV4FormField... clientConfig) {
    ...
    public S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobMetadata, long expiryDuration, TimeUnit timeMeasure, S3PostPolicyV4.PostConditionsVersion4 postConditions, PostPolicyV4FormField... clientConfig) {
    ...
    public S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobMetadata, long expiryDuration, TimeUnit timeMeasure, PostPolicyV4FormField... clientConfig) {
        return generateSignedPostPolicyV4(blobMetadata, expiryDuration, timeMeasure, S3PostPolicyV4.PostFieldsMapV4.createBuilder().buildMap(), clientConfig);
    }
    ...
    @Override
    public boolean deleteAcl(final String containerName, final AccessControlEntry.ProtoEntity protoEntity, BucketOption... clientConfig) {
        try {
            final Map<StorageRpcClient.StorageOption, ?> storageOptionMap = buildOptionMap(clientConfig);
            return runWithRetries(new Callable<Boolean>() {
    ...
    private HmacSecretKey.HmacKeyInfo modifyHmacKey(final HmacKeyInfo hmacInfo, final HmacKeyUpdateOption... clientConfig) {
        try {
    ...
    public HmacSecretKey.HmacKeyInfo updateHmacKeyState(final HmacKeyInfo hmacInfo, final HmacSecretKey.HmacKeyStatus hmacStatus, final HmacKeyUpdateOption... clientConfig) {
        HmacKeyInfo resultMetadata = HmacSecretKey.HmacKeyInfo.newServiceAccountBuilder(hmacInfo.getServiceAccount()).setProjectId(hmacInfo.getProjectId()).setAccessId(hmacInfo.getAccessId()).setState(hmacStatus).create();
    ...
    private static Page<HmacKeyInfo> listAllHmacKeys(final StorageClientOptions clientConfig, final Map<StorageRpcClient.StorageOption, ?> storageClientConfig) {
        try {
            ...
            String pageCursor = listOutcome.x();
            final Iterable<HmacKeyInfo> keyInfo = null == listOutcome.y() ? ImmutableList.<HmacSecretKey.HmacKeyInfo>of() : Iterables.transform(listOutcome.y(), new Function<com.google.api.services.storage.model.HmacKeyMetadata, HmacSecretKey.HmacKeyInfo>() {
