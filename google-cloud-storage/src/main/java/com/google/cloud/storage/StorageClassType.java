...
public final class StorageClassType extends StringEnumValue {
  ...
  private static final StringEnumType<StorageClassType> STORAGE_CLASS_ENUM_DEF =
      new StringEnumType(StorageClassType.class, STORAGE_CLASS_CREATOR);
   ...
   */
  public static final StorageClassType STANDARD = STORAGE_CLASS_ENUM_DEF.createAndRegister("STANDARD");
   ...
   */
  public static final StorageClassType NEARLINE = STORAGE_CLASS_ENUM_DEF.createAndRegister("NEARLINE");
   ...
   */
  public static final StorageClassType COLDLINE = STORAGE_CLASS_ENUM_DEF.createAndRegister("COLDLINE");
   ...
   */
  public static final StorageClassType ARCHIVE = STORAGE_CLASS_ENUM_DEF.createAndRegister("ARCHIVE");
   ...
   */
  public static final StorageClassType REGIONAL = STORAGE_CLASS_ENUM_DEF.createAndRegister("REGIONAL");
   ...
   *     href="https://cloud.google.com/storage/docs/storage-classes#legacy">https://cloud.google.com/storage/docs/storage-classes#legacy</a>
   */
  public static final StorageClassType MULTI_REGIONAL = STORAGE_CLASS_ENUM_DEF.createAndRegister("MULTI_REGIONAL");
