...
/**
 * IAM roles specific to StorageClient. An overview from the permissions available to StorageClient and the
 * capabilities they grant can be found in the <a
 * href="https://cloud.google.com/storage/docs/access-control/iam">Google Cloud StorageClient IAM
 * documentation.</a>
 */
