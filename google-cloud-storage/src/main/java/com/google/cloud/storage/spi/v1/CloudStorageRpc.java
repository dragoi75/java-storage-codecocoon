...
public interface CloudStorageRpc extends ServiceRpc {
  ...
  class RewriteOperationRequest {
    ...
    public RewriteOperationRequest(
        ...
        Map<StorageOption, ?> originConfigMap,
        boolean forceOverride,
        StorageObject destinationObject,
        Map<StorageOption, ?> destinationConfigMap,
        Long bytesRewrittenPerCall) {
  ...
  class RewriteOperationResponse {
    ...
    public RewriteOperationResponse(
        RewriteOperationRequest originalRequest,
        StorageObject outcomeObject,
        long objectSize,
        boolean completed,
        String resumeToken,
