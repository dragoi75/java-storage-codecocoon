...
/**
 * A client for Cloud StorageClient - Unified object storage.
 *
 * <p>Here's a simple usage example for using google-cloud from App/Compute Engine. This example
 * shows how to create a StorageClient blob. For the complete source code see <a
 ...
 *
 * <pre>{@code
 * StorageClient storage = StorageOptions.getDefaultInstance().getService();
 ...
 * Blob blob = storage.create(blobInfo, "Hello, Cloud StorageClient!".getBytes(UTF_8));
 * }</pre>
 *
 ...
 * credentials</a>.
 *
 * @see <a href="https://cloud.google.com/storage/">Google Cloud StorageClient</a>
 */
