...
final class StorageClientImpl extends BaseService<StorageSettings> implements StorageClient {
    ...
    private StorageBlob createInternal(BlobMetadata blobMetadata, final byte[] dataBytes, BlobUploadOption... settings) {
        ...
        try {
            return com.google.cloud.storage.StorageBlob.fromProto(this, runWithRetries(new Callable<StorageObject>() {
    ...
    public StorageBlob get(BlobIdentifier objectName, BlobGetOptions... settings) {
        ...
        try {
            ...
            return null == objectRecord ? null : com.google.cloud.storage.StorageBlob.fromProto(this, objectRecord);
        } catch (RetryHelperException retryEx) {
            throw StorageOperationException.translateAndRethrow(retryEx);
        }
    }
    ...
    private HmacSecretKey.HmacKeyInfo modifyHmacKey(final HmacSecretKey.HmacKeyInfo keyInfo, final HmacKeyUpdateOption... settings) {
        try {
            return HmacSecretKey.HmacKeyInfo.fromProto(runWithRetries(new Callable<com.google.api.services.storage.model.HmacKeyMetadata>() {
    ...
    @Override
    public HmacSecretKey.HmacKeyInfo updateHmacKeyState(final HmacSecretKey.HmacKeyInfo keyInfo, final HmacSecretKey.HmacKeyStatus status, final HmacKeyUpdateOption... settings) {
        HmacKeyInfo updatedInfo = HmacSecretKey.HmacKeyInfo.createBuilder(keyInfo.getServiceAccount()).setProjectId(keyInfo.getProjectId()).setAccessId(keyInfo.getAccessId()).setState(status).create();
    ...
    private static Page<HmacSecretKey.HmacKeyInfo> listAllHmacKeys(final StorageSettings serviceSettings, final Map<CloudStorageRpc.StorageOption, ?> settings) {
        try {
            ...
            String pageToken = pageCursorAndBuckets.x();
            final Iterable<HmacSecretKey.HmacKeyInfo> keyInfo = null == pageCursorAndBuckets.y() ? ImmutableList.<HmacSecretKey.HmacKeyInfo>of() : Iterables.transform(pageCursorAndBuckets.y(), new Function<com.google.api.services.storage.model.HmacKeyMetadata, HmacSecretKey.HmacKeyInfo>() {
