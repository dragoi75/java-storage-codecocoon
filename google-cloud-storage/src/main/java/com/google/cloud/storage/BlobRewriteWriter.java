...
public class BlobRewriteWriter implements Restorable<BlobRewriteWriter> {
  ...
  public RestorableState<BlobRewriteWriter> capture() {
    return RewriteStateImpl.newBlobRewriteBuilder(
                    clientOptions,
  ...
  static class RewriteStateImpl implements RestorableState<BlobRewriteWriter>, Serializable {
    ...
    public boolean equals(Object otherObject) {
      ...
      return Objects.equals(this.clientOptions, otherState.clientOptions)
          && Objects.equals(this.originBlobId, otherState.originBlobId)
          && Objects.equals(this.originOptions, otherState.originOptions)
          && Objects.equals(this.overwriteFlag, otherState.overwriteFlag)
          && Objects.equals(this.destinationMetadata, otherState.destinationMetadata)
          && Objects.equals(this.destinationOptions, otherState.destinationOptions)
          && Objects.equals(this.outcomeMetadata, otherState.outcomeMetadata)
          && Objects.equals(this.continuationToken, otherState.continuationToken)
          && Objects.equals(this.megabytesPerChunk, otherState.megabytesPerChunk)
          && this.totalBytes == otherState.totalBytes
          && this.completedFlag == otherState.completedFlag
          && this.bytesCopiedTotal == otherState.bytesCopiedTotal;
    }
