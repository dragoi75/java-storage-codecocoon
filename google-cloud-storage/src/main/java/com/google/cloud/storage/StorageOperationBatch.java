...
public class StorageOperationBatch {
    ...
    private RpcRequestBatch.CompletionHandler<StorageObject> buildUpdateCallback(final StorageClientOptions clientConfig, final StorageBatchResult<StorageBlob> deleteOutcome) {
        return new RpcRequestBatch.CompletionHandler<StorageObject>() {

            @Override
            public void handleSuccess(StorageObject response) {
                deleteOutcome.success(null == response ? null : StorageBlob.fromProto(clientConfig.getService(), response));
            }
    ...
    private RpcRequestBatch.CompletionHandler<StorageObject> buildGetCallback(final StorageClientOptions clientConfig, final StorageBatchResult<StorageBlob> deleteOutcome) {
        return new RpcRequestBatch.CompletionHandler<StorageObject>() {
     ...
     * failed.
     */
    public StorageBatchResult<StorageBlob> get(BlobIdentifier objectName, BlobGetOptions... clientConfig) {
     ...
     * be used in the same way as for {@link CloudStorageClient#update(BlobMetadata, BlobUploadOptions...)}. Calling
     ...
     * failed.
     */
    public StorageBatchResult<StorageBlob> get(String containerName, String objectName, BlobGetOptions... clientConfig) {
