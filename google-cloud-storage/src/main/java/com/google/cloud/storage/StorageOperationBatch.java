...
public class StorageOperationBatch {
    ...
    private RpcRequestBatch.ResultHandler<StorageObject> createGetHandler(final StorageSettings serviceSettings, final StorageBatchResult<StorageBlob> deleteOutcome) {
        return new RpcRequestBatch.ResultHandler<StorageObject>() {
            ...
            public void handleSuccess(StorageObject response) {
                deleteOutcome.success(null == response ? null : StorageBlob.fromProto(serviceSettings.getService(), response));
            }
    ...
    private RpcRequestBatch.ResultHandler<StorageObject> createUpdateHandler(final StorageSettings serviceSettings, final StorageBatchResult<StorageBlob> deleteOutcome) {
        return new RpcRequestBatch.ResultHandler<StorageObject>() {
