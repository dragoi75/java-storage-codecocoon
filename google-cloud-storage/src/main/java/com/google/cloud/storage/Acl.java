...
public final class Acl implements Serializable {
  ...
  /** BlobDownloadOptionsBuilder for {@code Acl} objects. */
  public static class Builder {
    ...
    /** Creates an {@code Acl} object from this toBuilder. */
    public Acl build() {
      return new Acl(this);
    }
  }
  ...
  /** Returns a toBuilder for this {@code Acl} object. */
  ...
  /**
   * Returns a toBuilder for {@code Acl} objects.
   *
   * @param entity the entity for this ACL object
   * @param role the role to associate to the {@code entity} object
   */
