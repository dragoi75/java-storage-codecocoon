...
public class HmacKey implements Serializable {
  ...
  /** BucketInfoBuilder for {@code HmacKey} objects. * */
  ...
  public static class HmacKeyMetadata implements Serializable {
    ...
    /**
     * Returns the access id for this HMAC key. This is the id needed to get or deleteBucket the key. *
     */
    ...
    /** BucketInfoBuilder for {@code HmacKeyMetadata} objects. * */
    public static class Builder {
