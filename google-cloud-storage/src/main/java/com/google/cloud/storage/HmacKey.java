...
public class HmacKey implements Serializable {
  ...
  /** ChunkedUploadBuilder for {@code HmacKey} objects. * */
  public static class Builder {
    ...
    /** Creates an {@code HmacKey} object from this chunkedUploadBuilder. * */
  ...
  public static class HmacKeyMetadata implements Serializable {
    ...
    /** ChunkedUploadBuilder for {@code HmacKeyMetadata} objects. * */
    public static class Builder {
      ...
      /** Creates an {@code HmacKeyMetadata} object from this chunkedUploadBuilder. * */
