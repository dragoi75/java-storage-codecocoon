...
public class BlobCopyWriter implements Restorable<BlobCopyWriter> {
  ...
  public RestorableState<BlobCopyWriter> capture() {
    return PersistentRewriteState.createBuilder(
                    storageSettings,
            ...
            BlobAttributes.fromProto(rewriteResult.rewriteRequest.target),
            rewriteResult.rewriteRequest.targetOptions)
        .setResult(rewriteResult.result != null ? BlobAttributes.fromProto(rewriteResult.result) : null)
  ...
  static class PersistentRewriteState implements RestorableState<BlobCopyWriter>, Serializable {
    ...
    static class RewriteResponseBuilder {
      ...
      private RewriteResponseBuilder(
          ...
          BlobIdentifier originIdentifier,
          Map<CloudStorageRpcClient.StorageOption, ?> originOptions,
          boolean shouldReplace,
          BlobAttributes destination,
          Map<CloudStorageRpcClient.StorageOption, ?> destinationOptions) {
    ...
    public BlobCopyWriter restore() {
      CloudStorageRpcClient.RewriteOperationRequest operationRequest =
          new CloudStorageRpcClient.RewriteOperationRequest(
              originIdentifier.toStorageObject(),
                  originOptions,
                  shouldReplace,
              destination.toProto(),
                  destinationOptions,
                  mbPerChunk);
      CloudStorageRpcClient.RewriteOperationResponse rewriteResult =
          new RewriteOperationResponse(
                  operationRequest,
              finalAttributes != null ? finalAttributes.toProto() : null,
                  contentSize,
                  isComplete,
                  operationToken,
                  bytesTransferred);
    ...
    public boolean equals(Object otherObject) {
      ...
      return Objects.equals(this.storageSettings, comparedState.storageSettings)
          && Objects.equals(this.originIdentifier, comparedState.originIdentifier)
          && Objects.equals(this.originOptions, comparedState.originOptions)
          && Objects.equals(this.shouldReplace, comparedState.shouldReplace)
          && Objects.equals(this.destination, comparedState.destination)
          && Objects.equals(this.destinationOptions, comparedState.destinationOptions)
          && Objects.equals(this.finalAttributes, comparedState.finalAttributes)
          && Objects.equals(this.operationToken, comparedState.operationToken)
          && Objects.equals(this.mbPerChunk, comparedState.mbPerChunk)
          && this.contentSize == comparedState.contentSize
          && this.isComplete == comparedState.isComplete
          && this.bytesTransferred == comparedState.bytesTransferred;
    }

    @Override
    public String toString() {
      return MoreObjects.toStringHelper(this)
          .add("source", originIdentifier)
          .add("overrideInfo", shouldReplace)
          .add("target", destination)
          .add("result", finalAttributes)
          .add("blobSize", contentSize)
          .add("isDone", isComplete)
