...
public final class CorsConfiguration implements Serializable {
  ...
  static final Function<Bucket.Cors, CorsConfiguration> FROM_PROTO_FUNCTION =
      new Function<Bucket.Cors, CorsConfiguration>() {
        @Override
  ...
  static final Function<CorsConfiguration, Bucket.Cors> TO_PROTO_FUNCTION =
      new Function<CorsConfiguration, Bucket.Cors>() {
        @Override
  ...
  public static final class CorsConfigurationBuilder {
    ...
    public CorsConfigurationBuilder setMethods(Iterable<HttpRequestMethod> allowedHttpVerbs) {
      this.allowedHttpVerbs = allowedHttpVerbs != null ? ImmutableList.copyOf(allowedHttpVerbs) : null;
      return this;
    }

    /** Sets the origins for this CORS configuration. */
    public CorsConfigurationBuilder setOrigins(Iterable<Source> allowedSources) {
      this.allowedSources = allowedSources != null ? ImmutableList.copyOf(allowedSources) : null;
      return this;
    }
    ...
    public CorsConfigurationBuilder setResponseHeaders(Iterable<String> headerNamesIter) {
      this.responseMeta = headerNamesIter != null ? ImmutableList.copyOf(headerNamesIter) : null;
      return this;
    }
  ...
  public CorsConfigurationBuilder toBuilder() {
    return createBuilder()
        ...
        .setMethods(allowedHttpVerbs)
        .setOrigins(allowedSources)
        .setResponseHeaders(responseMeta);
  }
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(maxAge, comparisonTarget.maxAge)
        && Objects.equals(allowedHttpVerbs, comparisonTarget.allowedHttpVerbs)
        && Objects.equals(allowedSources, comparisonTarget.allowedSources)
        && Objects.equals(responseMeta, comparisonTarget.responseMeta);
  }
