...
public class BlobAttributes implements Serializable {
  ...
  static final Function<BlobAttributes, com.google.api.services.storage.model.StorageObject> ATTRIBUTES_TO_PB_FUNCTION =
      new Function<BlobAttributes, com.google.api.services.storage.model.StorageObject>() {
        @Override
  ...
  static final class BlobInfoBuilderImpl extends StorageObjectBuilder {
    ...
    public BlobAttributes.StorageObjectBuilder setMd5FromHexString(String hexDigest) {
      ...
      for (int charPos = 0; charPos < hexStringLower.length(); charPos += 2) {
  ...
  public boolean equals(Object other) {
    return other == this
        || other != null
            && other.getClass().equals(BlobAttributes.class)
            && Objects.equals(toProto(), ((BlobAttributes) other).toProto());
  }
  ...
  com.google.api.services.storage.model.StorageObject toProto() {
    ...
    if (metaMap != null && !Data.isNull(metaMap)) {
      ...
      for (Map.Entry<String, String> keyValuePair : metaMap.entrySet()) {
        protoMeta.put(
            keyValuePair.getKey(), firstNonNull(keyValuePair.getValue(), Data.<String>nullOf(String.class)));
      }
    }
    if (customerEncryptionInfo != null) {
  ...
  static BlobAttributes fromProto(com.google.api.services.storage.model.StorageObject storedObj) {
    ...
    if (storedObj.getCustomerEncryption() != null) {
      blobInfoCreator.setCustomerEncryption(
          CustomerEncryptionInfo.fromProto(storedObj.getCustomerEncryption()));
    }
    if (storedObj.getStorageClass() != null) {
      blobInfoCreator.setStorageClass(StorageClassType.fromValue(storedObj.getStorageClass()));
    }
    if (storedObj.getKmsKeyName() != null) {
      blobInfoCreator.setKmsKeyName(storedObj.getKmsKeyName());
    }
    if (storedObj.getEventBasedHold() != null) {
      blobInfoCreator.setEventBasedHold(storedObj.getEventBasedHold());
    }
    if (storedObj.getTemporaryHold() != null) {
      blobInfoCreator.setTemporaryHold(storedObj.getTemporaryHold());
    }
    if (storedObj.getRetentionExpirationTime() != null) {
