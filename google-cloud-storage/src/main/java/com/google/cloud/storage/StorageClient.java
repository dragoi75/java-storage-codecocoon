...
public interface StorageClient extends Service<StorageSettings> {
  ...
  class BucketTargetRequestOption extends RpcOptionWrapper {
    ...
    public static BucketTargetRequestOption predefinedDefaultObjectAcl(PredefinedAccessControlList accessControl) {
      return new BucketTargetRequestOption(
          CloudStorageRpc.StorageOption.PREDEFINED_DEFAULT_OBJECT_ACL, accessControl.getEntry());
    }
  ...
  class ListHmacKeysOptions extends RpcOptionWrapper {
    ...
    public static ListHmacKeysOptions withServiceAccount(ServiceAccountInfo accountInfo) {
      return new ListHmacKeysOptions(
          CloudStorageRpc.StorageOption.SERVICE_ACCOUNT_EMAIL, accountInfo.getEmail());
    }
  ...
  class BucketGetOptions extends RpcOptionWrapper {
    ...
    public static BucketGetOptions withFields(BucketMetadataField... selectedFields) {
      return new BucketGetOptions(
          CloudStorageRpc.StorageOption.FIELDS, Helper.selector(BucketMetadataField.MANDATORY_FIELDS, selectedFields));
    }
  }
  ...
  class BlobUploadOption extends RpcOptionWrapper {
    ...
    static Tuple<BlobMetadata, BlobUploadOption[]> convertOptions(BlobMetadata blobInfo, BlobWriteSetting... writeSettings) {
      ...
      return Tuple.of(
          storageObjectBuilder.buildStorageObject(), convertedOptions.toArray(new BlobUploadOption[convertedOptions.size()]));
    }
  }
  ...
  class BlobWriteSetting implements Serializable {
    ...
    public boolean equals(Object candidate) {
      ...
      return this.writeSetting == otherSetting.writeSetting && Objects.equals(this.optionPayload, otherSetting.optionPayload);
    }
  ...
  class BlobGetOptions extends RpcOptionWrapper {
    ...
    public static BlobGetOptions fieldsSelector(BlobMetadataField... selectedFields) {
      return new BlobGetOptions(
          CloudStorageRpc.StorageOption.FIELDS, Helper.selector(BlobMetadataField.MANDATORY_FIELDS, selectedFields));
    }
  ...
  class BucketListOptions extends RpcOptionWrapper {
    ...
    public static BucketListOptions fieldsSelector(BucketMetadataField... selectedFields) {
      return new BucketListOptions(
          CloudStorageRpc.StorageOption.FIELDS,
  ...
  class BlobListOptions extends RpcOptionWrapper {
    ...
    public static BlobListOptions selectFields(BlobMetadataField... selectedFields) {
      return new BlobListOptions(
          CloudStorageRpc.StorageOption.FIELDS,
          Helper.listSelector(PRIMARY_FIELDS, "items", BlobMetadataField.MANDATORY_FIELDS, selectedFields));
    }
  }
  ...
  class UrlSigningOption implements Serializable {
    ...
    public static UrlSigningOption withBucketBoundHostname(
            String bucketHost, UriSchemeType scheme) {
      return new UrlSigningOption(
          RequestOption.BUCKET_BOUND_HOST_NAME, scheme.getScheme() + "://" + bucketHost);
    }
  ...
  class CopyOperationRequest implements Serializable {
    ...
    public static CopyOperationRequest create(String originContainer, String originObject, String destinationBlobName) {
      return CopyOperationRequest.newCopyOperationBuilder()
          ...
          .setTarget(BlobIdentifier.create(originContainer, destinationBlobName))
          .buildCopyOperation();
    }
    ...
    public static CopyOperationRequest create(BlobIdentifier originBlobIdentifier, String destinationBlobName) {
      return CopyOperationRequest.newCopyOperationBuilder()
          .setSource(originBlobIdentifier)
          .setTarget(BlobIdentifier.create(originBlobIdentifier.getBucket(), destinationBlobName))
          .buildCopyOperation();
    }
  ...
  /** @see #getAcl(String, AccessControlEntry.TypedEntity, BucketSourceOptions...) */
   ...
   * @throws StorageOperationException upon failure
   */
  boolean deleteAcl(String containerId, AccessControlEntry.TypedEntity principal, BucketSourceOptions... writeSettings);

  /** @see #deleteAcl(String, AccessControlEntry.TypedEntity, BucketSourceOptions...) */
  ...
  List<Boolean> testIamPermissions(
          String containerId, List<String> accessRights, BucketSourceOptions... writeSettings);
