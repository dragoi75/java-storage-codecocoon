...
public interface CloudStorageClient extends Service<StorageClientOptions> {
    ...
    enum PredefinedAccessControl {
        ...
        PredefinedAccessControl(String item) {
            this.item = item;
        }
    ...
    enum BucketMetadataField implements FieldSelector {
        ...
        static final List<? extends FieldSelector> FIELD_SELECTORS = ImmutableList.of(NAME);
    ...
    enum BlobMetadataField implements FieldSelector {
        ...
        static final List<? extends FieldSelector> FIELD_SELECTORS = ImmutableList.of(BUCKET, NAME);
    ...
    class BucketTargetOptions extends AbstractOption {
        ...
        private BucketTargetOptions(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         */
        public static BucketTargetOptions presetAcl(PredefinedAccessControl accessControlSetting) {
            return new BucketTargetOptions(StorageRpcClient.StorageOption.PREDEFINED_ACL, accessControlSetting.getEntry());
        }

        /**
         * Returns an option for specifying bucket's default ACL configuration for blobs.
         */
        public static BucketTargetOptions predefinedDefaultObjectAcl(PredefinedAccessControl accessControlSetting) {
            return new BucketTargetOptions(StorageRpcClient.StorageOption.PREDEFINED_DEFAULT_OBJECT_ACL, accessControlSetting.getEntry());
        }
         ...
         */
        public static BucketTargetOptions userProjectId(String projectForUser) {
            return new BucketTargetOptions(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
         ...
         *     patch</a>
         */
        public static BucketTargetOptions projection(String view) {
            return new BucketTargetOptions(StorageRpcClient.StorageOption.PROJECTION, view);
        }
    }
     ...
     */
    class BucketOption extends AbstractOption {

        private static final long serialVersionUID = 5185657617120212117L;

        private BucketOption(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         */
        public static BucketOption ifMetagenerationMatch(long generationId) {
            return new BucketOption(StorageRpcClient.StorageOption.IF_METAGENERATION_MATCH, generationId);
        }
         ...
         */
        public static BucketOption ifMetagenerationNotMatch(long generationId) {
            return new BucketOption(StorageRpcClient.StorageOption.IF_METAGENERATION_NOT_MATCH, generationId);
        }
         ...
         */
        public static BucketOption userProjectId(String projectForUser) {
            return new BucketOption(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }

        public static BucketOption policyVersionRequested(long policyRevision) {
            return new BucketOption(StorageRpcClient.StorageOption.REQUESTED_POLICY_VERSION, policyRevision);
        }
    }
    ...
    class ListHmacKeysOptions extends AbstractOption {
        ...
        private ListHmacKeysOptions(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         */
        public static ListHmacKeysOptions serviceAccountEmail(ServiceAccountInfo accountInfo) {
         ...
         */
        public static ListHmacKeysOptions maxItems(long maxItems) {
            return new ListHmacKeysOptions(StorageRpcClient.StorageOption.MAX_RESULTS, maxItems);
        }

        /**
         * Returns an option to specify the page token from which to start listing HMAC keys.
         */
        public static ListHmacKeysOptions pageCursor(String cursor) {
            return new ListHmacKeysOptions(StorageRpcClient.StorageOption.PAGE_TOKEN, cursor);
        }
         ...
         */
        public static ListHmacKeysOptions userProject(String projectForUser) {
            return new ListHmacKeysOptions(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
     ...
     */
    class CreateHmacKeyRequestOption extends AbstractOption {

        private CreateHmacKeyRequestOption(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         * Requester Pays buckets.
         */
        public static CreateHmacKeyRequestOption userProject(String projectForUser) {
            return new CreateHmacKeyRequestOption(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
        ...
        public static CreateHmacKeyRequestOption projectId(String projectIdentifier) {
            return new CreateHmacKeyRequestOption(StorageRpcClient.StorageOption.PROJECT_ID, projectIdentifier);
        }
    }
    ...
    class GetHmacKeyRequestOption extends AbstractOption {
        ...
        private GetHmacKeyRequestOption(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         * Requester Pays buckets.
         */
        public static GetHmacKeyRequestOption userProject(String projectForUser) {
            return new GetHmacKeyRequestOption(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
    ...
    class DeleteHmacKeyRequestOption extends AbstractOption {
        ...
        private DeleteHmacKeyRequestOption(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         * Requester Pays buckets.
         */
        public static DeleteHmacKeyRequestOption userProject(String projectForUser) {
            return new DeleteHmacKeyRequestOption(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
    }
    ...
    class HmacKeyUpdateOption extends AbstractOption {
        ...
        private HmacKeyUpdateOption(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         * Requester Pays buckets.
         */
        public static HmacKeyUpdateOption userProject(String projectForUser) {
            return new HmacKeyUpdateOption(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
    }
    ...
    class BucketGetOptions extends AbstractOption {
        ...
        private BucketGetOptions(StorageRpcClient.StorageOption storageOption, long generationId) {
            super(storageOption, generationId);
        }

        private BucketGetOptions(StorageRpcClient.StorageOption storageOption, String payload) {
            super(storageOption, payload);
        }
         ...
         * with 'requester_pays' flag.
         */
        public static BucketGetOptions userProjectId(String projectForUser) {
            return new BucketGetOptions(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
         ...
         * specified.
         */
        public static BucketGetOptions selectedFields(BucketMetadataField... selectedAttributes) {
            return new BucketGetOptions(StorageRpcClient.StorageOption.FIELDS, Helper.selector(BucketMetadataField.FIELD_SELECTORS, selectedAttributes));
        }
    }
    ...
    class BlobUploadOption extends AbstractOption {
        ...
        private BlobUploadOption(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         */
        public static BlobUploadOption presetAcl(PredefinedAccessControl accessControlSetting) {
            return new BlobUploadOption(StorageRpcClient.StorageOption.PREDEFINED_ACL, accessControlSetting.getEntry());
        }
         ...
         */
        public static BlobUploadOption autoDetectContentType() {
         ...
         * blob.
         */
        public static BlobUploadOption customerSuppliedKey(Key encryptionSecret) {
            String base64EncodedString = BaseEncoding.base64().encode(encryptionSecret.getEncoded());
            return new BlobUploadOption(StorageRpcClient.StorageOption.CUSTOMER_SUPPLIED_KEY, base64EncodedString);
        }
         ...
         * with 'requester_pays' flag.
         */
        public static BlobUploadOption userProjectId(String projectForUser) {
            return new BlobUploadOption(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
         ...
         */
        public static BlobUploadOption customerSuppliedKey(String encryptionSecret) {
            return new BlobUploadOption(StorageRpcClient.StorageOption.CUSTOMER_SUPPLIED_KEY, encryptionSecret);
        }

        /**
         * Returns an option to set a customer-managed key for server-side encryption of the blob.
         */
        public static BlobUploadOption kmsKey(String kmsResourceName) {
            return new BlobUploadOption(StorageRpcClient.StorageOption.KMS_KEY_NAME, kmsResourceName);
        }

        static Tuple<BlobMetadata, BlobUploadOption[]> convertWriteOptions(BlobMetadata blobMetadata, BlobWriteOptions... writeParams) {
            BlobMetadata.BlobMetadataBuilder metadataBuilder = blobMetadata.toBuilderCopy().setCrc32c(null).setMd5(null);
            List<BlobUploadOption> targetConfigs = Lists.newArrayListWithCapacity(writeParams.length);
            for (BlobWriteOptions writeParam : writeParams) {
                switch(writeParam.writeParam) {
                    ...
                    case IF_MD5_MATCH:
                        ...
                        break;
                    default:
                        targetConfigs.add(writeParam.toBlobUploadOption());
                        break;
                }
            }
            return Tuple.of(metadataBuilder.buildMetadata(), targetConfigs.toArray(new BlobUploadOption[targetConfigs.size()]));
        }
    }
    ...
    class BlobWriteOptions implements Serializable {
        ...
        private final ObjectWriteOption writeParam;

        private final Object payload;

        enum ObjectWriteOption {
        ...
        BlobUploadOption toBlobUploadOption() {
            return new BlobUploadOption(this.writeParam.toStorageRpcOption(), this.payload);
        }

        private BlobWriteOptions(ObjectWriteOption writeParam, Object payload) {
            this.writeParam = writeParam;
            this.payload = payload;
        }

        private BlobWriteOptions(ObjectWriteOption writeParam) {
            this(writeParam, null);
        }

        @Override
        public int hashCode() {
            return Objects.hash(writeParam, payload);
        }
        ...
        public boolean equals(Object comparisonObject) {
            ...
            if (!(comparisonObject instanceof BlobWriteOptions)) {
                return false;
            }
            final BlobWriteOptions comparedInstance = (BlobWriteOptions) comparisonObject;
            return comparedInstance.writeParam == this.writeParam && Objects.equals(this.payload, comparedInstance.payload);
        }

        /**
         * Returns an option for specifying blob's predefined ACL configuration.
         */
        public static BlobWriteOptions presetAcl(PredefinedAccessControl accessControlSetting) {
            return new BlobWriteOptions(ObjectWriteOption.PREDEFINED_ACL, accessControlSetting.getEntry());
        }
        ...
        public static BlobWriteOptions ifNotExists() {
            return new BlobWriteOptions(ObjectWriteOption.IF_GENERATION_MATCH, 0L);
        }
        ...
        public static BlobWriteOptions ifGenerationMatch() {
            return new BlobWriteOptions(ObjectWriteOption.IF_GENERATION_MATCH);
        }
        ...
        public static BlobWriteOptions ifGenerationNotMatch() {
            return new BlobWriteOptions(ObjectWriteOption.IF_GENERATION_NOT_MATCH);
        }
        ...
        public static BlobWriteOptions ifMetagenerationMatch() {
            return new BlobWriteOptions(ObjectWriteOption.IF_METAGENERATION_MATCH);
        }
        ...
        public static BlobWriteOptions ifMetagenerationNotMatch() {
            return new BlobWriteOptions(ObjectWriteOption.IF_METAGENERATION_NOT_MATCH);
        }
        ...
        public static BlobWriteOptions ifMd5Match() {
            return new BlobWriteOptions(ObjectWriteOption.IF_MD5_MATCH, true);
        }
        ...
        public static BlobWriteOptions ifCrc32cMatch() {
            return new BlobWriteOptions(ObjectWriteOption.IF_CRC32C_MATCH, true);
        }
         ...
         * blob.
         */
        public static BlobWriteOptions withEncryptionKey(Key encryptionSecret) {
            String base64EncodedString = BaseEncoding.base64().encode(encryptionSecret.getEncoded());
            return new BlobWriteOptions(ObjectWriteOption.CUSTOMER_SUPPLIED_KEY, base64EncodedString);
        }
         ...
         * @param encryptionSecret the AES256 encoded in base64
         */
        public static BlobWriteOptions withEncryptionKey(String encryptionSecret) {
            return new BlobWriteOptions(ObjectWriteOption.CUSTOMER_SUPPLIED_KEY, encryptionSecret);
        }
        ...
        public static BlobWriteOptions withKmsKeyName(String kmsResourceName) {
            return new BlobWriteOptions(ObjectWriteOption.KMS_KEY_NAME, kmsResourceName);
        }
         ...
         * with 'requester_pays' flag.
         */
        public static BlobWriteOptions withUserProject(String projectForUser) {
            return new BlobWriteOptions(ObjectWriteOption.USER_PROJECT, projectForUser);
        }
        ...
        public static BlobWriteOptions disableGzip() {
            return new BlobWriteOptions(ObjectWriteOption.IF_DISABLE_GZIP_CONTENT, true);
        }
        ...
        public static BlobWriteOptions autoDetectContentType() {
            return new BlobWriteOptions(ObjectWriteOption.DETECT_CONTENT_TYPE, true);
        }
    }
    ...
    class BlobReadOption extends AbstractOption {
        ...
        private BlobReadOption(StorageRpcClient.StorageOption storageOption, Object payload) {
            super(storageOption, payload);
        }
         ...
         */
        public static BlobReadOption ifGenerationMatch(long versionId) {
            return new BlobReadOption(StorageRpcClient.StorageOption.IF_GENERATION_MATCH, versionId);
        }
         ...
         */
        public static BlobReadOption generationNotMatch(long versionId) {
            return new BlobReadOption(StorageRpcClient.StorageOption.IF_GENERATION_NOT_MATCH, versionId);
        }
        ...
        public static BlobReadOption ifMetagenerationMatch(long generationId) {
            return new BlobReadOption(StorageRpcClient.StorageOption.IF_METAGENERATION_MATCH, generationId);
        }
        ...
        public static BlobReadOption ifMetagenerationNotMatch(long generationId) {
            return new BlobReadOption(StorageRpcClient.StorageOption.IF_METAGENERATION_NOT_MATCH, generationId);
        }
         ...
         * blob.
         */
        public static BlobReadOption withDecryptionKey(Key encryptionSecret) {
            String base64EncodedString = BaseEncoding.base64().encode(encryptionSecret.getEncoded());
         ...
         * @param encryptionSecret the AES256 encoded in base64
         */
        public static BlobReadOption withDecryptionKey(String encryptionSecret) {
            return new BlobReadOption(StorageRpcClient.StorageOption.CUSTOMER_SUPPLIED_KEY, encryptionSecret);
        }
         ...
         * with 'requester_pays' flag.
         */
        public static BlobReadOption withUserProject(String projectForUser) {
            return new BlobReadOption(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
    }
    ...
    class BlobGetOptions extends AbstractOption {
        ...
        private BlobGetOptions(StorageRpcClient.StorageOption storageOption, Long payload) {
            super(storageOption, payload);
        }

        private BlobGetOptions(StorageRpcClient.StorageOption storageOption, String payload) {
            super(storageOption, payload);
        }
        ...
        public static BlobGetOptions selectFields(BlobMetadataField... selectedAttributes) {
            return new BlobGetOptions(StorageRpcClient.StorageOption.FIELDS, Helper.selector(BlobMetadataField.FIELD_SELECTORS, selectedAttributes));
        }
         ...
         * with 'requester_pays' flag.
         */
        public static BlobGetOptions withUserProject(String projectForUser) {
            return new BlobGetOptions(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
         ...
         * blob.
         */
        public static BlobGetOptions withDecryptionKey(Key encryptionSecret) {
            String base64EncodedString = BaseEncoding.base64().encode(encryptionSecret.getEncoded());
            return new BlobGetOptions(StorageRpcClient.StorageOption.CUSTOMER_SUPPLIED_KEY, base64EncodedString);
        }
         ...
         * @param encryptionSecret the AES256 encoded in base64
         */
        public static BlobGetOptions withDecryptionKey(String encryptionSecret) {
            return new BlobGetOptions(StorageRpcClient.StorageOption.CUSTOMER_SUPPLIED_KEY, encryptionSecret);
        }
    }
    ...
    class BucketListOptions extends AbstractOption {
        ...
        private BucketListOptions(StorageRpcClient.StorageOption writeParam, Object payload) {
            super(writeParam, payload);
        }

        /**
         * Returns an option to specify the maximum number of buckets returned per page.
         */
        public static BucketListOptions withPageSize(long maxItems) {
            return new BucketListOptions(StorageRpcClient.StorageOption.MAX_RESULTS, maxItems);
        }
        ...
        public static BucketListOptions pageToken(String cursor) {
            return new BucketListOptions(StorageRpcClient.StorageOption.PAGE_TOKEN, cursor);
        }
        ...
        public static BucketListOptions withPrefix(String namePrefix) {
            return new BucketListOptions(StorageRpcClient.StorageOption.PREFIX, namePrefix);
        }
         ...
         * with 'requester_pays' flag.
         */
        public static BucketListOptions withUserProject(String projectForUser) {
            return new BucketListOptions(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
         ...
         * specified.
         */
        public static BucketListOptions selectFields(BucketMetadataField... selectedAttributes) {
            return new BucketListOptions(StorageRpcClient.StorageOption.FIELDS, Helper.listSelector("items", BucketMetadataField.FIELD_SELECTORS, selectedAttributes));
        }
    }
    ...
    class BlobListOptions extends AbstractOption {
        ...
        private static final String[] TOP_LEVEL_PROPERTIES = { "prefixes" };

        private static final long serialVersionUID = 9083383524788661294L;

        private BlobListOptions(StorageRpcClient.StorageOption writeParam, Object payload) {
            super(writeParam, payload);
        }
         ...
         */
        public static BlobListOptions withPageSize(long maxItems) {
            return new BlobListOptions(StorageRpcClient.StorageOption.MAX_RESULTS, maxItems);
        }
        ...
        public static BlobListOptions pageToken(String cursor) {
            return new BlobListOptions(StorageRpcClient.StorageOption.PAGE_TOKEN, cursor);
        }
        ...
        public static BlobListOptions withPrefix(String namePrefix) {
            return new BlobListOptions(StorageRpcClient.StorageOption.PREFIX, namePrefix);
        }
         ...
         */
        public static BlobListOptions onlyCurrentDirectory() {
        ...
        public static BlobListOptions withStartOffset(String startBoundary) {
            return new BlobListOptions(StorageRpcClient.StorageOption.START_OFF_SET, startBoundary);
        }
        ...
        public static BlobListOptions withEndOffset(String endBoundary) {
            return new BlobListOptions(StorageRpcClient.StorageOption.END_OFF_SET, endBoundary);
        }
         ...
         * `requester_pays` flag enabled to assign operation costs.
         *
         * @param projectForUser projectId of the billing user project.
         */
        public static BlobListOptions withUserProject(String projectForUser) {
            return new BlobListOptions(StorageRpcClient.StorageOption.USER_PROJECT, projectForUser);
        }
        ...
        public static BlobListOptions withFields(BlobMetadataField... selectedAttributes) {
            return new BlobListOptions(StorageRpcClient.StorageOption.FIELDS, Helper.listSelector(TOP_LEVEL_PROPERTIES, "items", BlobMetadataField.FIELD_SELECTORS, selectedAttributes));
        }
    }
     ...
     */
    class PostPolicyV4FormField implements Serializable {
        ...
        private PostPolicyV4FormField(StorageOption writeParam, Object payload) {
            this.writeParam = writeParam;
            this.payload = payload;
        }
         ...
         *     Accounts</a>
         */
        public static PostPolicyV4FormField withSigner(ServiceAccountSigner signingIdentity) {
            return new PostPolicyV4FormField(StorageOption.SERVICE_ACCOUNT_CRED, signingIdentity);
        }
         ...
         */
        public static PostPolicyV4FormField useVirtualHostedStyle() {
            return new PostPolicyV4FormField(StorageOption.VIRTUAL_HOSTED_STYLE, "");
        }
         ...
         * @see <a href="https://cloud.google.com/storage/docs/request-endpoints">Request Endpoints</a>
         */
        public static PostPolicyV4FormField usePathStyle() {
            return new PostPolicyV4FormField(StorageOption.PATH_STYLE, "");
        }
         ...
         *     GCLB Redirects</a>
         */
        public static PostPolicyV4FormField withBucketBoundHostname(String bucketHost) {
         ...
         *     GCLB Redirects</a>
         */
        public static PostPolicyV4FormField withBucketBoundHostname(String bucketHost, UriSchemeType schemeType) {
            return new PostPolicyV4FormField(StorageOption.BUCKET_BOUND_HOST_NAME, schemeType.getScheme() + "://" + bucketHost);
        }
    }
    ...
    class UrlSigningOption implements Serializable {
        ...
        private final RequestOption writeParam;
        ...
        private UrlSigningOption(RequestOption writeParam, Object payload) {
            this.writeParam = writeParam;
            this.payload = payload;
        }
         ...
         *     Accounts</a>
         */
        public static UrlSigningOption withSigner(ServiceAccountSigner signingIdentity) {
            return new UrlSigningOption(RequestOption.SERVICE_ACCOUNT_CRED, signingIdentity);
        }
         ...
         *     GCLB Redirects</a>
         */
        public static UrlSigningOption withBucketBoundHostname(String bucketHost, UriSchemeType schemeType) {
            return new UrlSigningOption(RequestOption.BUCKET_BOUND_HOST_NAME, schemeType.getScheme() + "://" + bucketHost);
        }
         ...
         *     Process</a>
         */
        public static UrlSigningOption includeQueryParams(Map<String, String> parametersMap) {
            return new UrlSigningOption(RequestOption.QUERY_PARAMS, parametersMap);
        }
    }
    ...
    class ComposeBlobsRequest implements Serializable {
        ...
        private final List<SourceBlobMetadata> sourceList;

        private final BlobMetadata destinationBlob;

        private final List<BlobUploadOption> targetConfigs;
        ...
        public static class SourceBlobMetadata implements Serializable {
            ...
            SourceBlobMetadata(String blobId, Long versionId) {
                this.blobId = blobId;
        ...
        public static class SourceTargetBuilder {
            ...
            private final List<SourceBlobMetadata> sourceList = new LinkedList<>();

            private final Set<BlobUploadOption> targetConfigs = new LinkedHashSet<>();
             ...
             */
            public SourceTargetBuilder addSources(Iterable<String> entries) {
                for (String entry : entries) {
                    sourceList.add(new SourceBlobMetadata(entry));
                }
                return this;
            }
             ...
             * Add source blobs for compose operation.
             */
            public SourceTargetBuilder addSources(String... entries) {
                return addSources(Arrays.asList(entries));
            }

            /**
             * Add a source with a specific generation to match.
             */
            public SourceTargetBuilder addSources(String entry, long versionId) {
                sourceList.add(new SourceBlobMetadata(entry, versionId));
                return this;
            }
             ...
             */
            public SourceTargetBuilder setTargetOptions(BlobUploadOption... writeParams) {
                Collections.addAll(targetConfigs, writeParams);
                return this;
            }
             ...
             * Sets compose operation's target blob options.
             */
            public SourceTargetBuilder setTargetOptions(Iterable<BlobUploadOption> writeParams) {
                Iterables.addAll(targetConfigs, writeParams);
                return this;
            }
        ...
        private ComposeBlobsRequest(SourceTargetBuilder requestAssembler) {
            sourceList = ImmutableList.copyOf(requestAssembler.sourceList);
            destinationBlob = requestAssembler.destinationBlob;
            targetConfigs = ImmutableList.copyOf(requestAssembler.targetConfigs);
        }
         ...
         * Creates a {@code ComposeRequest} object.
         *
         * @param components source blobs names
         * @param destinationBlob target blob
         */
        public static ComposeBlobsRequest of(Iterable<String> components, BlobMetadata destinationBlob) {
            return builder().setTarget(destinationBlob).addSources(components).buildRequest();
        }

        /**
         * Creates a {@code ComposeRequest} object.
         *
         * @param container name of the bucket where the compose operation takes place
         * @param components source blobs names
         * @param destinationBlob target blob name
         */
        public static ComposeBlobsRequest of(String container, Iterable<String> components, String destinationBlob) {
            return of(components, BlobMetadata.newBuilder(BlobIdentifier.from(container, destinationBlob)).buildMetadata());
        }

        /**
         * Returns a {@code ComposeRequest} builder.
         */
        public static SourceTargetBuilder builder() {
    ...
    class CopyOperationRequest implements Serializable {
        ...
        private final BlobIdentifier origin;
        ...
        public static class CopyOperationBuilder {
             ...
             * @return the builder
             */
            public CopyOperationBuilder setSource(String container, String entry) {
                this.origin = BlobIdentifier.from(container, entry);
                return this;
            }
             ...
             * @return the builder
             */
            public CopyOperationBuilder setSource(BlobIdentifier origin) {
                this.origin = origin;
                return this;
            }
             ...
             * @return the builder
             */
            public CopyOperationBuilder setSourceOptions(BlobReadOption... writeParams) {
             ...
             * @return the builder
             */
            public CopyOperationBuilder setSourceOptions(Iterable<BlobReadOption> writeParams) {
            ...
            public CopyOperationBuilder setTarget(BlobIdentifier destinationId) {
                ...
                this.destinationBlob = BlobMetadata.newBuilder(destinationId).buildMetadata();
                return this;
            }
             ...
             * @return the builder
             */
            public CopyOperationBuilder setTarget(BlobIdentifier destinationId, BlobUploadOption... writeParams) {
                this.allowOverwrite = false;
                this.destinationBlob = BlobMetadata.newBuilder(destinationId).buildMetadata();
                Collections.addAll(targetConfigs, writeParams);
                return this;
             ...
             * @return the builder
             */
            public CopyOperationBuilder setTarget(BlobMetadata destinationBlob, BlobUploadOption... writeParams) {
             ...
             * @return the builder
             */
            public CopyOperationBuilder setTarget(BlobMetadata destinationBlob, Iterable<BlobUploadOption> writeParams) {
                this.allowOverwrite = true;
                this.destinationBlob = checkNotNull(destinationBlob);
                Iterables.addAll(targetConfigs, writeParams);
                return this;
             ...
             * @return the builder
             */
            public CopyOperationBuilder setTarget(BlobIdentifier destinationId, Iterable<BlobUploadOption> writeParams) {
                this.allowOverwrite = false;
                this.destinationBlob = BlobMetadata.newBuilder(destinationId).buildMetadata();
                Iterables.addAll(targetConfigs, writeParams);
                return this;
        ...
        private CopyOperationRequest(CopyOperationBuilder requestAssembler) {
            origin = checkNotNull(requestAssembler.origin);
            readSettings = ImmutableList.copyOf(requestAssembler.readSettings);
            allowOverwrite = requestAssembler.allowOverwrite;
            destinationBlob = checkNotNull(requestAssembler.destinationBlob);
            targetConfigs = ImmutableList.copyOf(requestAssembler.targetConfigs);
            chunkSizeMb = requestAssembler.chunkSizeMb;
        }
         ...
         * @param originBlobName name of the source blob
         * @param destinationBlob a {@code BlobInfo} object for the target blob
         * @return a copy request
         */
        public static CopyOperationRequest create(String originBucket, String originBlobName, BlobMetadata destinationBlob) {
            return builder().setSource(originBucket, originBlobName).setTarget(destinationBlob).buildRequest();
        }
         ...
         * @return a copy request
         */
        public static CopyOperationRequest create(BlobIdentifier originBlobId, BlobMetadata destinationBlob) {
            return builder().setSource(originBlobId).setTarget(destinationBlob).buildRequest();
        }
         ...
         * @return a copy request
         */
        public static CopyOperationRequest create(String originBucket, String originBlobName, String destinationBlobName) {
            return CopyOperationRequest.builder().setSource(originBucket, originBlobName).setTarget(BlobIdentifier.from(originBucket, destinationBlobName)).buildRequest();
        }
         ...
         * @return a copy request
         */
        public static CopyOperationRequest create(String originBucket, String originBlobName, BlobIdentifier destinationBlob) {
            return builder().setSource(originBucket, originBlobName).setTarget(destinationBlob).buildRequest();
        }
         ...
         * @return a copy request
         */
        public static CopyOperationRequest create(BlobIdentifier originBlobId, String destinationBlobName) {
            return CopyOperationRequest.builder().setSource(originBlobId).setTarget(BlobIdentifier.from(originBlobId.getBucket(), destinationBlobName)).buildRequest();
        }
         ...
         * @return a copy request
         */
        public static CopyOperationRequest create(BlobIdentifier originBlobId, BlobIdentifier destinationBlobId) {
            return CopyOperationRequest.builder().setSource(originBlobId).setTarget(destinationBlobId).buildRequest();
        }
     ...
     */
    StorageObject createFrom(BlobMetadata blobMetadata, Path fileLocation, BlobWriteOptions... writeParams) throws IOException;
     ...
     * @param blobMetadata blob to create
     * @param fileLocation file to upload
     * @param chunkLength size of the buffer I/O operations
     * @param writeParams blob write options
     * @return a {@code Blob} with complete information
     * @throws IOException on I/O error
     * @throws StorageServiceException on server side error
     */
    StorageObject createFrom(BlobMetadata blobMetadata, Path fileLocation, int chunkLength, BlobWriteOptions... writeParams) throws IOException;
     ...
     */
    StorageObject createFrom(BlobMetadata blobMetadata, InputStream dataBytes, BlobWriteOptions... writeParams) throws IOException;
     ...
     * @throws StorageServiceException on server side error
     */
    StorageObject createFrom(BlobMetadata blobMetadata, InputStream dataBytes, int chunkLength, BlobWriteOptions... writeParams) throws IOException;
    ...
    /**
     * Lists the bucket's blobs. If the {@link BlobListOptions#onlyCurrentDirectory()} option is provided,
     ...
     */
    StorageObject update(BlobMetadata blobMetadata, BlobUploadOption... writeParams);
     ...
     * move it to a different bucket use the {@link StorageObject#copyToDestination} and {@link #delete} operations.
     *
     ...
     *
     * <p>Accepts an optional userProject {@link BucketOption} option which defines the project
     * id to assign operational costs.
     *
     ...
     * @throws StorageServiceException upon failure
     */
    boolean delete(String bucket, BucketOption... options);
     ...
     *
     * <p>This method returns a {@link BlobRewriteWriter} object for the provided {@code CopyRequest}. If
     * source and destination objects share the same location and storage class the source blob is
     * copied with one request and {@link BlobRewriteWriter#getResult()} immediately returns, regardless of
     * the {@link CopyOperationRequest#chunkSizeMb} parameter. If source and destination have
     * different location or storage class {@link BlobRewriteWriter#getResult()} might issue multiple RPC
     ...
     */
    BlobRewriteWriter copy(CopyOperationRequest copyRequest);
     ...
     * @param validity time until the signed URL expires, expressed in {@code unit}. The finest
     ...
     */
    URL signUrl(BlobMetadata blobMetadata, long validity, TimeUnit timeUnit, UrlSigningOption... writeParams);
     ...
     * credentials) then {@code signUrl} will throw an {@link IllegalStateException} unless an
     * implementation of {@link ServiceAccountSigner} is passed using the {@link
     * PostPolicyV4FormField#withSigner(ServiceAccountSigner)} option.
     *
     ...
     * @param validity time before expiration
     ...
     * @param validity how long until the form expires, in milliseconds
     ...
     *     Object</a>
     */
    S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobMetadata, long validity, TimeUnit timeUnit, S3PostPolicyV4.PostFieldsMapV4 selectedAttributes, PostConditionsVersion4 policyConstraints, PostPolicyV4FormField... writeParams);
     ...
     * TimeUnit, S3PostPolicyV4.PostFieldsMapV4, S3PostPolicyV4.PostConditionsVersion4, PostPolicyV4FormField...)}.
     */
    S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobInfo, long duration, TimeUnit unit, S3PostPolicyV4.PostFieldsMapV4 fields, PostPolicyV4FormField... options);
     ...
     * PostFieldsMapV4, PostConditionsVersion4, PostPolicyV4FormField...)}.
     */
    S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobInfo, long duration, TimeUnit unit, PostConditionsVersion4 conditions, PostPolicyV4FormField... options);
     ...
     * PostConditionsVersion4, PostPolicyV4FormField...)}.
     */
    S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobInfo, long duration, TimeUnit unit, PostPolicyV4FormField... options);
     ...
     * }</pre>
     *
     * @param container name of the bucket where the getAcl operation takes place
     * @param protoPrincipal ACL entity to fetch
     * @param writeParams extra parameters to apply to this operation
     * @throws StorageServiceException upon failure
     */
    AccessControlEntry getAcl(String container, AccessControlEntry.ProtoEntity protoPrincipal, BucketOption... writeParams);

    /**
     * @see #getAcl(String, ProtoEntity, BucketOption...)
     */
    AccessControlEntry getAcl(String bucket, AccessControlEntry.ProtoEntity entity);
     ...
     * }</pre>
     *
     * @param container name of the bucket to delete an ACL from
     * @param protoPrincipal ACL entity to delete
     * @param writeParams extra parameters to apply to this operation
     * @return {@code true} if the ACL was deleted, {@code false} if it was not found
     * @throws StorageServiceException upon failure
     */
    boolean deleteAcl(String container, AccessControlEntry.ProtoEntity protoPrincipal, BucketOption... writeParams);

    /**
     * @see #deleteAcl(String, AccessControlEntry.ProtoEntity, BucketOption...)
     */
    boolean deleteAcl(String bucket, AccessControlEntry.ProtoEntity entity);
     ...
     * }</pre>
     *
     * @param container name of the bucket for which an ACL should be created
     * @param accessControlSetting ACL to create
     * @param writeParams extra parameters to apply to this operation
     * @throws StorageServiceException upon failure
     */
    AccessControlEntry createAcl(String container, AccessControlEntry accessControlSetting, BucketOption... writeParams);

    /**
     * @see #createAcl(String, AccessControlEntry, BucketOption...)
     */
     ...
     * }</pre>
     *
     * @param container name of the bucket where the updateAcl operation takes place
     * @param accessControlSetting ACL to update
     * @param writeParams extra parameters to apply to this operation
     * @throws StorageServiceException upon failure
     */
    AccessControlEntry updateAcl(String container, AccessControlEntry accessControlSetting, BucketOption... writeParams);

    /**
     * @see #updateAcl(String, AccessControlEntry, BucketOption...)
     */
     ...
     * }</pre>
     *
     * @param container the name of the bucket to list ACLs for
     * @param writeParams any number of BucketSourceOptions to apply to this operation
     * @throws StorageServiceException upon failure
     */
    List<AccessControlEntry> listAcls(String container, BucketOption... writeParams);
     ...
     * @throws StorageServiceException upon failure
     */
    AccessControlEntry getDefaultAcl(String bucket, AccessControlEntry.ProtoEntity entity);
     ...
     * @throws StorageServiceException upon failure
     */
    boolean deleteDefaultAcl(String bucket, AccessControlEntry.ProtoEntity entity);
     ...
     * @throws StorageServiceException upon failure
     */
    AccessControlEntry getAcl(BlobIdentifier blob, AccessControlEntry.ProtoEntity entity);
     ...
     * @throws StorageServiceException upon failure
     */
    boolean deleteAcl(BlobIdentifier blob, AccessControlEntry.ProtoEntity entity);
     ...
     * @throws StorageServiceException upon failure
     */
    Page<HmacSecretKey.HmacKeyInfo> listHmacKeys(ListHmacKeysOptions... writeParams);
     ...
     * @throws StorageServiceException upon failure
     */
    void deleteHmacKey(HmacSecretKey.HmacKeyInfo hmacKeyMetadata, DeleteHmacKeyRequestOption... options);
     ...
     * @throws StorageServiceException upon failure
     */
    HmacKeyInfo updateHmacKeyState(final HmacSecretKey.HmacKeyInfo hmacKeyMetadata, final HmacSecretKey.HmacKeyStatus state, HmacKeyUpdateOption... options);
     ...
     * }</pre>
     *
     * @param container name of the bucket where the getIamPolicy operation takes place
     * @param writeParams extra parameters to apply to this operation
     * @throws StorageServiceException upon failure
     */
    Policy getIamPolicy(String container, BucketOption... writeParams);
     ...
     * }</pre>
     *
     * @param container name of the bucket where the setIamPolicy operation takes place
     * @param permissionSet policy to be set on the specified bucket
     * @param writeParams extra parameters to apply to this operation
     * @throws StorageServiceException upon failure
     */
    Policy setIamPolicy(String container, Policy permissionSet, BucketOption... writeParams);
     ...
     * }</pre>
     *
     * @param container name of the bucket where the testIamPermissions operation takes place
     * @param allowedActions list of permissions to test on the bucket
     * @param writeParams extra parameters to apply to this operation
     * @throws StorageServiceException upon failure
     */
    List<Boolean> testIamPermissions(String container, List<String> allowedActions, BucketOption... writeParams);
