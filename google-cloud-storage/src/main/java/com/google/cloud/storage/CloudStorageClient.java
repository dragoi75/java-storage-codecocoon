...
public interface CloudStorageClient extends Service<StorageClientOptions> {
  ...
  class BucketTargetOptions extends AbstractOption {
    ...
    public static BucketTargetOptions predefinedDefaultObjectAcl(PredefinedAccessControl accessControlSetting) {
      return new BucketTargetOptions(
          StorageRpcClient.StorageOption.PREDEFINED_DEFAULT_OBJECT_ACL, accessControlSetting.getEntry());
    }
  ...
  class ListHmacKeysOptions extends AbstractOption {
    ...
    public static ListHmacKeysOptions serviceAccountEmail(ServiceAccountInfo accountInfo) {
      return new ListHmacKeysOptions(
          StorageRpcClient.StorageOption.SERVICE_ACCOUNT_EMAIL, accountInfo.getEmail());
    }
  ...
  class BucketGetOptions extends AbstractOption {
    ...
    public static BucketGetOptions selectedFields(BucketMetadataField... selectedAttributes) {
      return new BucketGetOptions(
          StorageRpcClient.StorageOption.FIELDS, Helper.selector(BucketMetadataField.FIELD_SELECTORS, selectedAttributes));
    }
  }
  ...
  class BlobUploadOption extends AbstractOption {
    ...
    static Tuple<BlobMetadata, BlobUploadOption[]> convertWriteOptions(BlobMetadata blobMetadata, BlobWriteOptions... writeParams) {
      ...
      return Tuple.of(
          metadataBuilder.buildMetadata(), targetConfigs.toArray(new BlobUploadOption[targetConfigs.size()]));
    }
  }
  ...
  class BlobWriteOptions implements Serializable {
    ...
    public boolean equals(Object comparisonObject) {
      ...
      return this.writeParam == comparedInstance.writeParam && Objects.equals(this.payload, comparedInstance.payload);
    }
  ...
  class BlobGetOptions extends AbstractOption {
    ...
    public static BlobGetOptions selectFields(BlobMetadataField... selectedAttributes) {
      return new BlobGetOptions(
          StorageRpcClient.StorageOption.FIELDS, Helper.selector(BlobMetadataField.FIELD_SELECTORS, selectedAttributes));
    }
  ...
  class BucketListOptions extends AbstractOption {
    ...
    public static BucketListOptions selectFields(BucketMetadataField... selectedAttributes) {
      return new BucketListOptions(
          StorageRpcClient.StorageOption.FIELDS,
          Helper.listSelector("items", BucketMetadataField.FIELD_SELECTORS, selectedAttributes));
    }
  }
  ...
  class BlobListOptions extends AbstractOption {
    ...
    public static BlobListOptions withFields(BlobMetadataField... selectedAttributes) {
      return new BlobListOptions(
          StorageRpcClient.StorageOption.FIELDS,
          Helper.listSelector(TOP_LEVEL_PROPERTIES, "items", BlobMetadataField.FIELD_SELECTORS, selectedAttributes));
    }
  }
  ...
  class PostPolicyV4FormField implements Serializable {
     ...
     *     GCLB Redirects</a>
     */
    public static PostPolicyV4FormField withBucketBoundHostname(
            String bucketHost, UriSchemeType schemeType) {
      return new PostPolicyV4FormField(
          StorageOption.BUCKET_BOUND_HOST_NAME,
          schemeType.getScheme() + "://" + bucketHost);
    }
  }
  ...
  class UrlSigningOption implements Serializable {
    ...
    public static UrlSigningOption withBucketBoundHostname(
      ...
      return new UrlSigningOption(
          RequestOption.BUCKET_BOUND_HOST_NAME, schemeType.getScheme() + "://" + bucketHost);
    }
  ...
  class CopyOperationRequest implements Serializable {
    ...
    public static CopyOperationRequest create(String originBucket, String originBlobName, String destinationBlobName) {
      return CopyOperationRequest.builder()
          ...
          .setTarget(BlobIdentifier.from(originBucket, destinationBlobName))
          .buildRequest();
    }
    ...
    public static CopyOperationRequest create(BlobIdentifier originBlobId, String destinationBlobName) {
      return CopyOperationRequest.builder()
          ...
          .setTarget(BlobIdentifier.from(originBlobId.getBucket(), destinationBlobName))
          .buildRequest();
    }
  ...
  StorageObject create(
          BlobMetadata blobInfo, byte[] content, int offset, int length, BlobUploadOption... options);
   ...
   * @throws StorageServiceException on server side error
   */
  StorageObject createFrom(BlobMetadata blobMetadata, Path fileLocation, int chunkLength, BlobWriteOptions... writeParams)
      throws IOException;
   ...
   */
  StorageObject createFrom(BlobMetadata blobMetadata, InputStream dataBytes, BlobWriteOptions... writeParams)
      throws IOException;
  ...
  StorageObject createFrom(
          BlobMetadata blobMetadata, InputStream dataBytes, int chunkLength, BlobWriteOptions... writeParams)
      throws IOException;
   ...
   *     Object</a>
   */
  S3PostPolicyV4 generateSignedPostPolicyV4(
      BlobMetadata blobMetadata,
      long validity,
      TimeUnit timeUnit,
      S3PostPolicyV4.PostFieldsMapV4 selectedAttributes,
      PostConditionsVersion4 policyConstraints,
      PostPolicyV4FormField... writeParams);
   ...
   */
  S3PostPolicyV4 generateSignedPostPolicyV4(
          BlobMetadata blobInfo, long duration, TimeUnit unit, PostPolicyV4FormField... options);
  ...
  List<Boolean> testIamPermissions(
          String container, List<String> allowedActions, BucketOption... writeParams);
