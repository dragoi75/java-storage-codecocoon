...
public interface CloudStorageClient extends Service<StorageClientOptions> {
     ...
     * @throws StorageServiceException upon failure
     */
    boolean deleteAcl(String container, ProtoEntity protoPrincipal, BucketOption... writeParams);
     ...
     * @throws StorageServiceException upon failure
     */
    Page<HmacKeyInfo> listHmacKeys(ListHmacKeysOptions... writeParams);
     ...
     * @throws StorageServiceException upon failure
     */
    boolean deleteAcl(BlobIdentifier blob, ProtoEntity entity);

    /**
     * @see #getAcl(String, ProtoEntity, BucketOption...)
     */
    AccessControlEntry getAcl(String bucket, ProtoEntity entity);
     ...
     * @throws StorageServiceException upon failure
     */
    boolean deleteDefaultAcl(String bucket, ProtoEntity entity);
     ...
     * @throws StorageServiceException upon failure
     */
    AccessControlEntry getAcl(String container, ProtoEntity protoPrincipal, BucketOption... writeParams);
     ...
     * @throws StorageServiceException upon failure
     */
    HmacKeyInfo updateHmacKeyState(final HmacKeyInfo hmacKeyMetadata, final HmacSecretKey.HmacKeyStatus state, HmacKeyUpdateOption... options);
     ...
     * ServiceAccountSigner} was passed to {@link StorageClientOptions}' builder via {@code
     ...
     *     Object</a>
     */
    S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobMetadata, long validity, TimeUnit timeUnit, PostFieldsMapV4 selectedAttributes, PostConditionsVersion4 policyConstraints, PostPolicyV4FormField... writeParams);
     ...
     * @throws StorageServiceException upon failure
     */
    AccessControlEntry getDefaultAcl(String bucket, ProtoEntity entity);
     ...
     * TimeUnit, PostFieldsMapV4, PostConditionsVersion4, PostPolicyV4FormField...)}.
     */
    S3PostPolicyV4 generateSignedPostPolicyV4(BlobMetadata blobInfo, long duration, TimeUnit unit, PostFieldsMapV4 fields, PostPolicyV4FormField... options);
    ...
    /**
     * @see #deleteAcl(String, ProtoEntity, BucketOption...)
     */
    boolean deleteAcl(String bucket, ProtoEntity entity);
     ...
     * @throws StorageServiceException upon failure
     */
    void deleteHmacKey(HmacKeyInfo hmacKeyMetadata, DeleteHmacKeyRequestOption... options);
     ...
     * @throws StorageServiceException upon failure
     */
    AccessControlEntry getAcl(BlobIdentifier blob, ProtoEntity entity);
