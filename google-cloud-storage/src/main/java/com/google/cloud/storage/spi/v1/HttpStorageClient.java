...
public class HttpStorageClient implements StorageRpcClient {
    ...
    public StorageObject create(StorageObject objectMetadata, final InputStream inputStream, Map<StorageOption, ?> clientConfig) {
        ...
        Scope tracingScope = telemetry.withSpan(spanContext);
        try {
            Storage.Objects.Insert uploadAction = dataStore.objects().insert(objectMetadata.getBucket(), objectMetadata, new InputStreamContent(resolveContentType(objectMetadata, clientConfig), inputStream));
    ...
    private Storage.Objects.Get getCall(StorageObject obj, Map<StorageOption, ?> clientConfig) throws IOException {
