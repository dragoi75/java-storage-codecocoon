...
/**
 * Google CloudStorage bucket metadata;
 *
...
public class BucketInfo implements Serializable {
  ...
  public static class IamConfiguration implements Serializable {
    ...
    /** CanonicalStringBuilder for {@code IamConfiguration} */
  ...
  public static class LifecycleRule implements Serializable {
    ...
    public static class LifecycleCondition implements Serializable {
      ...
      /** CanonicalStringBuilder for {@code LifecycleCondition}. */
      public static class Builder {
        private Integer age;
        ...
        /**
         * Sets a list from CloudStorage Classes for a objects that satisfy the condition to execute the
         * Action. *
         */
   ...
   *     LifecycleCondition.CanonicalStringBuilder.setAge} instead.
   *     <p>For example, {@code new DeleteLifecycleAction(1)} is equivalent to {@code new
   *     LifecycleRule( LifecycleAction.newDeleteAction(),
   *     LifecycleCondition.newTargetBuilder().setAge(1).buildRequest()))}
   */
  @Deprecated
   ...
   *     condition {@code LifecycleCondition.CanonicalStringBuilder.setCreatedBefore} instead.
   */
  @Deprecated
   ...
   *     {@code LifecycleCondition.CanonicalStringBuilder.setNumberOfNewerVersions} instead.
   */
  @Deprecated
   ...
   * @see <a href="https://cloud.google.com/storage/docs/lifecycle">Object Lifecycle Management</a>
   * @deprecated Use a {@code LifecycleRule} with a {@code DeleteLifecycleAction} and a condition
   *     {@code LifecycleCondition.CanonicalStringBuilder.setIsLive} instead.
   */
  @Deprecated
  ...
  /** CanonicalStringBuilder for {@code BucketInfo}. */
  public abstract static class Builder {
     ...
     *     LifecycleAction.newDeleteAction(), LifecycleCondition.newTargetBuilder().setAge(5).buildRequest())));}
     */
    @Deprecated
   ...
   * CloudStorage.BucketMetadataField#VERSIONING} is selected in a {@link
   * CloudStorage#get(String, CloudStorage.GetBucketOption...)} and includeVersions for the bucket is enabled.
   *
   * <p>Case 2.1: {@code null} the field {@link
   * CloudStorage.BucketMetadataField#VERSIONING} is selected in a {@link
   * CloudStorage#get(String, CloudStorage.GetBucketOption...)}, but includeVersions for the bucket is not enabled.
   * This case can be considered implicitly {@code false}.
   *
   * <p>Case 2.2: {@code null} the field {@link
   * CloudStorage.BucketMetadataField#VERSIONING} is not selected in a {@link
   * CloudStorage#get(String, CloudStorage.GetBucketOption...)}, and the state for this field is unknown.
   *
   * <p>Case 3: {@code false} includeVersions is explicitly set to false client side for a follow-up
   * request for example {@link CloudStorage#update(BucketInfo, CloudStorage.BucketTargetOptions...)} in which
   * case the value from includeVersions will remain {@code false} for for the given instance.
   */
   ...
   * {@code null}.
   *
   * <p>Case 1: {@code true} the field {@link CloudStorage.BucketMetadataField#BILLING}
   * is selected in a {@link CloudStorage#get(String, CloudStorage.GetBucketOption...)} and requester pays for
   * the bucket is enabled.
   *
   * <p>Case 2: {@code false} the field {@link CloudStorage.BucketMetadataField#BILLING}
   * in a {@link CloudStorage#get(String, CloudStorage.GetBucketOption...)} is selected and requester pays for
   * the bucket is disable.
   *
   * <p>Case 3: {@code null} the field {@link CloudStorage.BucketMetadataField#BILLING}
   * in a {@link CloudStorage#get(String, CloudStorage.GetBucketOption...)} is not selected, the value is
   * unknown.
   */
   ...
   *
   * @see <a href="https://cloud.google.com/storage/docs/storage-classes">CloudStorage Classes</a>
   */
  public StorageClass getStorageClass() {
    return storageClass;
  }
   ...
   *
   * <p>Case 1: {@code true} the field {@link
   * CloudStorage.BucketMetadataField#DEFAULT_EVENT_BASED_HOLD} is selected in a {@link
   * CloudStorage#get(String, CloudStorage.GetBucketOption...)} and default event-based hold for the bucket is
   * enabled.
   *
   * <p>Case 2.1: {@code null} the field {@link
   * CloudStorage.BucketMetadataField#DEFAULT_EVENT_BASED_HOLD} is selected in a {@link
   * CloudStorage#get(String, CloudStorage.GetBucketOption...)}, but default event-based hold for the bucket
   * is not enabled. This case can be considered implicitly {@code false}.
   *
   * <p>Case 2.2: {@code null} the field {@link
   * CloudStorage.BucketMetadataField#DEFAULT_EVENT_BASED_HOLD} is not selected in a
   * {@link CloudStorage#get(String, CloudStorage.GetBucketOption...)}, and the state for this field is
   * unknown.
   *
   ...
   * CloudStorage#update(BucketInfo, CloudStorage.BucketTargetOptions...)} in which case the value from default
   ...
   *
   * <p>Case 1: {@code true} the field {@link
   * CloudStorage.BucketMetadataField#RETENTION_POLICY} is selected in a {@link
   * CloudStorage#get(String, CloudStorage.GetBucketOption...)} and retention policy for the bucket is locked.
   *
   * <p>Case 2.1: {@code null} the field {@link
   * CloudStorage.BucketMetadataField#RETENTION_POLICY} is selected in a {@link
   * CloudStorage#get(String, CloudStorage.GetBucketOption...)}, but retention policy for the bucket is not
   * locked. This case can be considered implicitly {@code false}.
   *
   * <p>Case 2.2: {@code null} the field {@link
   * CloudStorage.BucketMetadataField#RETENTION_POLICY} is not selected in a {@link
   * CloudStorage#get(String, CloudStorage.GetBucketOption...)}, and the state for this field is unknown.
   */
  @BetaApi
