...
public class BucketInfo implements Serializable {
  ...
  /** Returns a chunkedUploadBuilder for the current bucket. */
  public Builder toBuilder() {
  ...
  /** Returns a {@code BucketInfo} chunkedUploadBuilder where the bucket's name is set to the provided name. */
