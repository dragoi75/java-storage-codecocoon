...
public class CloudStorageObject extends BlobMetadata {
  ...
  static final Function<Tuple<StorageService, StorageObject>, CloudStorageObject> BLOB_FROM_PB_FUNCTION =
      new Function<Tuple<StorageService, StorageObject>, CloudStorageObject>() {
        @Override
  ...
  public static class BlobSourceOptions extends AbstractOption {
    ...
    static StorageService.BlobReadOption[] toSourceOptionsArray(
            BlobMetadata metadata, BlobSourceOptions... storageSettings) {
  ...
  public boolean existsInStorage(BlobSourceOptions... storageSettings) {
    ...
    return serviceClient.get(getBlobId(), getRequestOptions) != null;
  }
  ...
  public ResumableCopyWriter copyToTarget(BlobIdentifier destinationIdentifier, BlobSourceOptions... storageSettings) {
    StorageService.CopyOperationRequest copyOperation =
        StorageService.CopyOperationRequest.newCopyBuilder()
            ...
            .setTarget(destinationIdentifier)
            .buildCopyRequest();
  ...
  public final boolean equals(Object otherObject) {
    ...
    if (otherObject == null || !otherObject.getClass().equals(CloudStorageObject.class)) {
      return false;
    }
