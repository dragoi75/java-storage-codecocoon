...
public final class HttpRequestMethod extends StringEnumValue {
  ...
  private static final StringEnumType<HttpRequestMethod> HTTP_REQUEST_METHOD_TYPE =
      new StringEnumType(HttpRequestMethod.class, METHOD_CONSTRUCTOR_FUNC);

  public static final HttpRequestMethod GET = HTTP_REQUEST_METHOD_TYPE.createAndRegister("GET");
  public static final HttpRequestMethod HEAD = HTTP_REQUEST_METHOD_TYPE.createAndRegister("HEAD");
  public static final HttpRequestMethod PUT = HTTP_REQUEST_METHOD_TYPE.createAndRegister("PUT");
  public static final HttpRequestMethod POST = HTTP_REQUEST_METHOD_TYPE.createAndRegister("POST");
