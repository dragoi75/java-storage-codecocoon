...
public final class HttpRequestMethod extends StringEnumValue {
  ...
  private static final StringEnumType<HttpRequestMethod> HTTP_REQUEST_METHOD_ENUM =
      new StringEnumType(HttpRequestMethod.class, STRING_TO_HTTP_REQUEST_METHOD_FN);

  public static final HttpRequestMethod GET = HTTP_REQUEST_METHOD_ENUM.createAndRegister("GET");
  public static final HttpRequestMethod HEAD = HTTP_REQUEST_METHOD_ENUM.createAndRegister("HEAD");
  public static final HttpRequestMethod PUT = HTTP_REQUEST_METHOD_ENUM.createAndRegister("PUT");
  public static final HttpRequestMethod POST = HTTP_REQUEST_METHOD_ENUM.createAndRegister("POST");
