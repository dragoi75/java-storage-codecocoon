...
public final class HttpRequestMethod extends StringEnumValue {
  ...
  private static final StringEnumType<HttpRequestMethod> ENUM_TYPE =
      new StringEnumType(HttpRequestMethod.class, FACTORY_FUNCTION);

  public static final HttpRequestMethod GET = ENUM_TYPE.createAndRegister("GET");
  public static final HttpRequestMethod HEAD = ENUM_TYPE.createAndRegister("HEAD");
  public static final HttpRequestMethod PUT = ENUM_TYPE.createAndRegister("PUT");
  public static final HttpRequestMethod POST = ENUM_TYPE.createAndRegister("POST");
