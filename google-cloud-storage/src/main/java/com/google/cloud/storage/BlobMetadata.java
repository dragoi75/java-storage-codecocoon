...
public class BlobMetadata implements Serializable {
  ...
  static final Function<BlobMetadata, StorageObject> INFO_TO_PB_MAPPER =
  ...
  public static class CustomerEncryptionInfo implements Serializable {
    ...
    StorageObject.CustomerEncryption toProto() {
      return new StorageObject.CustomerEncryption()
          .setEncryptionAlgorithm(algorithmName)
          .setKeySha256(keyDigest);
    }
    ...
    static CustomerEncryptionInfo fromProto(StorageObject.CustomerEncryption encryptionProto) {
      return new CustomerEncryptionInfo(
          encryptionProto.getEncryptionAlgorithm(), encryptionProto.getKeySha256());
    }
  }
  ...
  public Map<String, String> getMetadata() {
    return customAttributes == null || Data.isNull(customAttributes) ? null : Collections.unmodifiableMap(customAttributes);
  }
  ...
  StorageObject toProto() {
    ...
    if (customAttributes != null && !Data.isNull(customAttributes)) {
      ...
      for (Map.Entry<String, String> mapPair : customAttributes.entrySet()) {
        protoMetadataMap.put(
            mapPair.getKey(), firstNonNull(mapPair.getValue(), Data.<String>nullOf(String.class)));
      }
    }
  ...
  static BlobMetadata fromPb(StorageObject protoObject) {
    ...
    if (protoObject.getCustomerEncryption() != null) {
      blobInfoFactory.setCustomerEncryption(
          CustomerEncryptionInfo.fromProto(protoObject.getCustomerEncryption()));
    }
    if (protoObject.getStorageClass() != null) {
      blobInfoFactory.setStorageClass(StorageTier.fromValue(protoObject.getStorageClass()));
    }
    if (protoObject.getKmsKeyName() != null) {
      blobInfoFactory.setKmsKeyName(protoObject.getKmsKeyName());
    }
    if (protoObject.getEventBasedHold() != null) {
      blobInfoFactory.setEventBasedHold(protoObject.getEventBasedHold());
    }
    if (protoObject.getTemporaryHold() != null) {
      blobInfoFactory.setTemporaryHold(protoObject.getTemporaryHold());
    }
    if (protoObject.getRetentionExpirationTime() != null) {
