...
public class BlobMetadata implements Serializable {
  ...
  static final Function<BlobMetadata, com.google.api.services.storage.model.StorageObject> BLOB_METADATA_TO_PB_FN =
      new Function<BlobMetadata, com.google.api.services.storage.model.StorageObject>() {
        @Override
  ...
  public static class CustomerEncryptionMetadata implements Serializable {
    ...
    public final boolean equals(Object other) {
      return other == this
          || other != null
              && other.getClass().equals(CustomerEncryptionMetadata.class)
              && Objects.equals(toProto(), ((CustomerEncryptionMetadata) other).toProto());
    }
    ...
    com.google.api.services.storage.model.StorageObject.CustomerEncryption toProto() {
      return new com.google.api.services.storage.model.StorageObject.CustomerEncryption()
          .setEncryptionAlgorithm(encryptionAlgorithmName)
    ...
    static CustomerEncryptionMetadata fromProto(com.google.api.services.storage.model.StorageObject.CustomerEncryption customerEncryptionProto) {
      return new CustomerEncryptionMetadata(
  ...
  static final class BlobInfoBuilderImpl extends StorageObjectBuilder {
    ...
    public BlobMetadata.StorageObjectBuilder setMd5FromHexString(String hexDigest) {
      ...
      for (int charPos = 0; charPos < hexDigestLower.length(); charPos += 2) {
  ...
  public Map<String, String> getMetadata() {
    return metaMap == null || Data.isNull(metaMap) ? null : Collections.unmodifiableMap(metaMap);
  }
  ...
  com.google.api.services.storage.model.StorageObject toProto() {
    ...
    if (metaMap != null && !Data.isNull(metaMap)) {
    ...
    if (customerEncryptionMetadata != null) {
