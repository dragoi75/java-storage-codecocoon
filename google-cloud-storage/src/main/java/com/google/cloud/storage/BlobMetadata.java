...
public class BlobMetadata implements Serializable {
  ...
  static final Function<BlobMetadata, StorageObject> METADATA_TO_PROTO_FN =
  ...
  public static class CustomerEncryptionSettings implements Serializable {
    ...
    public final boolean equals(Object other) {
      return other == this
          || other != null
              && other.getClass().equals(CustomerEncryptionSettings.class)
              && Objects.equals(toProto(), ((CustomerEncryptionSettings) other).toProto());
    }
    ...
    static CustomerEncryptionSettings fromProto(StorageObject.CustomerEncryption protoEncryption) {
      return new CustomerEncryptionSettings(
          protoEncryption.getEncryptionAlgorithm(), protoEncryption.getKeySha256());
    }
  }
  ...
  static BlobMetadata fromProto(StorageObject protoObject) {
    ...
    if (protoObject.getCustomerEncryption() != null) {
      blobInfoBuilder.setCustomerEncryption(
          CustomerEncryptionSettings.fromProto(protoObject.getCustomerEncryption()));
    }
