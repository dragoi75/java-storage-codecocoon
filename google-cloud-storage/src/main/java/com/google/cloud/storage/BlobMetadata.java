...
public class BlobMetadata implements Serializable {
  ...
  static final Function<BlobMetadata, com.google.api.services.storage.model.StorageObject> INFO_TO_PROTO_FUNCTION =
  ...
  public static class CustomerEncryptionInfo implements Serializable {
    ...
    public final boolean equals(Object otherObject) {
      return otherObject == this
          || otherObject != null
              && otherObject.getClass().equals(CustomerEncryptionInfo.class)
              && Objects.equals(toProto(), ((CustomerEncryptionInfo) otherObject).toProto());
    }
    ...
    com.google.api.services.storage.model.StorageObject.CustomerEncryption toProto() {
      return new com.google.api.services.storage.model.StorageObject.CustomerEncryption()
          .setEncryptionAlgorithm(cipherAlgorithm)
          .setKeySha256(keyFingerprint);
    }
  ...
  static final class BlobMetadataBuilderImpl extends BlobMetadataBuilder {
    ...
    public BlobMetadata.BlobMetadataBuilder setMd5FromHexString(String hexDigest) {
      ...
      for (int charPos = 0; charPos < md5HexLower.length(); charPos += 2) {
        ...
        if (highOrderBits == -1 || lowOrderBits == -1) {
          throw new IllegalArgumentException(
              "each byte must be represented by 2 valid hexadecimal characters");
        }
    ...
    public BlobMetadata.BlobMetadataBuilder setCrc32cFromHexString(String checksum32Hex) {
      if (checksum32Hex == null) {
        return this;
      }
      if (checksum32Hex.length() % 2 != 0) {
        throw new IllegalArgumentException(
            "each byte must be represented by 2 valid hexadecimal characters");
      }
  ...
  public boolean equals(Object otherObject) {
    return otherObject == this
        || otherObject != null
            && otherObject.getClass().equals(BlobMetadata.class)
            && Objects.equals(toProto(), ((BlobMetadata) otherObject).toProto());
  }
  ...
  static BlobMetadata fromProto(com.google.api.services.storage.model.StorageObject storageObj) {
    ...
    if (storageObj.getCustomerEncryption() != null) {
      blobMetadataBuilder.setCustomerEncryption(
          CustomerEncryptionInfo.fromProto(storageObj.getCustomerEncryption()));
    }
    if (storageObj.getStorageClass() != null) {
      blobMetadataBuilder.setStorageClass(StorageClassType.fromValue(storageObj.getStorageClass()));
    }
    if (storageObj.getTimeStorageClassUpdated() != null) {
      blobMetadataBuilder.setTimeStorageClassUpdated(storageObj.getTimeStorageClassUpdated().getValue());
    }
    if (storageObj.getKmsKeyName() != null) {
      blobMetadataBuilder.setKmsKeyName(storageObj.getKmsKeyName());
    }
    if (storageObj.getEventBasedHold() != null) {
      blobMetadataBuilder.setEventBasedHold(storageObj.getEventBasedHold());
    }
    if (storageObj.getTemporaryHold() != null) {
      blobMetadataBuilder.setTemporaryHold(storageObj.getTemporaryHold());
    }
    if (storageObj.getRetentionExpirationTime() != null) {
