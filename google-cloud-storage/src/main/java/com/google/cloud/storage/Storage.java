...
public interface Storage extends Service<StorageClientOptions> {
    ...
    class BlobWriteOptions implements Serializable {
        ...
        public static BlobWriteOptions customerSuppliedKey(String cryptoKey) {
            return new BlobWriteOptions(StorageOption.CUSTOMER_SUPPLIED_KEY, cryptoKey);
        }
        ...
        public static BlobWriteOptions withPredefinedAcl(PredefinedAccessControlList accessControlList) {
            return new BlobWriteOptions(StorageOption.PREDEFINED_ACL, accessControlList.getEntry());
        }
     ...
     */
    HmacKeyDetails updateHmacKeyState(final HmacKeyDetails hmacKeyMetadata, final HmacSecretKey.HmacKeyStatus state, HmacKeyUpdateOption... options);
     ...
     * TimeUnit, PostFieldsMapV4, PostConditionsV4Model, PostPolicyV4Parameter...)}.
     */
     ...
     * @throws StorageServiceException upon failure
     */
    Page<HmacKeyDetails> listHmacKeys(ListHmacKeysOptions... writeOptions);
     ...
     * PostConditionsV4Model, PostPolicyV4Parameter...)}.
     */
     ...
     * @throws StorageServiceException upon failure
     */
    HmacKeyDetails getHmacKey(String accessId, RetrieveHmacKeyOption... options);
     ...
     * @throws StorageServiceException upon failure
     */
    void deleteHmacKey(HmacKeyDetails hmacKeyMetadata, DeleteHmacKeyRequestOption... options);
