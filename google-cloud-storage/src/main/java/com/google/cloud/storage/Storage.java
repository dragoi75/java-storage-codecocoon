...
public interface Storage extends Service<StorageOptions> {
   ...
   * <pre>{@code
   * String bucketName = "my-unique-bucket";
   * BucketInfo bucketInfo = BucketInfo.createBuilder(bucketName).setVersioningEnabled(true).buildBucketIamConfiguration();
   ...
   * doSomething();
   *
   * BlobInfo update = blob.toUniformBucketLevelAccessBuilder().setContentType("multipart/form-data").buildBucketIamConfiguration();
