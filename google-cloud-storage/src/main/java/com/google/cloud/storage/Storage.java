...
public interface Storage extends Service<StorageClientOptions> {
  ...
  class ListHmacKeysOptions extends AbstractOption {
    ...
    public static ListHmacKeysOptions withServiceAccount(ServiceAccountInfo accountIdentity) {
      return new ListHmacKeysOptions(
          StorageRpcClient.StorageOption.SERVICE_ACCOUNT_EMAIL, accountIdentity.getEmail());
    }
  ...
  class GetBucketOption extends AbstractOption {
    ...
    public static GetBucketOption withFields(BucketAttribute... selectedAttributes) {
      return new GetBucketOption(
          StorageRpcClient.StorageOption.FIELDS, Helper.selector(BucketAttribute.MANDATORY_SELECTORS, selectedAttributes));
    }
  }
  ...
  class BlobUploadOption extends AbstractOption {
    ...
    static Tuple<BlobMetadata, BlobUploadOption[]> toBlobUploadOptions(BlobMetadata blobMetadata, BlobWriteOptions... writeOptions) {
      ...
      return Tuple.of(
          storageObjectBuilder.buildObject(), uploadOptionsList.toArray(new BlobUploadOption[uploadOptionsList.size()]));
    }
  }
  ...
  class BlobSourceOptions extends AbstractOption {
    ...
    public static BlobSourceOptions returnRawInputStream(boolean returnRawStream) {
      return new BlobSourceOptions(
          StorageRpcClient.StorageOption.RETURN_RAW_INPUT_STREAM, returnRawStream);
    }
  }
  ...
  class BlobGetOptions extends AbstractOption {
    ...
    public static BlobGetOptions selectFields(BlobMetadataField... selectedAttributes) {
      return new BlobGetOptions(
          StorageRpcClient.StorageOption.FIELDS, Helper.selector(BlobMetadataField.MANDATORY_SELECTORS, selectedAttributes));
    }
  ...
  class BucketListOptions extends AbstractOption {
    ...
    public static BucketListOptions selectFields(BucketAttribute... selectedAttributes) {
      return new BucketListOptions(
          ...
          Helper.listSelector("items", BucketAttribute.MANDATORY_SELECTORS, selectedAttributes));
    }
  }
  ...
  class BlobListOptions extends AbstractOption {
    ...
    public static BlobListOptions withFields(BlobMetadataField... selectedAttributes) {
      return new BlobListOptions(
          StorageRpcClient.StorageOption.FIELDS,
          Helper.listSelector(TOP_FIELDS, "items", BlobMetadataField.MANDATORY_SELECTORS, selectedAttributes));
    }
  }
  ...
  class PostPolicyV4Parameter implements Serializable {
    ...
    public static PostPolicyV4Parameter withBucketBoundHostname(
            String hostForBucket, UriSchemeType schemeType) {
      return new PostPolicyV4Parameter(
          StorageOption.BUCKET_BOUND_HOST_NAME,
          schemeType.getScheme() + "://" + hostForBucket);
    }
  }
  ...
  class UrlSigningOption implements Serializable {
    ...
    public static UrlSigningOption withBucketBoundHostname(
      ...
      return new UrlSigningOption(
          RequestOption.BUCKET_BOUND_HOST_NAME, schemeType.getScheme() + "://" + hostForBucket);
    }
  ...
  class ChunkedCopyRequest implements Serializable {
    ...
    public static ChunkedCopyRequest create(String srcBucket, String srcBlobName, String destBlob) {
      return ChunkedCopyRequest.newCopyOperationBuilder()
          .setSource(srcBucket, srcBlobName)
          .setTarget(BlobId.from(srcBucket, destBlob))
          .buildCopyRequest();
    }
    ...
    public static ChunkedCopyRequest create(BlobId srcBlobId, String destBlob) {
      return ChunkedCopyRequest.newCopyOperationBuilder()
          .setSource(srcBlobId)
          .setTarget(BlobId.from(srcBlobId.getBucket(), destBlob))
          .buildCopyRequest();
    }
   ...
   * @throws StorageServiceException on server side error
   */
  StorageObject createFrom(BlobMetadata blobMetadata, Path fileLocation, int chunkSize, BlobWriteOptions... writeOptions)
      throws IOException;
   ...
   */
  StorageObject createFrom(BlobMetadata blobMetadata, InputStream dataBytes, BlobWriteOptions... writeOptions)
      throws IOException;
  ...
  StorageObject createFrom(
          BlobMetadata blobMetadata, InputStream dataBytes, int chunkSize, BlobWriteOptions... writeOptions)
      throws IOException;
  ...
  S3PostPolicyV4 generateSignedPostPolicyV4(
      ...
      long timeout,
      TimeUnit timeScale,
      PostFieldsMapV4 selectedAttributes,
      PostConditionsV4Model postConstraints,
   ...
   * @throws StorageServiceException upon failure
   */
  HmacKeyDetails updateHmacKeyState(
  ...
  List<Boolean> testIamPermissions(
          String storageName, List<String> allowedActions, BucketSourceOptions... writeOptions);
