...
public final class AccessControlEntry implements Serializable {
  ...
  static final Function<ObjectAccessControl, AccessControlEntry> FROM_OBJECT_PROTO_FUNCTION =
  ...
  static final Function<BucketAccessControl, AccessControlEntry> FROM_BUCKET_PROTO_FUNCTION =
  ...
  public static final class RoleType extends StringEnumValue {
    ...
    private static final ApiFunction<String, RoleType> STRING_TO_ROLE_CONSTRUCTOR =
        new ApiFunction<String, RoleType>() {
          @Override
  ...
  public static final class ProjectInfo extends AbstractEntity {
    ...
    public static final class ProjectMemberRole extends StringEnumValue {
      ...
      private static final ApiFunction<String, ProjectMemberRole> STRING_TO_ROLE_CONSTRUCTOR =
      ...
      private static final StringEnumType<ProjectMemberRole> ROLE_TYPE_ENUM =
          new StringEnumType(ProjectMemberRole.class, STRING_TO_ROLE_CONSTRUCTOR);
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
        .add("entity", abstractEntityInstance)
        .add("role", roleType)
        .add("etag", eTagValue)
        .add("id", identifier)
        .toString();
  ...
  public boolean equals(Object otherObj) {
    ...
    return Objects.equals(this.abstractEntityInstance, thatEntry.abstractEntityInstance)
        && Objects.equals(this.roleType, thatEntry.roleType)
        && Objects.equals(this.eTagValue, thatEntry.eTagValue)
  ...
  static AccessControlEntry fromProto(ObjectAccessControl acl) {
    ...
    return builder(abstractEntityInstance, roleType)
        .setEtag(acl.getEtag())
        .setId(acl.getId())
        .buildInstance();
  }
