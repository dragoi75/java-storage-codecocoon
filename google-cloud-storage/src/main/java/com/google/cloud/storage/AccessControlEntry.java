...
public final class AccessControlEntry implements Serializable {
    ...
    static final Function<ObjectAccessControl, AccessControlEntry> OBJECT_PB_TO_ACCESS_CONTROL_ENTRY = new Function<ObjectAccessControl, AccessControlEntry>() {
    ...
    static final Function<BucketAccessControl, AccessControlEntry> BUCKET_PB_TO_ACCESS_CONTROL_ENTRY = new Function<BucketAccessControl, AccessControlEntry>() {
    ...
    public static final class ProjectInfo extends AbstractEntity {
        ...
        public static final class ProjectRoleType extends StringEnumValue {
            ...
            private static final StringEnumType<ProjectRoleType> ROLE_TYPE = new StringEnumType(ProjectRoleType.class, STRING_TO_ACCESS_ROLE);
