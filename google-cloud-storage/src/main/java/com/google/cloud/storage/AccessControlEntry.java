...
public final class AccessControlEntry implements Serializable {
  ...
  static final Function<ObjectAccessControl, AccessControlEntry> OBJECT_PB_TO_ENTRY_FN =
  ...
  static final Function<BucketAccessControl, AccessControlEntry> BUCKET_PB_TO_ENTRY_FN =
  ...
  public static final class ProjectInfo extends TypedEntity {
    ...
    public static final class ProjectUserRole extends StringEnumValue {
      ...
      private static final ApiFunction<String, ProjectUserRole> USER_ROLE_CONSTRUCTOR_FN =
          new ApiFunction<String, ProjectUserRole>() {
            @Override
      ...
      private static final StringEnumType<ProjectUserRole> ROLE_TYPE =
          new StringEnumType(ProjectUserRole.class, USER_ROLE_CONSTRUCTOR_FN);
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(this.typedEntity, otherEntry.typedEntity)
        && Objects.equals(this.userRole, otherEntry.userRole)
        && Objects.equals(this.entityTag, otherEntry.entityTag)
        && Objects.equals(this.identifier, otherEntry.identifier);
  }
  ...
  static AccessControlEntry fromProto(ObjectAccessControl objectAcl) {
    ...
    return builder(typedEntity, userRole)
