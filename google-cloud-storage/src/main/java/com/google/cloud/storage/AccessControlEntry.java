...
public final class AccessControlEntry implements Serializable {
    ...
    static final Function<ObjectAccessControl, AccessControlEntry> FROM_OBJECT_PB_TO_ENTRY = new Function<ObjectAccessControl, AccessControlEntry>() {
    ...
    static final Function<BucketAccessControl, AccessControlEntry> FROM_BUCKET_PB_TO_ENTRY = new Function<BucketAccessControl, AccessControlEntry>() {
    ...
    public static final class ProjectInfo extends ProtoEntity {
        ...
        public static final class ProjectRoleType extends StringEnumValue {
            ...
            private static final StringEnumType<ProjectRoleType> USER_ROLE_TYPE = new StringEnumType(ProjectRoleType.class, USER_ROLE_CONSTRUCTOR_FN);
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(this.protoEnt, that.protoEnt) && Objects.equals(this.userRank, that.userRank) && Objects.equals(this.versionToken, that.versionToken) && Objects.equals(this.entityKey, that.entityKey);
    }
