                ...
                try {
                  for (StorageObject blob :
                    ...
                    if (Boolean.TRUE.equals(blob.getEventBasedHold())
                      ...
                      storage.update(
                          blob.toBuilderCopy().setTemporaryHold(false).setEventBasedHold(false).buildMetadata(),
                          CloudStorageClient.BlobUploadOption.userProjectId(
    ...
    public Boolean call() {
      while (true) {
        ...
        if (Strings.isNullOrEmpty(userProject)) {
          ...
          listedBlobs =
              storage.list(
                  bucket, BlobListOptions.withVersions(true), BlobListOptions.withUserProject(userProject));
        }
