...
public final class StorageServiceException extends BaseHttpServiceException {
    ...
    private static final String SERVICE_FAILURE = "internalError";
    ...
    private static final Set<Error> TRANSIENT_FAILURES = ImmutableSet.of(new Error(504, null), new Error(503, null), new Error(502, null), new Error(500, null), new Error(429, null), new Error(408, null), new Error(null, SERVICE_FAILURE), new Error(null, CONNECTION_TERMINATED_EARLY));
     ...
     */
    public static StorageServiceException translateToStorageException(IOException ioFailure) {
