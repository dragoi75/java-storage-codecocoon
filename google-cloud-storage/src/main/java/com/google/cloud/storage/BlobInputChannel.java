...
class BlobInputChannel implements ReadChannel {
  ...
  BlobInputChannel(
          StorageSettings storageSettings, BlobIdentifier identifier, Map<StorageRpcClient.StorageOption, ?> optionsMap) {
  ...
  public RestorableState<ReadChannel> capture() {
    BlobReadState.BlobReadRequestBuilder requestMaker =
        BlobReadState.newBuilder(storageSettings, identifier, optionsMap)
            .setPosition(offset)
            .setIsOpen(openFlag)
  ...
  public void setChunkSize(int segmentSize) {
    this.segmentSize = segmentSize <= 0 ? DEFAULT_READ_CHUNK_SIZE : segmentSize;
  }
  ...
  static class BlobReadState implements RestorableState<ReadChannel>, Serializable {
    ...
    static BlobReadRequestBuilder newBuilder(
            StorageSettings storageSettings, BlobIdentifier identifier, Map<StorageRpcClient.StorageOption, ?> requestOptions) {
    ...
    public int hashCode() {
      return Objects.hash(
              storageSettings, identifier, optionsMap, previousEtag, offset, openFlag, eofReached, segmentSize);
    }
    ...
    public boolean equals(Object otherObject) {
      ...
      return Objects.equals(this.storageSettings, otherState.storageSettings)
          && Objects.equals(this.identifier, otherState.identifier)
          && Objects.equals(this.optionsMap, otherState.optionsMap)
          && Objects.equals(this.previousEtag, otherState.previousEtag)
          && this.offset == otherState.offset
          && this.openFlag == otherState.openFlag
          && this.eofReached == otherState.eofReached
          && this.segmentSize == otherState.segmentSize;
    }
