...
final class StorageImpl extends BaseService<StorageSettings> implements StorageClient {
    ...
    public PostPolicyVersion4 generateSignedPostPolicyV4(BlobAttributes blobInfo, long duration, TimeUnit unit, PostFieldsVersion4 fields, PostConditionsVersion4 conditions, PostPolicyV4Parameter... options) {
        ...
        PostConditionsVersion4 v4Conditions = conditionsBuilder.addBucket(ConditionTypeV4.MATCHES, blobInfo.getBucket()).addKey(ConditionTypeV4.MATCHES, blobInfo.getName()).addCondition(ConditionTypeV4.MATCHES, "x-goog-date", date).addCondition(ConditionTypeV4.MATCHES, "x-goog-credential", signingCredential).addCondition(ConditionTypeV4.MATCHES, "x-goog-algorithm", "GOOG4-RSA-SHA256").create();
        ...
        for (PostPolicyVersion4.BinaryCondition condition : v4Conditions.getConditions()) {
            if (ConditionTypeV4.MATCHES == condition.conditionKind) {
   ...
   */
    ...
    @Override
    public AclEntry getAcl(final String bucket, final TypedEntity entity, BucketSourceRequestOption... options) {
        try {
            final Map<CloudStorageRpcClient.StorageOption, ?> optionsMap = optionMap(options);
    ...
    @Override
    public boolean deleteDefaultAcl(final String bucket, final TypedEntity entity) {
        try {
            return runWithRetries(new Callable<Boolean>() {
    ...
    @Override
    public AclEntry getDefaultAcl(final String bucket, final TypedEntity entity) {
        try {
    ...
    @Override
    public boolean deleteAcl(final String bucket, final TypedEntity entity, BucketSourceRequestOption... options) {
        try {
            final Map<CloudStorageRpcClient.StorageOption, ?> optionsMap = optionMap(options);
            return runWithRetries(new Callable<Boolean>() {
    ...
    @Override
    public AclEntry getAcl(final BlobIdentifier blob, final TypedEntity entity) {
        try {
            ObjectAccessControl answer = runWithRetries(new Callable<ObjectAccessControl>() {
    ...
    private HmacKeyInfo updateHmacKey(final HmacKeyInfo hmacKeyMetadata, final UpdateHmacKeyOptions... options) {
        try {
            return HmacKeyInfo.fromProto(runWithRetries(new Callable<com.google.api.services.storage.model.HmacKeyMetadata>() {
    ...
    @Override
    public boolean deleteAcl(final BlobIdentifier blob, final TypedEntity entity) {
        try {
            return runWithRetries(new Callable<Boolean>() {
    ...
    public PostPolicyVersion4 generateSignedPostPolicyV4(BlobAttributes blobInfo, long duration, TimeUnit unit, PostConditionsVersion4 conditions, PostPolicyV4Parameter... options) {
        return generateSignedPostPolicyV4(blobInfo, duration, unit, PostFieldsVersion4.builder().create(), conditions, options);
    }
    ...
    private static Page<HmacKeyInfo> listHmacKeys(final StorageSettings serviceOptions, final Map<CloudStorageRpcClient.StorageOption, ?> options) {
        try {
            ...
            final Iterable<HmacKeyInfo> metadata = null == result.y() ? ImmutableList.<HmacKeyInfo>of() : Iterables.transform(result.y(), new Function<com.google.api.services.storage.model.HmacKeyMetadata, HmacKeyInfo>() {
    ...
    @Override
    public AclEntry getAcl(final String bucket, final TypedEntity entity) {
    ...
    @Override
    public HmacSecretKey.HmacKeyInfo updateHmacKeyState(final HmacKeyInfo hmacKeyMetadata, final HmacSecretKey.HmacKeyStatus state, final UpdateHmacKeyOptions... options) {
        HmacKeyInfo updatedMetadata = HmacKeyInfo.newAccessKeyBuilder(hmacKeyMetadata.getServiceAccount()).setProjectId(hmacKeyMetadata.getProjectId()).setAccessId(hmacKeyMetadata.getAccessId()).setState(state).buildHmacKeyInfo();
