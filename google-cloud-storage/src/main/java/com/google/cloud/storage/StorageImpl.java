...
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.DELIMITER;
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.IF_GENERATION_MATCH;
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.IF_GENERATION_NOT_MATCH;
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.IF_METAGENERATION_MATCH;
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.IF_METAGENERATION_NOT_MATCH;
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.IF_SOURCE_GENERATION_MATCH;
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.IF_SOURCE_GENERATION_NOT_MATCH;
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.IF_SOURCE_METAGENERATION_MATCH;
import static com.google.cloud.storage.spi.v1.StorageRpc.RequestOption.IF_SOURCE_METAGENERATION_NOT_MATCH;
...
final class StorageImpl extends BaseService<StorageOptions> implements Storage {
  ...
  @Override
  public Bucket create(BucketInfo bucketInfo, TargetBucketOption... options) {
    final com.google.api.services.storage.model.Bucket bucketPb = bucketInfo.toPb();
    final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(bucketInfo, options);
    try {
  ...
  @Override
  public Blob create(BlobInfo blobInfo, BlobUploadOption... options) {
  ...
  @Override
  public Blob create(BlobInfo blobInfo, byte[] content, BlobUploadOption... options) {
  ...
  @Override
  @Deprecated
  public Blob create(BlobInfo blobInfo, InputStream content, ObjectWriteOption... options) {
    Tuple<BlobInfo, BlobUploadOption[]> targetOptions = BlobUploadOption.convertOptions(blobInfo, options);
    StorageObject blobPb = targetOptions.x().toPb();
    Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(targetOptions.x(), targetOptions.y());
  ...
  private Blob internalCreate(BlobInfo info, final byte[] content, BlobUploadOption... options) {
    Preconditions.checkNotNull(content);
    final StorageObject blobPb = info.toPb();
    final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(info, options);
    try {
      return Blob.fromPb(
          this,
          runWithRetries(
  ...
  @Override
  public Blob createFrom(BlobInfo blobInfo, Path path, ObjectWriteOption... options)
      throws IOException {
    return createFrom(blobInfo, path, DEFAULT_BUFFER_SIZE, options);
  }

  @Override
  public Blob createFrom(BlobInfo blobInfo, Path path, int bufferSize, ObjectWriteOption... options)
      throws IOException {
  ...
  @Override
  public Blob createFrom(BlobInfo blobInfo, InputStream content, ObjectWriteOption... options)
      throws IOException {
  ...
  @Override
  public Bucket get(String bucket, BucketGetOptions... options) {
    final com.google.api.services.storage.model.Bucket bucketPb = BucketInfo.of(bucket).toPb();
    final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(options);
    try {
  ...
  @Override
  public Blob get(String bucket, String blob, BlobGetOptions... options) {
    return get(BlobId.of(bucket, blob), options);
  }

  @Override
  public Blob get(BlobId blob, BlobGetOptions... options) {
    final StorageObject storedObject = blob.toPb();
    final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(blob, options);
    try {
  ...
  private static class BucketPageFetcher implements NextPageFetcher<Bucket> {
    ...
    BucketPageFetcher(
        StorageOptions serviceOptions, String cursor, Map<StorageRpc.RequestOption, ?> optionMap) {
      this.requestOptions =
          PageImpl.nextRequestOptions(StorageRpc.RequestOption.PAGE_TOKEN, cursor, optionMap);
  ...
  private static class BlobPageFetcher implements NextPageFetcher<Blob> {
    ...
    BlobPageFetcher(
        ...
        String cursor,
        Map<StorageRpc.RequestOption, ?> optionMap) {
      this.requestOptions =
          PageImpl.nextRequestOptions(StorageRpc.RequestOption.PAGE_TOKEN, cursor, optionMap);
      this.serviceOptions = serviceOptions;
      this.bucket = bucket;
  ...
  private static class HmacKeyMetadataPageFetcher implements NextPageFetcher<HmacKeyMetadata> {
    ...
    private final StorageOptions serviceOptions;
    private final Map<StorageRpc.RequestOption, ?> options;

    HmacKeyMetadataPageFetcher(StorageOptions serviceOptions, Map<StorageRpc.RequestOption, ?> options) {
      this.serviceOptions = serviceOptions;
  ...
  @Override
  public Page<Bucket> list(ListBucketsOption... options) {
    return listBuckets(getOptions(), optionMap(options));
  }

  @Override
  public Page<Blob> list(final String bucket, BlobListOptions... options) {
    return listBlobs(bucket, getOptions(), optionMap(options));
  }

  private static Page<Bucket> listBuckets(
      final StorageOptions serviceOptions, final Map<StorageRpc.RequestOption, ?> optionsMap) {
    try {
  ...
  @Override
  public Bucket update(BucketInfo bucketInfo, TargetBucketOption... options) {
    final com.google.api.services.storage.model.Bucket bucketPb = bucketInfo.toPb();
    final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(bucketInfo, options);
    try {
      return Bucket.fromPb(
  ...
  @Override
  public Blob update(BlobInfo blobInfo, BlobUploadOption... options) {
    final StorageObject storageObject = blobInfo.toPb();
    final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(blobInfo, options);
    try {
      return Blob.fromPb(
          this,
          runWithRetries(
  ...
  public Blob compose(final ComposeBlobsRequest composeRequest) {
    ...
    final Map<StorageRpc.RequestOption, ?> targetOptions =
        optionMap(
  ...
  public CopyWriter copy(final CopyOperationRequest copyRequest) {
    ...
    final Map<StorageRpc.RequestOption, ?> sourceOptions =
        optionMap(
  ...
  public ReadChannel reader(String bucket, String blob, BlobSourceOptions... options) {
    Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(options);
  ...
  public ReadChannel reader(BlobId blob, BlobSourceOptions... options) {
    Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(blob, options);
    return new BlobReadChannel(getOptions(), blob, optionsMap);
  }

  @Override
  public BlobWriteChannel writer(BlobInfo blobInfo, ObjectWriteOption... options) {
    Tuple<BlobInfo, BlobUploadOption[]> targetOptions = BlobUploadOption.convertOptions(blobInfo, options);
  ...
  private BlobWriteChannel writer(BlobInfo blobInfo, BlobUploadOption... options) {
    final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(blobInfo, options);
  ...
  public FormPostPolicyV4 generateSignedPostPolicyV4(
      ...
      FormPostPolicyV4.PostConditionsV4Dto conditions,
    ...
    FormPostPolicyV4.PostConditionsV4Dto.ConditionBuilder conditionsBuilder = conditions.toConditionBuilder();
    ...
    for (Map.Entry<String, String> entry : fields.getFieldsMap().entrySet()) {
      ...
      conditionsBuilder.addBinaryCondition(
          FormPostPolicyV4.ConditionTypeV4.MATCHES, entry.getKey(), entry.getValue());

      policyFields.put(entry.getKey(), entry.getValue());
    }

    PostConditionsV4Dto v4Conditions =
        conditionsBuilder
            .addBucketConstraint(FormPostPolicyV4.ConditionTypeV4.MATCHES, blobInfo.getBucket())
            .withKeyCondition(FormPostPolicyV4.ConditionTypeV4.MATCHES, blobInfo.getName())
            .addBinaryCondition(FormPostPolicyV4.ConditionTypeV4.MATCHES, "x-goog-date", date)
            .addBinaryCondition(FormPostPolicyV4.ConditionTypeV4.MATCHES, "x-goog-credential", signingCredential)
            .addBinaryCondition(FormPostPolicyV4.ConditionTypeV4.MATCHES, "x-goog-algorithm", "GOOG4-RSA-SHA256")
            .buildPostConditionsV4Dto();
    FormPostPolicyV4.PostPolicyV4PolicyDocument document =
        FormPostPolicyV4.PostPolicyV4PolicyDocument.from(
    ...
    for (FormPostPolicyV4.BinaryConditionV4 condition : v4Conditions.getConditions()) {
      if (condition.conditionKind == FormPostPolicyV4.ConditionTypeV4.MATCHES) {
    ...
    return FormPostPolicyV4.from(url, policyFields);
  }
  ...
  public FormPostPolicyV4 generateSignedPostPolicyV4(
    ...
    return generateSignedPostPolicyV4(
        blobInfo, duration, unit, fields, PostConditionsV4Dto.newConditionBuilder().buildPostConditionsV4Dto(), options);
  }
  ...
  public FormPostPolicyV4 generateSignedPostPolicyV4(
      ...
      PostPolicyV4Parameter... options) {
    return generateSignedPostPolicyV4(
        blobInfo, duration, unit, FormPostPolicyV4.PostFieldsMapV4.newUploadFormBuilder().buildPostFieldsMap(), conditions, options);
  }

  public FormPostPolicyV4 generateSignedPostPolicyV4(
      BlobInfo blobInfo, long duration, TimeUnit unit, PostPolicyV4Parameter... options) {
    return generateSignedPostPolicyV4(
        blobInfo, duration, unit, FormPostPolicyV4.PostFieldsMapV4.newUploadFormBuilder().buildPostFieldsMap(), options);
  }
  ...
  private SignatureInfo buildSignatureInfo(
    ...
    if (firstNonNull((Boolean) optionMap.get(UrlSigningOption.RequestOption.MD5), false)) {
      checkArgument(blobInfo.getMd5() != null, "Blob is missing a getValue for md5");
    ...
    if (firstNonNull((Boolean) optionMap.get(UrlSigningOption.RequestOption.CONTENT_TYPE), false)) {
      checkArgument(blobInfo.getContentType() != null, "Blob is missing a getValue for content-type");
  ...
  @Override
  public Acl getAcl(final String bucket, final Entity entity, BucketSourceOptions... options) {
    try {
      final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(options);
  ...
  public boolean deleteAcl(
      final String bucket, final Entity entity, BucketSourceOptions... options) {
    try {
      final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(options);
      return runWithRetries(
          new Callable<Boolean>() {
  ...
  @Override
  public Acl createAcl(String bucket, Acl acl, BucketSourceOptions... options) {
  ...
  @Override
  public Acl updateAcl(String bucket, Acl acl, BucketSourceOptions... options) {
    final BucketAccessControl aclPb = acl.toBucketPb().setBucket(bucket);
    try {
      final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(options);
      return Acl.fromPb(
  ...
  @Override
  public List<Acl> listAcls(final String bucket, BucketSourceOptions... options) {
    try {
      final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(options);
  ...
  public HmacKey createHmacKey(
      final ServiceAccount serviceAccount, final CreateHmacKeyOptions... options) {
    try {
  ...
  @Override
  public Page<HmacKeyMetadata> listHmacKeys(HmacKeyListOption... options) {
    return listHmacKeys(getOptions(), optionMap(options));
  }

  @Override
  public HmacKeyMetadata getHmacKey(final String accessId, final HmacKeyRetrievalOption... options) {
    try {
  ...
  private static Page<HmacKeyMetadata> listHmacKeys(
      final StorageOptions serviceOptions, final Map<StorageRpc.RequestOption, ?> options) {
    try {
  ...
  public Policy setIamPolicy(
      final String bucket, final Policy policy, BucketSourceOptions... options) {
    try {
      final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(options);
      return convertFromApiPolicy(
          runWithRetries(
  ...
  public List<Boolean> testIamPermissions(
      final String bucket, final List<String> permissions, BucketSourceOptions... options) {
    try {
      final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(options);
  ...
  @Override
  public Bucket lockRetentionPolicy(BucketInfo bucketInfo, TargetBucketOption... options) {
    final com.google.api.services.storage.model.Bucket bucketPb = bucketInfo.toPb();
    final Map<StorageRpc.RequestOption, ?> optionsMap = optionMap(bucketInfo, options);
    try {
      return Bucket.fromPb(
  ...
  private static <T> void addToOptionMap(
      StorageRpc.RequestOption option, T defaultValue, Map<StorageRpc.RequestOption, Object> map) {
    addToOptionMap(option, option, defaultValue, map);
  }

  private static <T> void addToOptionMap(
      StorageRpc.RequestOption getOption,
      StorageRpc.RequestOption putOption,
      T defaultValue,
      Map<StorageRpc.RequestOption, Object> map) {
    if (map.containsKey(getOption)) {
      @SuppressWarnings("unchecked")
      T value = (T) map.remove(getOption);
      checkArgument(
          value != null || defaultValue != null,
          "StorageOption " + getOption.getValue() + " is missing a getValue");
      value = firstNonNull(value, defaultValue);
      map.put(putOption, value);
    }
  }

  private static Map<StorageRpc.RequestOption, ?> optionMap(
  ...
  private static Map<StorageRpc.RequestOption, ?> optionMap(
      ...
      boolean useAsSource) {
    Map<StorageRpc.RequestOption, Object> temp = Maps.newEnumMap(StorageRpc.RequestOption.class);
  ...
  private static Map<StorageRpc.RequestOption, ?> optionMap(Option... options) {
  ...
  private static Map<StorageRpc.RequestOption, ?> optionMap(BucketInfo bucketInfo, Option... options) {
    return optionMap(null, bucketInfo.getMetageneration(), options);
  }

  static Map<StorageRpc.RequestOption, ?> optionMap(BlobInfo blobInfo, Option... options) {
    return optionMap(blobInfo.getGeneration(), blobInfo.getMetageneration(), options);
  }

  static Map<StorageRpc.RequestOption, ?> optionMap(BlobId blobId, Option... options) {
