...
public class StorageBlob extends BlobMetadata {
  ...
  static final Function<Tuple<CloudStorageClient, StorageObject>, StorageBlob> BLOB_FROM_PB_FUNCTION =
      new Function<Tuple<CloudStorageClient, StorageObject>, StorageBlob>() {
        @Override
  ...
  public static class BlobSourceOptions extends OptionDescriptor {
    ...
    static CloudStorageClient.BlobReadOption[] convertToSourceOptions(
            BlobMetadata metadata, BlobSourceOptions... clientSettings) {
  ...
  public boolean blobExists(BlobSourceOptions... clientSettings) {
    ...
    return cloudClient.get(getBlobId(), retrievalParams) != null;
  }
  ...
  public BlobCopyWriter copyToBlob(BlobIdentifier destinationBlobId, BlobSourceOptions... clientSettings) {
    CloudStorageClient.CopyOperationRequest transferRequest =
        CloudStorageClient.CopyOperationRequest.builder()
            .setSource(getBucket(), getName())
            .setSourceOptions(convertToSourceOptions(this, clientSettings))
