...
public class SigningContext {
  ...
  private static final List<String> RESERVED_PARAM_NAMES_LOWER =
  ...
  private SigningContext(RequestSignatureBuilder signatureBuilder) {
    ...
    ImmutableMap.Builder<String, String> headersBuilder =
        new ImmutableMap.Builder<String, String>().putAll(signatureBuilder.canonicalExtensionHeaders);
    ...
    if (CloudStorageClient.UrlSigningOption.SignatureSchemeVersion.V4.equals(signatureSchemeVersion)
        && (!signatureBuilder.canonicalExtensionHeaders.containsKey("host"))) {
  ...
  private String buildV2UnsignedPayload() {
    ...
    if (canonicalExtensionHeaders.size() > 0) {
      contentBuilder.append(
          new CanonicalExtensionHeadersSerializer(CloudStorageClient.UrlSigningOption.SignatureSchemeVersion.V2)
  ...
  private String computeV4CanonicalRequestHash() {
    ...
    CanonicalExtensionHeadersSerializer extensionHeadersSerializer =
        new CanonicalExtensionHeadersSerializer(CloudStorageClient.UrlSigningOption.SignatureSchemeVersion.V4);
    ...
    canonicalReqBuilder
        .append(extensionHeadersSerializer.serialize(canonicalExtensionHeaders))
        .append(COMPONENT_SEPARATOR);
    canonicalReqBuilder
        .append(extensionHeadersSerializer.serializeHeaderNames(canonicalExtensionHeaders))
        .append(COMPONENT_SEPARATOR);
  ...
  public String buildV4QueryString() {
    ...
    StringBuilder headersSignedBuilder =
        new CanonicalExtensionHeadersSerializer(CloudStorageClient.UrlSigningOption.SignatureSchemeVersion.V4)
            .serializeHeaderNames(canonicalExtensionHeaders);
    paramTreeMap.put(
        "X-Goog-SignedHeaders", rfc3986UriEncode(headersSignedBuilder.toString(), true));
