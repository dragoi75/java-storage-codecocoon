...
public final class StorageTier extends StringEnumValue {
  ...
  private static final StringEnumType<StorageTier> STORAGE_TIER_ENUM_DEF =
   ...
   */
  public static final StorageTier STANDARD = STORAGE_TIER_ENUM_DEF.createAndRegister("STANDARD");
   ...
   */
  public static final StorageTier NEARLINE = STORAGE_TIER_ENUM_DEF.createAndRegister("NEARLINE");
   ...
   */
  public static final StorageTier COLDLINE = STORAGE_TIER_ENUM_DEF.createAndRegister("COLDLINE");
   ...
   */
  public static final StorageTier ARCHIVE = STORAGE_TIER_ENUM_DEF.createAndRegister("ARCHIVE");
   ...
   */
  public static final StorageTier REGIONAL = STORAGE_TIER_ENUM_DEF.createAndRegister("REGIONAL");
   ...
   *     href="https://cloud.google.com/storage/docs/storage-classes#legacy">https://cloud.google.com/storage/docs/storage-classes#legacy</a>
   */
  public static final StorageTier MULTI_REGIONAL = STORAGE_TIER_ENUM_DEF.createAndRegister("MULTI_REGIONAL");
