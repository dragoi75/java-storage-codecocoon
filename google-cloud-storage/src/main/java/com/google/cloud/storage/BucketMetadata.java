...
public class BucketMetadata implements Serializable {
  ...
  static final Function<BucketMetadata, com.google.api.services.storage.model.Bucket> TO_BUCKET_FUNCTION =
  ...
  public static class BucketIamConfiguration implements Serializable {
    ...
    public int hashCode() {
      return Objects.hash(
              ...
              uniformBucketLevelAccessLockTime,
    ...
    Bucket.IamConfiguration toProto() {
      ...
      Bucket.IamConfiguration.UniformBucketLevelAccess uniformBucketLevelAccessProto =
      ...
      uniformBucketLevelAccessProto.setLockedTime(
          uniformBucketLevelAccessLockTime == null
              ? null
              : new DateTime(uniformBucketLevelAccessLockTime));

      identityAccessConfig.setUniformBucketLevelAccess(uniformBucketLevelAccessProto);
      identityAccessConfig.setPublicAccessPrevention(
          publicAccessPreventionPolicy == null ? null : publicAccessPreventionPolicy.getValue());
    ...
    static BucketIamConfiguration fromProto(Bucket.IamConfiguration identityAccessConfig) {
      Bucket.IamConfiguration.UniformBucketLevelAccess uniformBucketLevelAccessProto =
          identityAccessConfig.getUniformBucketLevelAccess();
      ...
      if (publicAccessPreventionPolicy != null) {
        publicAccessPreventionEnum = PublicAccessPreventionPolicy.parseValue(publicAccessPreventionPolicy);
      }

      return builder()
          .setIsUniformBucketLevelAccessEnabled(uniformBucketLevelAccessProto.getEnabled())
          .setUniformBucketLevelAccessLockedTime(lockedDateTime == null ? null : lockedDateTime.getValue())
          .setPublicAccessPrevention(publicAccessPreventionEnum)
          .buildConfig();
    }
    ...
    public static class BucketAccessConfigurationBuilder {
       ...
       */
      public BucketAccessConfigurationBuilder setIsUniformBucketLevelAccessEnabled(
  ...
  public static class LoggingConfig implements Serializable {
    ...
    Bucket.Logging toProto() {
      ...
      if (logBucketName != null || logObjectNamePrefix != null) {
    ...
    static LoggingConfig fromProto(Bucket.Logging auditLogging) {
      return builder()
          .setLogBucket(auditLogging.getLogBucket())
          .setLogObjectPrefix(auditLogging.getLogObjectPrefix())
          .buildConfig();
    }
  ...
  public static class LifecycleRuleDefinition implements Serializable {
    ...
    public LifecycleRuleDefinition(LifecycleRuleAction ruleAction, LifecycleRuleCondition ruleCondition) {
      if (ruleCondition.getIsLive() == null
          && ruleCondition.getAge() == null
          && ruleCondition.getCreatedBefore() == null
          && ruleCondition.getMatchesStorageClass() == null
          && ruleCondition.getNumberOfNewerVersions() == null
          && ruleCondition.getDaysSinceNoncurrentTime() == null
          && ruleCondition.getNoncurrentTimeBefore() == null
          && ruleCondition.getCustomTimeBefore() == null
          && ruleCondition.getDaysSinceCustomTime() == null) {
        LOGGER.warning(
    ...
    Rule toProto() {
      ...
      if (this.ruleAction.getActionType().equals(SetStorageClassLifecycleOperation.TYPE)) {
        ruleAction.setStorageClass(
            ((SetStorageClassLifecycleOperation) this.ruleAction).getStorageClass().toString());
      }
      ...
      Rule.Condition ruleCondition =
          new Rule.Condition()
              .setAge(this.ruleCondition.getAge())
              .setCreatedBefore(
                  this.ruleCondition.getCreatedBefore() == null
                      ? null
                      : new DateTime(true, this.ruleCondition.getCreatedBefore().getValue(), 0))
              .setIsLive(this.ruleCondition.getIsLive())
              .setNumNewerVersions(this.ruleCondition.getNumberOfNewerVersions())
              .setMatchesStorageClass(
                  this.ruleCondition.getMatchesStorageClass() == null
                      ? null
                      : transform(
                          this.ruleCondition.getMatchesStorageClass(),
                          Functions.toStringFunction()))
              .setDaysSinceNoncurrentTime(this.ruleCondition.getDaysSinceNoncurrentTime())
              .setNoncurrentTimeBefore(
                  this.ruleCondition.getNoncurrentTimeBefore() == null
                      ? null
                      : new DateTime(
                          true, this.ruleCondition.getNoncurrentTimeBefore().getValue(), 0))
              .setCustomTimeBefore(
                  this.ruleCondition.getCustomTimeBefore() == null
                      ? null
                      : new DateTime(true, this.ruleCondition.getCustomTimeBefore().getValue(), 0))
              .setDaysSinceCustomTime(this.ruleCondition.getDaysSinceCustomTime());
    ...
    static LifecycleRuleDefinition fromProto(Rule protoEntry) {
        ...
        case SetStorageClassLifecycleOperation.TYPE:
          ruleAction =
              LifecycleRuleAction.createSetStorageClassAction(
                  StorageTier.of(lifecycleActionParam.getStorageClass()));
          break;
      ...
      LifecycleRuleCondition.LifecycleConditionBuilder condBuilder =
          LifecycleRuleCondition.builder()
              ...
              .setCreatedBefore(ruleCondition.getCreatedBefore())
              .setIsLive(ruleCondition.getIsLive())
              .setNumberOfNewerVersions(ruleCondition.getNumNewerVersions())
              .setMatchesStorageClass(
                  ruleCondition.getMatchesStorageClass() == null
                      ? null
                      : transform(
              ...
              .setDaysSinceNoncurrentTime(ruleCondition.getDaysSinceNoncurrentTime())
              .setNoncurrentTimeBefore(ruleCondition.getNoncurrentTimeBefore())
              .setCustomTimeBefore(ruleCondition.getCustomTimeBefore())
              .setDaysSinceCustomTime(ruleCondition.getDaysSinceCustomTime());
    ...
    public static class LifecycleRuleCondition implements Serializable {
      ...
      public LifecycleConditionBuilder toBuilder() {
        return builder()
            ...
            .setIsLive(this.isActive)
            .setMatchesStorageClass(this.matchedStorageTiers)
            .setDaysSinceNoncurrentTime(this.daysSinceNoncurrent)
            .setNoncurrentTimeBefore(this.noncurrentCutoff)
            .setCustomTimeBefore(this.customTimeCutoff)
  ...
  public abstract static class DeletionRule implements Serializable {
    ...
    static DeletionRule fromProto(Rule protoEntry) {
      if (protoEntry.getAction() != null && SUPPORTED_OPERATIONS.endsWith(protoEntry.getAction().getType())) {
        Rule.Condition ruleCondition = protoEntry.getCondition();
  ...
  static final class BucketBuilderImpl extends BucketBuilder {
    ...
    public BucketMetadata.BucketBuilder setDeleteRules(Iterable<? extends DeletionRule> deletionEntries) {
      this.deletionRules = deletionEntries != null ? ImmutableList.copyOf(deletionEntries) : null;
      return this;
    }
    ...
    public BucketMetadata.BucketBuilder setLifecycleRules(Iterable<? extends LifecycleRuleDefinition> deletionEntries) {
      this.lifecyclePolicies =
          deletionEntries != null ? ImmutableList.copyOf(deletionEntries) : ImmutableList.<LifecycleRuleDefinition>of();
      return this;
    }
    ...
    public BucketMetadata.BucketBuilder setCors(Iterable<CorsConfiguration> crossOriginConfigs) {
      this.crossOriginConfigs = crossOriginConfigs != null ? ImmutableList.copyOf(crossOriginConfigs) : ImmutableList.<CorsConfiguration>of();
      return this;
    }
    ...
    public BucketMetadata.BucketBuilder setDefaultKmsKeyName(String primaryKmsKey) {
      this.primaryKmsKey =
          primaryKmsKey != null ? primaryKmsKey : Data.<String>nullOf(String.class);
      return this;
    }
    ...
    public BucketMetadata.BucketBuilder setLogging(LoggingConfig auditLogging) {
      this.auditLogging = auditLogging != null ? auditLogging : LoggingConfig.builder().buildConfig();
      return this;
    }
  ...
  com.google.api.services.storage.model.Bucket toProto() {
    com.google.api.services.storage.model.Bucket protoBucket =
    ...
    if (defaultAccessControls != null) {
      protoBucket.setDefaultObjectAcl(
          transform(
    ...
    if (deletionRules != null || lifecyclePolicies != null) {
      ...
      if ((deletionRules == null && lifecyclePolicies.isEmpty())
          || (lifecyclePolicies == null && deletionRules.isEmpty())
          || (deletionRules != null && deletionRules.isEmpty() && lifecyclePolicies.isEmpty())) {
        policyRules.setRule(Collections.<Rule>emptyList());
      } else {
        Set<Rule> deletionEntries = new HashSet<>();
        if (deletionRules != null) {
          deletionEntries.addAll(
              transform(
                      deletionRules,
    ...
    if (retentionDuration != null) {
      if (Data.isNull(retentionDuration)) {
        protoBucket.setRetentionPolicy(
  ...
  static BucketMetadata fromProto(com.google.api.services.storage.model.Bucket protoBucket) {
    ...
    if (protoBucket.getDefaultObjectAcl() != null) {
      accessConfigBuilder.setDefaultAcl(
          transform(
              protoBucket.getDefaultObjectAcl(),
    ...
    if (protoBucket.getLifecycle() != null && protoBucket.getLifecycle().getRule() != null) {
      accessConfigBuilder.setLifecycleRules(
          transform(
              protoBucket.getLifecycle().getRule(),
      ...
      accessConfigBuilder.setDeleteRules(
          transform(
              protoBucket.getLifecycle().getRule(),
    ...
    if (protoBucket.getDefaultEventBasedHold() != null) {
    ...
    if (protoBucket.getLocationType() != null) {
