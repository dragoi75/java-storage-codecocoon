...
public class BucketMetadata implements Serializable {
  ...
  static final Function<BucketMetadata, com.google.api.services.storage.model.Bucket> TO_METADATA_PROTOBUF =
  ...
  public static class IamSettings implements Serializable {
    ...
    public boolean equals(Object objForComparison) {
      if (this == objForComparison) return true;
      if (objForComparison == null || getClass() != objForComparison.getClass()) {
        return false;
      }
  ...
  public static class LifecycleRuleDefinition implements Serializable {
    ...
    Rule toProto() {
      ...
      if (this.ruleAction.getActionType().equals(UpdateStorageClassLifecycleAction.TYPE)) {
        ruleAction.setStorageClass(
            ((UpdateStorageClassLifecycleAction) this.ruleAction).getStorageClass().toString());
      }
      ...
      switch (lifecycleActionParam.getType()) {
        ...
        default:
          throw new UnsupportedOperationException(
              "The specified lifecycle action " + lifecycleActionParam.getType() + " is not currently supported");
      }

      Rule.Condition ruleCondition = protoRule.getCondition();

      LifecycleRuleCondition.LifecycleRuleConditionBuilder condBuilder =
    ...
    public static class LifecycleRuleCondition implements Serializable {
      ...
      public LifecycleRuleConditionBuilder toBuilder() {
        return newLifecycleRuleConditionBuilder()
            .setAge(this.lifespanDays)
            .setCreatedBefore(this.creationCutoff)
            .setNumberOfNewerVersions(this.newerVersionCount)
            .setIsLive(this.activeFlag)
            .setMatchesStorageClass(this.matchedStorageClasses);
      }
    ...
    public abstract static class LifecycleOperation implements Serializable {
       ...
       */
      public static UpdateStorageClassLifecycleAction createSetStorageClassAction(
  ...
  public abstract static class DeleteActionRule implements Serializable {
    ...
    static DeleteActionRule fromProto(Rule protoRule) {
      if (protoRule.getAction() != null && SUPPORTED_ACTIONS.endsWith(protoRule.getAction().getType())) {
        Rule.Condition ruleCondition = protoRule.getCondition();
  ...
  static final class BucketBuilderImpl extends BucketBuilder {
    ...
    public BucketMetadata.BucketBuilder setDeleteRules(Iterable<? extends DeleteActionRule> deletePolicies) {
      this.deletionRules = deletePolicies != null ? ImmutableList.copyOf(deletePolicies) : null;
      return this;
    }

    @Override
    public BucketMetadata.BucketBuilder setLifecycleRules(Iterable<? extends LifecycleRuleDefinition> deletePolicies) {
      this.lifecyclePolicies = deletePolicies != null ? ImmutableList.copyOf(deletePolicies) : null;
      return this;
    }
    ...
    public BucketMetadata.BucketBuilder setDefaultAcl(Iterable<AclEntry> accessControlList) {
      this.defaultAccessControl = accessControlList != null ? ImmutableList.copyOf(accessControlList) : null;
      return this;
    }
  ...
  public boolean equals(Object otherObj) {
    return otherObj == this
        || otherObj != null
            ...
            && Objects.equals(toProto(), ((BucketMetadata) otherObj).toProto());
  }
  ...
  com.google.api.services.storage.model.Bucket toProto() {
    ...
    if (indexDocument != null || missingPage != null) {
    ...
    if (deletionRules != null) {
      deletePolicies.addAll(
          transform(
                  deletionRules,
              new Function<DeleteActionRule, Rule>() {
                @Override
  ...
  static BucketMetadata fromProto(com.google.api.services.storage.model.Bucket protoBucket) {
    ...
    if (protoBucket.getDefaultObjectAcl() != null) {
      uniformAccessConfig.setDefaultAcl(
          transform(
    ...
    if (protoBucket.getLifecycle() != null && protoBucket.getLifecycle().getRule() != null) {
      uniformAccessConfig.setLifecycleRules(
          transform(
      ...
      uniformAccessConfig.setDeleteRules(
          transform(
              protoBucket.getLifecycle().getRule(),
              new Function<Rule, DeleteActionRule>() {
                @Override
