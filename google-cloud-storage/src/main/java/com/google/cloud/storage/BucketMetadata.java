...
public class BucketMetadata implements Serializable {
  ...
  static final Function<BucketMetadata, com.google.api.services.storage.model.Bucket> TO_PROTOBUF_FUNCTION =
  ...
  public static class BucketIamConfiguration implements Serializable {
    ...
    static BucketIamConfiguration fromProto(Bucket.IamConfiguration iamConfig) {
      ...
      return newUniformBucketLevelAccessBuilder()
          .setIsUniformBucketLevelAccessEnabled(uniformAccessConfig.getEnabled())
  ...
  public static class LifecycleRuleDefinition implements Serializable {
    ...
    public LifecycleRuleDefinition(AbstractLifecycleAction lifecycleActParam, LifecycleRuleCondition lifecycleCondParam) {
      if (lifecycleCondParam.getIsLive() == null
          && lifecycleCondParam.getAge() == null
          && lifecycleCondParam.getCreatedBefore() == null
          && lifecycleCondParam.getMatchesStorageClass() == null
          && lifecycleCondParam.getNumberOfNewerVersions() == null) {
    ...
    Rule toProto() {
      ...
      if (ruleAction.getActionType().equals(UpdateStorageClassLifecycleAction.TYPE)) {
        lifecycleActParam.setStorageClass(
            ((UpdateStorageClassLifecycleAction) ruleAction).getStorageClass().toString());
      }

      protoEntry.setAction(lifecycleActParam);

      Rule.Condition lifecycleCondParam =
          new Rule.Condition()
    ...
    static LifecycleRuleDefinition fromProto(Rule protoEntry) {
        ...
        case UpdateStorageClassLifecycleAction.TYPE:
          ruleAction =
              AbstractLifecycleAction.newUpdateStorageClassAction(
                  StorageClassType.fromValue(lifecycleActParam.getStorageClass()));
          break;
        default:
          throw new UnsupportedOperationException(
              "The specified lifecycle action " + lifecycleActParam.getType() + " is not currently supported");
      }
      ...
      LifecycleRuleCondition.LifecycleConditionBuilder condCreator =
          LifecycleRuleCondition.newLifecycleConditionBuilder()
              .setAge(lifecycleCondParam.getAge())
              .setCreatedBefore(lifecycleCondParam.getCreatedBefore())
              .setIsLive(lifecycleCondParam.getIsLive())
              .setNumberOfNewerVersions(lifecycleCondParam.getNumNewerVersions())
              .setMatchesStorageClass(
                  lifecycleCondParam.getMatchesStorageClass() == null
                      ? null
                      : transform(
                          lifecycleCondParam.getMatchesStorageClass(),
    ...
    public static class LifecycleRuleCondition implements Serializable {
      ...
      public LifecycleConditionBuilder toBuilder() {
        return newLifecycleConditionBuilder()
            .setAge(this.daysOld)
            .setCreatedBefore(this.creationTimestamp)
            .setNumberOfNewerVersions(this.newerVersionsCount)
            .setIsLive(this.liveFlag)
            .setMatchesStorageClass(this.matchingStorageTypes);
      }
      ...
      public String toString() {
        return MoreObjects.toStringHelper(this)
            .add("age", daysOld)
            .add("createBefore", creationTimestamp)
            .add("numberofNewerVersions", newerVersionsCount)
            .add("isLive", liveFlag)
            .add("matchesStorageClass", matchingStorageTypes)
            .toString();
      }
  ...
  public abstract static class DeletionRule implements Serializable {
    ...
    static DeletionRule fromProto(Rule protoEntry) {
      if (protoEntry.getAction() != null && ALLOWED_ACTIONS.endsWith(protoEntry.getAction().getType())) {
        Rule.Condition lifecycleCondParam = protoEntry.getCondition();
  ...
  com.google.api.services.storage.model.Bucket toProto() {
    ...
    if (requesterBillingEnabled != null) {
  ...
  static BucketMetadata fromProto(com.google.api.services.storage.model.Bucket bucketProto) {
    ...
    if (bucketProto.getOwner() != null) {
      uniformBuilder.setOwner(AccessControlEntry.AbstractEntity.fromProto(bucketProto.getOwner().getEntity()));
    }
    ...
    if (bucketProto.getLifecycle() != null && bucketProto.getLifecycle().getRule() != null) {
      uniformBuilder.setLifecycleRules(
          transform(
