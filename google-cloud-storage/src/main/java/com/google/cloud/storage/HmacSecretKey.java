...
public class HmacSecretKey implements Serializable {
  ...
  static HmacSecretKey fromProto(com.google.api.services.storage.model.HmacKey protoKey) {
    return HmacSecretKey.newSecretBuilder(protoKey.getSecret())
        .setMetadata(HmacKeyDetails.fromProto(protoKey.getMetadata()))
        .create();
  }
  ...
  public static class HmacKeyDetails implements Serializable {
    ...
    public static HmacKeyDetails of(
    ...
    public boolean equals(Object otherObject) {
      ...
      return Objects.equals(this.accessIdentifier, thatDetails.accessIdentifier)
          && Objects.equals(this.entityTag, thatDetails.entityTag)
          && Objects.equals(this.resourceIdentifier, thatDetails.resourceIdentifier)
          && Objects.equals(this.projectIdentifier, thatDetails.projectIdentifier)
          && Objects.equals(this.accountInfo, thatDetails.accountInfo)
          && Objects.equals(this.status, thatDetails.status)
          && Objects.equals(this.createdAt, thatDetails.createdAt)
          && Objects.equals(this.updatedAt, thatDetails.updatedAt);
    }

    public com.google.api.services.storage.model.HmacKeyMetadata toProto() {
      com.google.api.services.storage.model.HmacKeyMetadata keyDetails =
      ...
      keyDetails.setServiceAccountEmail(
          this.accountInfo == null ? null : this.accountInfo.getEmail());
      keyDetails.setState(this.status == null ? null : this.status.toString());
      keyDetails.setTimeCreated(this.createdAt == null ? null : new DateTime(this.createdAt));
      keyDetails.setUpdated(this.updatedAt == null ? null : new DateTime(this.updatedAt));

      return keyDetails;
    }

    static HmacKeyDetails fromProto(com.google.api.services.storage.model.HmacKeyMetadata keyDetails) {
      return newServiceAccountBuilder(ServiceAccountInfo.from(keyDetails.getServiceAccountEmail()))
          .setAccessId(keyDetails.getAccessId())
          .setCreateTime(keyDetails.getTimeCreated().getValue())
          .setEtag(keyDetails.getEtag())
          .setId(keyDetails.getId())
          .setProjectId(keyDetails.getProjectId())
          .setState(HmacKeyStatus.valueOf(keyDetails.getState()))
          .setUpdateTime(keyDetails.getUpdated().getValue())
          .buildHmacKeyDetails();
    }
