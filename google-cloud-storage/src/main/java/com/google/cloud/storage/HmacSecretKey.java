...
public class HmacSecretKey implements Serializable {
  ...
  static HmacSecretKey fromProto(com.google.api.services.storage.model.HmacKey protoKey) {
    return HmacSecretKey.createBuilder(protoKey.getSecret())
  ...
  public static class HmacKeyInfo implements Serializable {
    ...
    public static HmacKeyInfo of(
            ServiceAccountInfo serviceAcctInfo, String accessIdentifier, String projectIdentifier) {
    ...
    public boolean equals(Object otherObject) {
      ...
      return Objects.equals(this.accessIdentifier, comparedInfo.accessIdentifier)
          ...
          && Objects.equals(this.serviceAcctInfo, comparedInfo.serviceAcctInfo)
          && Objects.equals(this.status, comparedInfo.status)
          && Objects.equals(this.creationTime, comparedInfo.creationTime)
          && Objects.equals(this.lastUpdated, comparedInfo.lastUpdated);
    }
    ...
    public com.google.api.services.storage.model.HmacKeyMetadata toProto() {
      ...
      keyDetails.setServiceAccountEmail(
          this.serviceAcctInfo == null ? null : this.serviceAcctInfo.getEmail());
      keyDetails.setState(this.status == null ? null : this.status.toString());
      keyDetails.setTimeCreated(this.creationTime == null ? null : new DateTime(this.creationTime));
      keyDetails.setUpdated(this.lastUpdated == null ? null : new DateTime(this.lastUpdated));

      return keyDetails;
    }

    static HmacKeyInfo fromProto(com.google.api.services.storage.model.HmacKeyMetadata keyDetails) {
      return createBuilder(ServiceAccountInfo.ofEmail(keyDetails.getServiceAccountEmail()))
