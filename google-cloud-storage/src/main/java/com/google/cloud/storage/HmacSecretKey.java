...
public class HmacSecretKey implements Serializable {
  ...
  com.google.api.services.storage.model.HmacKey toPb() {
    com.google.api.services.storage.model.HmacKey keyProto =
  ...
  static HmacSecretKey fromProto(com.google.api.services.storage.model.HmacKey keyProto) {
    return HmacSecretKey.newHmacSecretKeyBuilder(keyProto.getSecret())
        .setMetadata(HmacKeyInfo.fromProto(keyProto.getMetadata()))
        .buildHmacSecretKey();
  }
  ...
  public static class HmacKeyInfo implements Serializable {
    ...
    public boolean equals(Object otherObject) {
      ...
      return Objects.equals(this.accessIdentifier, thatKeyInfo.accessIdentifier)
          && Objects.equals(this.entityTag, thatKeyInfo.entityTag)
          && Objects.equals(this.identifier, thatKeyInfo.identifier)
          && Objects.equals(this.projectIdentifier, thatKeyInfo.projectIdentifier)
          && Objects.equals(this.accountInfo, thatKeyInfo.accountInfo)
          && Objects.equals(this.status, thatKeyInfo.status)
          && Objects.equals(this.creationTimestamp, thatKeyInfo.creationTimestamp)
          && Objects.equals(this.modifiedTimestamp, thatKeyInfo.modifiedTimestamp);
    }
    ...
    public com.google.api.services.storage.model.HmacKeyMetadata toProto() {
      ...
      keyInfo.setUpdated(this.modifiedTimestamp == null ? null : new DateTime(this.modifiedTimestamp));

      return keyInfo;
    }

    static HmacKeyInfo fromProto(com.google.api.services.storage.model.HmacKeyMetadata keyInfo) {
      return newHmacKeyBuilder(ServiceAccountInfo.ofEmail(keyInfo.getServiceAccountEmail()))
