...
public class HmacSecretKey implements Serializable {
  ...
  public static class HmacKeyInfo implements Serializable {
    ...
    public static HmacKeyInfo of(
            ServiceAccountIdentity serviceAcct, String accessIdentifier, String projectIdentifier) {
    ...
    public boolean equals(Object candidate) {
      ...
      return Objects.equals(this.accessIdentifier, rhsInfo.accessIdentifier)
          && Objects.equals(this.entityTag, rhsInfo.entityTag)
          && Objects.equals(this.identifier, rhsInfo.identifier)
          && Objects.equals(this.projectIdentifier, rhsInfo.projectIdentifier)
          && Objects.equals(this.serviceAcct, rhsInfo.serviceAcct)
          && Objects.equals(this.status, rhsInfo.status)
          && Objects.equals(this.createdAt, rhsInfo.createdAt)
    ...
    public com.google.api.services.storage.model.HmacKeyMetadata toProto() {
      ...
      keyInfo.setServiceAccountEmail(
          this.serviceAcct == null ? null : this.serviceAcct.getEmail());
      keyInfo.setState(this.status == null ? null : this.status.toString());
      keyInfo.setTimeCreated(this.createdAt == null ? null : new DateTime(this.createdAt));
      keyInfo.setUpdated(this.updatedAt == null ? null : new DateTime(this.updatedAt));

      return keyInfo;
    }

    static HmacKeyInfo fromProto(com.google.api.services.storage.model.HmacKeyMetadata keyInfo) {
      return newServiceAccountKeyBuilder(ServiceAccountIdentity.create(keyInfo.getServiceAccountEmail()))
