...
public class StorageOptions extends ServiceOptions<StorageClient, StorageOptions> {

  private static final long serialVersionUID = -2907268477247502947L;
  private static final String API_SHORT_NAME = "StorageClient";
  ...
  public static class DefaultStorageFactory implements StorageFactory {
    ...
    @Override
    public StorageClient create(StorageOptions options) {
  ...
  public static class Builder extends ServiceOptions.Builder<StorageClient, StorageOptions, Builder> {
  ...
  private static class StorageDefaults implements ServiceDefaults<StorageClient, StorageOptions> {
