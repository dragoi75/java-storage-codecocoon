...
public class StorageOptions extends ServiceOptions<Storage, StorageOptions> {
  ...
  public static class Builder extends ServiceOptions.Builder<Storage, StorageOptions, Builder> {
    ...
    /**
     * Override default enablement from invocation id added to x-goog-api-client header.
     *
     * @param includeInvocationId a boolean to change enablement from invocation id
     * @return the builder
     */
