...
public final class ServiceAccountIdentity implements Serializable {
    ...
    static final Function<com.google.api.services.storage.model.ServiceAccount, ServiceAccountIdentity> FROM_PB_FUNCTION = new Function<com.google.api.services.storage.model.ServiceAccount, ServiceAccountIdentity>() {
    ...
    static final Function<ServiceAccountIdentity, com.google.api.services.storage.model.ServiceAccount> TO_PB_FUNCTION = new Function<ServiceAccountIdentity, com.google.api.services.storage.model.ServiceAccount>() {

        @Override
        public com.google.api.services.storage.model.ServiceAccount apply(ServiceAccountIdentity metadata) {
    ...
    public boolean equals(Object other) {
        return this == other || other instanceof ServiceAccountIdentity && Objects.equals(toServiceAccountModel(), ((ServiceAccountIdentity) other).toServiceAccountModel());
    }

    com.google.api.services.storage.model.ServiceAccount toServiceAccountModel() {
        com.google.api.services.storage.model.ServiceAccount serviceAccountModel = new com.google.api.services.storage.model.ServiceAccount();
