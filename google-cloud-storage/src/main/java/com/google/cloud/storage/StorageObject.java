...
public class StorageObject extends BlobMetadata {
  ...
  public static class BlobReadOption extends AbstractOption {
    ...
    static Storage.BlobSourceOptions[] convertToSourceOptions(
            BlobMetadata metadata, BlobReadOption... clientConfig) {
  ...
  public boolean blobExists(BlobReadOption... clientConfig) {
    ...
    return backendService.get(getBlobId(), retrieveOptions) != null;
  }
  ...
  public ObjectCopyWriter copyToTarget(BlobId destinationBlobId, BlobReadOption... clientConfig) {
    ChunkedCopyRequest copyJob =
        ChunkedCopyRequest.newCopyOperationBuilder()
            .setSource(getBucket(), getName())
            .setSourceOptions(convertToSourceOptions(this, clientConfig))
   ...
   */
  public URL generateSignedUrl(long timeSpan, TimeUnit timeScale, Storage.UrlSigningOption... clientConfig) {
   ...
   * @throws StorageServiceException upon failure
   */
  public boolean deleteAclEntry(AccessControlEntry.AbstractEntity principal) {
