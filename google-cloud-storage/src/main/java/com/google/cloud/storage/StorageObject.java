...
public class StorageObject extends BlobMetadata {
  ...
  static final Function<Tuple<StorageService, com.google.api.services.storage.model.StorageObject>, StorageObject> BLOB_FROM_PB_FUNCTION =
      new Function<Tuple<StorageService, com.google.api.services.storage.model.StorageObject>, StorageObject>() {
        @Override
  ...
  public static class BlobSourceOptions extends AbstractOption {
    ...
    static StorageService.BlobSourceOptions[] toStorageSourceOptionsArray(
  ...
  public boolean existsInStorage(BlobSourceOptions... storageSettings) {
    ...
    return storageService.get(getBlobId(), fetchParams) != null;
  }
  ...
  public BlobCopyWriter copyToDestination(BlobIdentifier destinationBlob, BlobSourceOptions... storageSettings) {
    StorageService.CopyOperationRequest transferSpec =
        StorageService.CopyOperationRequest.newCopyOperationBuilder()
            .setSource(getBucket(), getName())
            .setSourceOptions(toStorageSourceOptionsArray(this, storageSettings))
  ...
  public final boolean equals(Object candidateObject) {
    if (candidateObject == this) {
      return true;
    }
    if (candidateObject == null || !candidateObject.getClass().equals(StorageObject.class)) {
      return false;
    }
