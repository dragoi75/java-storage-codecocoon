...
public class StorageObject extends BlobAttributes {
    ...
    public BlobCopyWriter copyToTarget(BlobIdentifier destinationBlobId, BlobSourceOptions... storageSettings) {
        StorageClient.DataCopyRequest transferRequest = DataCopyRequest.builder().setSource(getBucket(), getName()).setSourceOptions(toSourceOptionsArray(this, storageSettings)).setTarget(destinationBlobId).buildCopyRequest();
