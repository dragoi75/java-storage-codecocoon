...
public class StorageObject extends BlobAttributes {
    ...
    static final Function<Tuple<StorageClient, com.google.api.services.storage.model.StorageObject>, StorageObject> BLOB_FROM_PB_FUNCTION = new Function<Tuple<StorageClient, com.google.api.services.storage.model.StorageObject>, StorageObject>() {
    ...
    public static class BlobSourceOptions extends RpcOptionEntry {
        ...
        static StorageClient.BlobSourceOptions[] toSourceOptionsArray(BlobAttributes blobAttributes, BlobSourceOptions... storageSettings) {
     ...
     */
    public URL generateSignedUrl(long timeToLive, TimeUnit timeMeasure, UrlSigningOption... storageSettings) {
    ...
    public BlobCopyWriter copyToTarget(BlobIdentifier destinationBlobId, BlobSourceOptions... storageSettings) {
        DataCopyRequest transferRequest = DataCopyRequest.builder().setSource(getBucket(), getName()).setSourceOptions(toSourceOptionsArray(this, storageSettings)).setTarget(destinationBlobId).buildCopyRequest();
    ...
    public boolean blobExists(BlobSourceOptions... storageSettings) {
        ...
        return null != storageClient.get(getBlobId(), getOpts);
    }
    ...
    public void downloadToPath(OutputStream outStream, BlobSourceOptions... storageSettings) {
        ...
        try {
            runWithRetries(callable(new Runnable() {
                ...
                @Override
                public void run() {
                    rpcClient.read(getBlobId().toStorageObject(), requestParams, countingOut.getCount(), countingOut);
                }
            }), this.storageSettings.getRetrySettings(), StorageImpl.EXCEPTION_HANDLER, this.storageSettings.getClock());
