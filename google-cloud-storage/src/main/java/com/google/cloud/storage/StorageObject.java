...
public class StorageObject extends BlobInfo {
  ...
  static final Function<Tuple<Storage, com.google.api.services.storage.model.StorageObject>, StorageObject> BLOB_FROM_PB_FUNCTION =
  ...
  public static class BlobReadOption extends AbstractOption {
    ...
    static Storage.BlobSourceSettings[] toSourceOptionsArray(
            BlobInfo blobMetadata, BlobReadOption... storageSettings) {
  ...
  public boolean existsInStorage(BlobReadOption... storageSettings) {
    ...
    return backendClient.get(getBlobId(), retrievalOptions) != null;
  }
  ...
  public ChunkedCopyWriter copyToBlob(BlobIdentifier destinationBlob, BlobReadOption... storageSettings) {
    CopyOperationRequest transferOperation =
        CopyOperationRequest.createBuilder()
   ...
   */
  public URL generateSignedUrl(long expiryTime, TimeUnit timeScale, Storage.UrlSigningOption... storageSettings) {
   ...
   * @throws StorageServiceException upon failure
   */
  public boolean deleteAclForEntity(AclEntry.BaseEntity principal) {
