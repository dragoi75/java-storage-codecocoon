...
public class StorageObject extends BlobMetadata {
  ...
  static final Function<Tuple<CloudStorageClient, com.google.api.services.storage.model.StorageObject>, StorageObject> BLOB_FROM_PB_FUNCTION =
      new Function<Tuple<CloudStorageClient, com.google.api.services.storage.model.StorageObject>, StorageObject>() {
        @Override
  ...
  public static class BlobSourceOptions extends AbstractOption {
    ...
    static CloudStorageClient.BlobReadOption[] toSourceOptionsArray(
            BlobMetadata blobMetadata, BlobSourceOptions... clientSettings) {
  ...
  public void downloadToPath(OutputStream outStream, BlobSourceOptions... clientSettings) {
    ...
    try {
      runWithRetries(
          ...
          this.clientSettings.getRetrySettings(),
          StorageServiceImpl.EXCEPTION_HANDLER,
          this.clientSettings.getClock());
  ...
  public boolean existsInStorage(BlobSourceOptions... clientSettings) {
    ...
    return cloudClient.get(getBlobId(), resolvedGetOptions) != null;
  }
  ...
  public BlobRewriteWriter copyToDestination(BlobIdentifier destinationBlobId, BlobSourceOptions... clientSettings) {
    CopyOperationRequest copyOperation =
        CopyOperationRequest.builder()
            .setSource(getBucket(), getName())
            .setSourceOptions(toSourceOptionsArray(this, clientSettings))
