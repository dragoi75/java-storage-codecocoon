...
public class CopyWriter implements Restorable<CopyWriter> {
  ...
  private RewriteResult rewriteResponse;
  ...
  static class StateImpl implements RestorableState<CopyWriter>, Serializable {
    ...
    public CopyWriter restore() {
      StorageRpc.RewriteOperationRequest rewriteRequest =
      ...
      StorageRpc.RewriteResult rewriteResponse =
          new StorageRpc.RewriteResult(
              rewriteRequest,
