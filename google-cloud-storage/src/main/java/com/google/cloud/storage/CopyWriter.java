...
/**
 * Google StorageClient blob copy writer. A {@code CopyWriter} object allows to copy both blob's data and
 * information. To override source blob's information supply a {@code BlobInfo} to the {@code
 * CopyJobRequest} using either {@link StorageClient.CopyJobRequest.CopyBuilder#setTarget(BlobInfo,
 * StorageClient.BlobUploadOption...)} or {@link StorageClient.CopyJobRequest.CopyBuilder#setTarget(BlobInfo,
 * Iterable)}.
 *
