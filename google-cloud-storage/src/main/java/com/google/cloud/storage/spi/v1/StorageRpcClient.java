...
public interface StorageRpcClient extends ServiceRpc {
  ...
  class ObjectRewriteRequest {
    ...
    public ObjectRewriteRequest(
        StorageObject inputObject,
        Map<StorageOption, ?> inputOptionMap,
        boolean forceUpdate,
        StorageObject destObject,
        Map<StorageOption, ?> destOptionMap,
        Long mbPerCall) {
    ...
    public boolean equals(Object candidate) {
      ...
      return Objects.equals(this.source, thatRewrite.source)
          && Objects.equals(this.sourceOptions, thatRewrite.sourceOptions)
          && Objects.equals(this.overrideInfo, thatRewrite.overrideInfo)
          && Objects.equals(this.target, thatRewrite.target)
          && Objects.equals(this.targetOptions, thatRewrite.targetOptions)
          && Objects.equals(this.megabytesRewrittenPerCall, thatRewrite.megabytesRewrittenPerCall);
    }
  ...
  class RewriteOperationResponse {
    ...
    public RewriteOperationResponse(
    ...
    public boolean equals(Object candidate) {
      ...
      return Objects.equals(this.rewriteRequest, thatRewrite.rewriteRequest)
          && Objects.equals(this.result, thatRewrite.result)
          && Objects.equals(this.rewriteToken, thatRewrite.rewriteToken)
          && this.blobSize == thatRewrite.blobSize
          && Objects.equals(this.isDone, thatRewrite.isDone)
          && this.totalBytesRewritten == thatRewrite.totalBytesRewritten;
    }
