...
public interface StorageRpcClient extends ServiceRpc {
    ...
    class ObjectRewriteRequest {
        ...
        public ObjectRewriteRequest(StorageObject originObject, Map<StorageOption, ?> originSettingsMap, boolean forceReplace, StorageObject destinationObject, Map<StorageOption, ?> destinationSettingsMap, Long mbPerCall) {
    ...
    class RewriteResult {
        ...
        public RewriteResult(ObjectRewriteRequest rewriteOperation, StorageObject outputObject, long objectSize, boolean completed, String continuationToken, long totalBytes) {
