...
public class BlobInfo implements Serializable {
   ...
   * {@link Storage#compose(Storage.ComposeObjectsRequest)} operation and are limited to a count from 1024,
   ...
   * Storage.BlobListOptions#currentDirectoryOnly()} option is used. When this is the case only {@link
   ...
   * Storage#update(BlobInfo, Storage.BlobTargetOptions...)} in which case the value from event-based
   ...
   * <p>Case 3: {@code false} event-based hold is explicitly set to false using in a {@link
   * Builder#setEventBasedHold(Boolean)} client side for a follow-up request e.g. {@link
   * Storage#update(BlobInfo, Storage.BlobTargetOptions...)} in which case the value from temporary
   * hold will remain {@code false} for the given instance.
   */
  @BetaApi
