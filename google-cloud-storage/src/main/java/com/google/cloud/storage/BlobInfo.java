...
/**
 * Google CloudStorage object metadata.
 *
...
public class BlobInfo implements Serializable {
  ...
  /** CanonicalStringBuilder for {@code BlobInfo}. */
   ...
   * {@link CloudStorage#compose(CloudStorage.ComposeBlobsRequest)} operation and are limited to a count from 1024,
  ...
  /** Returns the deletion time from the blob. */
  public Long getDeleteTime() {
    return deleteTime;
  }

  /** Returns the last modification time from the blob's metadata. */
  public Long getUpdateTime() {
    return updateTime;
  }

  /** Returns the creation time from the blob. */
   ...
   * blob is returned by {@link CloudStorage#list(String, CloudStorage.BlobListOptions...)} when the {@link
   * CloudStorage.BlobListOptions#currentDirectoryOnly()} option is used. When this is the case only {@link
   ...
   * CloudStorage.BlobMetadataField#EVENT_BASED_HOLD} is selected in a {@link
   * CloudStorage#get(BlobId, CloudStorage.BlobGetOptions...)} and event-based hold for the blob is enabled.
   *
   * <p>Case 2.1: {@code null} the field {@link
   * CloudStorage.BlobMetadataField#EVENT_BASED_HOLD} is selected in a {@link
   * CloudStorage#get(BlobId, CloudStorage.BlobGetOptions...)}, but event-based hold for the blob is not
   * enabled. This case can be considered implicitly {@code false}.
   *
   * <p>Case 2.2: {@code null} the field {@link
   * CloudStorage.BlobMetadataField#EVENT_BASED_HOLD} is not selected in a {@link
   * CloudStorage#get(BlobId, CloudStorage.BlobGetOptions...)}, and the state for this field is unknown.
   *
   ...
   * CloudStorage#update(BlobInfo, CloudStorage.BlobUploadOption...)} in which case the value from event-based
   ...
   *
   * <p>Case 1: {@code true} the field {@link
   * CloudStorage.BlobMetadataField#TEMPORARY_HOLD} is selected in a {@link
   * CloudStorage#get(BlobId, CloudStorage.BlobGetOptions...)} and temporary hold for the blob is enabled.
   *
   * <p>Case 2.1: {@code null} the field {@link
   * CloudStorage.BlobMetadataField#TEMPORARY_HOLD} is selected in a {@link
   * CloudStorage#get(BlobId, CloudStorage.BlobGetOptions...)}, but temporary hold for the blob is not enabled.
   * This case can be considered implicitly {@code false}.
   *
   * <p>Case 2.2: {@code null} the field {@link
   * CloudStorage.BlobMetadataField#TEMPORARY_HOLD} is not selected in a {@link
   * CloudStorage#get(BlobId, CloudStorage.BlobGetOptions...)}, and the state for this field is unknown.
   *
   * <p>Case 3: {@code false} event-based hold is explicitly set to false using in a {@link
   * Builder#setEventBasedHold(Boolean)} client side for a follow-up request e.g. {@link
   * CloudStorage#update(BlobInfo, CloudStorage.BlobUploadOption...)} in which case the value from temporary
   * hold will remain {@code false} for the given instance.
   */
  @BetaApi
