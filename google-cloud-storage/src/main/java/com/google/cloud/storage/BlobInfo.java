...
public class BlobInfo implements Serializable {
  ...
  /** Returns a newBuilder for the current blob. */
  ...
  /** Returns a {@code BlobInfo} newBuilder where blob identity is set using the provided values. */
  ...
  /** Returns a {@code BlobInfo} newBuilder where blob identity is set using the provided value. */
