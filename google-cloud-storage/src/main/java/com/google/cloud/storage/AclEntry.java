...
public final class AclEntry implements Serializable {
  ...
  static final Function<ObjectAccessControl, AclEntry> FROM_OBJECT_PROTO_FN =
  ...
  static final Function<BucketAccessControl, AclEntry> FROM_BUCKET_PROTO_FN =
  ...
  public static final class AccessRole extends StringEnumValue {
    ...
    private static final ApiFunction<String, AccessRole> ACCESS_ROLE_CREATOR =
  ...
  public static final class ProjectInfo extends TypedEntity {
    ...
    public static final class ProjectRoleType extends StringEnumValue {
      ...
      private static final ApiFunction<String, ProjectRoleType> ACCESS_ROLE_CREATOR =
      ...
      private static final StringEnumType<ProjectRoleType> ACCESS_ROLE_TYPE =
          new StringEnumType(ProjectRoleType.class, ACCESS_ROLE_CREATOR);
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
        .add("entity", typedItem)
        .add("role", accessPermission)
        .add("etag", versionTag)
        .add("id", uniqueKey)
        .toString();
  }
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(this.typedItem, thatEntry.typedItem)
        && Objects.equals(this.accessPermission, thatEntry.accessPermission)
        && Objects.equals(this.versionTag, thatEntry.versionTag)
        && Objects.equals(this.uniqueKey, thatEntry.uniqueKey);
  }
  ...
  static AclEntry fromProto(ObjectAccessControl objAccess) {
    ...
    return builder(typedItem, accessPermission)
        .setEtag(objAccess.getEtag())
        .setId(objAccess.getId())
        .buildEntry();
  }
