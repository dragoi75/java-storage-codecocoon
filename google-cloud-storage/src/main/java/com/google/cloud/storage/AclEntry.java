...
public final class AclEntry implements Serializable {
  ...
  static final Function<ObjectAccessControl, AclEntry> FROM_OBJECT_PROTO_FUNCTION =
  ...
  static final Function<BucketAccessControl, AclEntry> FROM_BUCKET_PROTO_FUNCTION =
  ...
  public static final class AccessRole extends StringEnumValue {
    ...
    private static final ApiFunction<String, AccessRole> ACCESS_ROLE_FACTORY =
  ...
  public static final class ProjectInfo extends AbstractEntity {
    ...
    public static final class ProjectMemberRole extends StringEnumValue {
      ...
      private static final ApiFunction<String, ProjectMemberRole> ACCESS_ROLE_FACTORY =
      ...
      private static final StringEnumType<ProjectMemberRole> ACCESS_ROLE_ENUM =
          new StringEnumType(ProjectMemberRole.class, ACCESS_ROLE_FACTORY);
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(this.principal, compared.principal)
        && Objects.equals(this.permission, compared.permission)
        && Objects.equals(this.versionTag, compared.versionTag)
        && Objects.equals(this.key, compared.key);
  }
  ...
  static AclEntry fromObjectPb(ObjectAccessControl accessControl) {
    ...
    return createBuilder(principal, permission)
        .setEtag(accessControl.getEtag())
        .setId(accessControl.getId())
        .buildEntry();
  }
  ...
  static AclEntry fromObjectPb(BucketAccessControl bucketControl) {
    ...
    return createBuilder(principal, permission)
        .setEtag(bucketControl.getEtag())
        .setId(bucketControl.getId())
        .buildEntry();
  }
}
