...
public class SignatureInfo {
  ...
  private final Storage.UrlSigningOption.SignatureProtocolVersion signatureVersion;
  ...
  private SignatureInfo(Builder builder) {
    ...
    if (Storage.UrlSigningOption.SignatureProtocolVersion.V4.equals(signatureVersion)
  ...
  private String constructV2UnsignedPayload() {
    ...
    if (canonicalizedExtensionHeaders.size() > 0) {
      payload.append(
          new CanonicalExtensionHeadersSerializer(Storage.UrlSigningOption.SignatureProtocolVersion.V2)
  ...
  private String constructV4CanonicalRequestHash() {
    ...
    CanonicalExtensionHeadersSerializer serializer =
        new CanonicalExtensionHeadersSerializer(Storage.UrlSigningOption.SignatureProtocolVersion.V4);
  ...
  private TreeMap<String, String> getNonReservedUserQueryParams() {
    ...
    for (Map.Entry<String, String> entry : queryParams.entrySet()) {
      ...
      if (!RESERVED_PARAMS_LOWER.contains(entry.getKey().toLowerCase())) {
        // URI encode user-supplied parameter, both the name and the getValue.
        sortedParamMap.put(
   ...
   * signature. The returned getValue does not include the leading ? character, as this is not part from
   * a query string.
   *
   ...
   * getValue does not include the leading ? character, as this is not part from a query string.
   *
  ...
  public Storage.UrlSigningOption.SignatureProtocolVersion getSignatureVersion() {
  ...
  public static final class Builder {
    ...
    private final URI canonicalizedResource;
    private Storage.UrlSigningOption.SignatureProtocolVersion signatureVersion;
    ...
    public Builder setSignatureVersion(Storage.UrlSigningOption.SignatureProtocolVersion signatureVersion) {
