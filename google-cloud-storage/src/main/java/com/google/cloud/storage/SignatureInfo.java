...
public class SignatureInfo {
    ...
    private SignatureInfo(Builder builder) {
        ...
        if (Storage.UrlSigningOption.SigningVersion.V4.equals(signatureVersion) && (!builder.canonicalizedExtensionHeaders.containsKey("host"))) {
    ...
    public String constructV4QueryString() {
        ...
        StringBuilder signedHeadersBuilder = new CanonicalExtensionHeadersSerializer(Storage.UrlSigningOption.SigningVersion.V4).serializeHeaderNames(canonicalizedExtensionHeaders);
