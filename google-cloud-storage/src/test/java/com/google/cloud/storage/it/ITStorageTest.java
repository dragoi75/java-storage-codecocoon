...
import com.google.cloud.storage.Storage.BucketMetadataField;
...
public class ITStorageTest {
  ...
  public void beforeEach() {
    Bucket remoteBucket =
        storage.get(
            BUCKET,
            Storage.BucketGetOptions.setFields(BucketMetadataField.ID, BucketMetadataField.BILLING),
    ...
    if (remoteBucket.requesterPays() != null && remoteBucket.requesterPays() == true) {
      remoteBucket
          ...
          .build()
          .update(Storage.TargetBucketOption.withUserProject(storage.getOptions().getProjectId()));
    }
  }
  ...
  private static void ensureKmsKeyRingIamPermissionsForTests(
    ...
    Binding binding =
        Binding.newBuilder()
            ...
            .addMembers("ofServiceAccount:" + serviceAccount.getEmail())
            .build();
  ...
  public void testListBuckets() throws InterruptedException {
    Iterator<Bucket> bucketIterator =
        storage
            .list(Storage.ListBucketsOption.withPrefix(BUCKET), Storage.ListBucketsOption.withFields())
            .iterateAll()
            .iterator();
  ...
  public void testGetBucketSelectedFields() {
    Bucket remoteBucket = storage.get(BUCKET, Storage.BucketGetOptions.setFields(BucketMetadataField.ID));
  ...
  public void testGetBucketLifecycleRules() {
    ...
    storage.create(
        BucketInfo.newBuilder(lifecycleTestBucketName)
            ...
            .build());
    Bucket remoteBucket =
        storage.get(lifecycleTestBucketName, Storage.BucketGetOptions.setFields(BucketMetadataField.LIFECYCLE));
  ...
  public void testCreateGetBlobWithEncryptionKey() {
    ...
    BlobInfo blob = BlobInfo.newBuilder(BUCKET, blobName).build();
    Blob remoteBlob =
        storage.create(blob, BLOB_BYTE_CONTENT, Storage.BlobUploadOption.encryptionKeyOption(KEY));
    assertNotNull(remoteBlob);
    assertEquals(blob.getBucket(), remoteBlob.getBucket());
    assertEquals(blob.getName(), remoteBlob.getName());
    byte[] readBytes =
    ...
    remoteBlob =
        storage.get(
            ...
            Storage.BlobGetOptions.setFields(Storage.BlobMetadataField.CRC32C, Storage.BlobMetadataField.MD5HASH));
  ...
  public void testCreateBlobWithKmsKeyNameAndCustomerSuppliedKey() {
    try {
      ...
      storage.create(
          blob,
          BLOB_BYTE_CONTENT,
          Storage.BlobUploadOption.encryptionKeyOption(KEY),
  ...
  public void testCreateBlobStreamDisableGzipContent() {
    ...
    BlobInfo blob = BlobInfo.newBuilder(BUCKET, blobName).setContentType(CONTENT_TYPE).build();
    ByteArrayInputStream stream = new ByteArrayInputStream(BLOB_STRING_CONTENT.getBytes(UTF_8));
    Blob remoteBlob = storage.create(blob, stream, ObjectWriteOption.withGzipDisabled());
    assertNotNull(remoteBlob);
    assertEquals(blob.getBucket(), remoteBlob.getBucket());
    assertEquals(blob.getName(), remoteBlob.getName());
    assertEquals(blob.getContentType(), remoteBlob.getContentType());
  ...
  public void testCreateBlobMd5Fail() {
    ...
    ByteArrayInputStream stream = new ByteArrayInputStream(BLOB_STRING_CONTENT.getBytes(UTF_8));
    try {
      storage.create(blob, stream, ObjectWriteOption.ifMd5Match());
      fail("StorageException was expected");
    } catch (StorageException ex) {
      // expected
    }
  ...
  public void testGetBlobEmptySelectedFields() {
    ...
    Blob remoteBlob = storage.get(blob.getBlobId(), Storage.BlobGetOptions.setFields());
  ...
  public void testGetBlobSelectedFields() {
    ...
    assertNotNull(storage.create(blob));
    Blob remoteBlob =
        storage.get(blob.getBlobId(), Storage.BlobGetOptions.setFields(Storage.BlobMetadataField.METADATA));
    assertEquals(blob.getBlobId(), remoteBlob.getBlobId());
  ...
  public void testGetBlobKmsKeyNameField() {
    ...
    Blob remoteBlob =
        storage.get(blob.getBlobId(), Storage.BlobGetOptions.setFields(Storage.BlobMetadataField.KMS_KEY_NAME));
    assertEquals(blob.getBlobId(), remoteBlob.getBlobId());
    assertTrue(remoteBlob.getKmsKeyName().startsWith(kmsKeyOneResourcePath));
    assertNull(remoteBlob.getContentType());
  }
  ...
  public void testGetBlobAllSelectedFields() {
    ...
    assertNotNull(storage.create(blob));
    Blob remoteBlob =
        storage.get(blob.getBlobId(), Storage.BlobGetOptions.setFields(Storage.BlobMetadataField.values()));
    assertEquals(blob.getBucket(), remoteBlob.getBucket());
    assertEquals(blob.getName(), remoteBlob.getName());
    assertEquals(ImmutableMap.of("k", "v"), remoteBlob.getMetadata());
  ...
  public void testListBlobRequesterPays() throws InterruptedException {
    BlobInfo blob1 =
        BlobInfo.newBuilder(BUCKET, "test-list-blobs-empty-selected-setFields-blob1")
            .setContentType(CONTENT_TYPE)
            .build();
    ...
    Bucket remoteBucket =
        storage.get(BUCKET, Storage.BucketGetOptions.setFields(BucketMetadataField.ID, BucketMetadataField.BILLING));
  ...
  public void testComposeBlobFail() {
    ...
    Storage.ComposeBlobsRequest req =
        Storage.ComposeBlobsRequest.newTargetBuilder()
            .addSourceBlob(sourceBlobName1, -1L)
            .addSourceBlob(sourceBlobName2, -1L)
  ...
  public void testCopyBlob() {
    ...
    Storage.CopyOperationRequest req = Storage.CopyOperationRequest.copyOf(source, BlobId.of(BUCKET, targetBlobName));
    ...
    Storage.CopyOperationRequest req =
        Storage.CopyOperationRequest.newCopyOperationBuilder()
            ...
            .setTarget(
                ...
                Storage.BlobUploadOption.withPredefinedAcl(Storage.PredefinedAclEntry.PUBLIC_READ))
  ...
  public void testCopyBlobWithEncryptionKeys() {
    ...
    Storage.CopyOperationRequest req =
        Storage.CopyOperationRequest.newCopyOperationBuilder()
            .setSource(source)
            .setTarget(target, Storage.BlobUploadOption.encryptionKeyOption(OTHER_BASE64_KEY))
  ...
  public void testReadAndWriteChannelWithEncryptionKey() throws IOException {
    ...
    try (WriteChannel writer =
        storage.writer(blob, Storage.ObjectWriteOption.customerSuppliedKey(BASE64_KEY))) {
      stringBytes = BLOB_STRING_CONTENT.getBytes(UTF_8);
      writer.write(ByteBuffer.wrap(BLOB_BYTE_CONTENT));
      writer.write(ByteBuffer.wrap(stringBytes));
    }
  ...
  public void testWriteChannelFail() throws IOException {
    ...
    try {
      try (WriteChannel writer = storage.writer(blob, Storage.ObjectWriteOption.ifGenerationMatch())) {
  ...
  public void testGetSignedUrl() throws IOException {
    ...
    for (Storage.UrlSigningOption urlStyle :
        Arrays.asList(
            Storage.UrlSigningOption.pathStyle(),
  ...
  private void testBucketAclRequesterPays(boolean requesterPays) {
    if (requesterPays) {
      Bucket remoteBucket =
          storage.get(BUCKET, Storage.BucketGetOptions.setFields(BucketMetadataField.ID, Storage.BucketMetadataField.BILLING));
    ...
    Storage.BucketSourceOptions[] bucketOptions =
        requesterPays
            ? new Storage.BucketSourceOptions[] {Storage.BucketSourceOptions.setUserProject(projectId)}
    ...
    if (requesterPays) {
      ...
      Bucket updatedBucket =
          storage.update(remoteBucket, Storage.TargetBucketOption.withUserProject(projectId));
  ...
  public void testHmacKey() {
    ...
    try {
      ...
      Page<HmacKey.HmacKeyMetadata> metadatas =
          storage.listHmacKeys(Storage.HmacKeyListOption.ofServiceAccount(serviceAccount));
      ...
      metadatas = storage.listHmacKeys(Storage.HmacKeyListOption.ofServiceAccount(serviceAccount));
      ...
      metadatas =
          storage.listHmacKeys(
              Storage.HmacKeyListOption.ofServiceAccount(serviceAccount),
              Storage.HmacKeyListOption.withMaxResults(2L));
      ...
      metadatas =
          storage.listHmacKeys(
              Storage.HmacKeyListOption.ofServiceAccount(serviceAccount),
              Storage.HmacKeyListOption.withMaxResults(2L),
              Storage.HmacKeyListOption.pageToken(nextPageToken));
  ...
  public void testBucketPolicyV1RequesterPays() throws ExecutionException, InterruptedException {
    ...
    try {
      Bucket bucketDefault =
          storage.get(
              bucketName, Storage.BucketGetOptions.setFields(BucketMetadataField.ID, BucketMetadataField.BILLING));
      ...
      Bucket bucketFalse =
          storage.update(
              ...
              Storage.TargetBucketOption.withUserProject(projectId));
    ...
    List<com.google.cloud.Binding> bindingsWithConditionalPolicy =
        ImmutableList.of(
            ...
            com.google.cloud.Binding.newBuilder()
                ...
                .setMembers(
                    ImmutableList.of(
                        "ofServiceAccount:storage-python@spec-test-ruby-samples.iam.gserviceaccount.com"))
                .setCondition(
  ...
  public void testUpdateBucketRequesterPays() {
    ...
    assertNotNull(remoteBlob);
    byte[] readBytes =
        storage.readAllBytes(BUCKET, blobName, Storage.BlobSourceOptions.withUserProject(projectId));
    assertArrayEquals(BLOB_BYTE_CONTENT, readBytes);
    remoteBucket = remoteBucket.toBuilder().setRequesterPays(false).build();
    updatedBucket = storage.update(remoteBucket, Storage.TargetBucketOption.withUserProject(projectId));
    assertFalse(updatedBucket.requesterPays());
  }
  ...
  public void testListBucketRequesterPaysFails() throws InterruptedException {
    ...
    Iterator<Bucket> bucketIterator =
        storage
            .list(
                Storage.ListBucketsOption.withPrefix(BUCKET),
                Storage.ListBucketsOption.withFields(),
                Storage.ListBucketsOption.withUserProject(projectId))
            .iterateAll()
            .iterator();
    while (!bucketIterator.hasNext()) {
      Thread.sleep(500);
  ...
  public void testListBucketDefaultKmsKeyName() throws ExecutionException, InterruptedException {
    ...
    try {
      Iterator<Bucket> bucketIterator =
          storage
              .list(
                  Storage.ListBucketsOption.withPrefix(bucketName),
                  Storage.ListBucketsOption.withFields(Storage.BucketMetadataField.ENCRYPTION))
              .iterateAll()
              .iterator();
      while (!bucketIterator.hasNext()) {
        Thread.sleep(500);
        bucketIterator =
            storage
                .list(
                    Storage.ListBucketsOption.withPrefix(bucketName),
                    Storage.ListBucketsOption.withFields(BucketMetadataField.ENCRYPTION))
                .iterateAll()
                .iterator();
      }
      while (bucketIterator.hasNext()) {
  ...
  public void testRetentionPolicyNoLock() throws ExecutionException, InterruptedException {
    ...
    try {
      ...
      remoteBucket =
          storage.get(bucketName, Storage.BucketGetOptions.setFields(BucketMetadataField.RETENTION_POLICY));
      assertEquals(RETENTION_PERIOD, remoteBucket.getRetentionPeriod());
      assertNotNull(remoteBucket.getRetentionEffectiveTime());
      assertNull(remoteBucket.retentionPolicyIsLocked());
  ...
  private void retentionPolicyLockRequesterPays(boolean requesterPays)
    ...
    try {
      ...
      if (requesterPays) {
        remoteBucket =
            storage.lockRetentionPolicy(
                remoteBucket,
                Storage.TargetBucketOption.ifMetagenerationMatch(),
                Storage.TargetBucketOption.withUserProject(projectId));
      } else {
        remoteBucket =
            storage.lockRetentionPolicy(
                remoteBucket, Storage.TargetBucketOption.ifMetagenerationMatch());
      }
      ...
      if (requesterPays) {
        ...
        Bucket updateBucket =
            storage.update(bucketInfo, Storage.TargetBucketOption.withUserProject(projectId));
  ...
  public void testEnableDisableBucketDefaultEventBasedHold()
    ...
    try {
      ...
      remoteBucket =
          storage.get(
              bucketName, Storage.BucketGetOptions.setFields(BucketMetadataField.DEFAULT_EVENT_BASED_HOLD));
      assertTrue(remoteBucket.getDefaultEventBasedHold());
      ...
      remoteBlob =
          storage.get(
              blobInfo.getBlobId(), Storage.BlobGetOptions.setFields(Storage.BlobMetadataField.EVENT_BASED_HOLD));
      assertTrue(remoteBlob.getEventBasedHold());
  ...
  public void testEnableDisableTemporaryHold() {
    ...
    remoteBlob =
        storage.get(remoteBlob.getBlobId(), Storage.BlobGetOptions.setFields(Storage.BlobMetadataField.TEMPORARY_HOLD));
    assertTrue(remoteBlob.getTemporaryHold());
  ...
  public void testEnableAndDisableBucketPolicyOnlyOnExistingBucket() throws Exception {
    ...
    try {
      ...
      Bucket remoteBucket =
          storage.get(bpoBucket, Storage.BucketGetOptions.setFields(BucketMetadataField.IAMCONFIGURATION));
  ...
  public void testBucketLocationType() throws ExecutionException, InterruptedException {
    ...
    Bucket bucket1 =
        storage.lockRetentionPolicy(bucket, Storage.TargetBucketOption.ifMetagenerationMatch());
    ...
    Iterator<Bucket> bucketIterator =
        storage.list(Storage.ListBucketsOption.withPrefix(bucketName)).iterateAll().iterator();
    while (bucketIterator.hasNext()) {
      Bucket remoteBucket = bucketIterator.next();
  ...
  public void testSignedPostPolicyV4() throws Exception {
    PostFieldsMapV4 fields = PostFieldsMapV4.newUploadFormBuilder().setAcl("public-read").buildPostFieldsMap();
  ...
  public void testUploadWithEncryption() throws Exception {
    ...
    Blob blob = storage.createFrom(blobInfo, content, Storage.ObjectWriteOption.customerSuppliedKey(KEY));
