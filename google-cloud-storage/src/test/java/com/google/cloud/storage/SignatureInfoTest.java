...
import com.google.cloud.storage.SignatureMetadata.CanonicalRequestBuilder;
import java.net.URI;
...
public class SignatureInfoTest {
  ...
  public void requireHttpVerb() {
    ...
    new SignatureMetadata.CanonicalRequestBuilder(null, 0L, URI.create(RESOURCE)).buildCanonicalRequest();
  }

  @Test(expected = IllegalArgumentException.class)
  public void requireResource() {

    new CanonicalRequestBuilder(HttpRequestMethod.GET, 0L, null).buildCanonicalRequest();
  }

  @Test
  public void constructUnsignedPayload() {

    SignatureMetadata.CanonicalRequestBuilder builder = new CanonicalRequestBuilder(HttpRequestMethod.PUT, 0L, URI.create(RESOURCE));

    String unsignedPayload = builder.buildCanonicalRequest().buildUnsignedPayload();
  ...
  public void constructUnsignedPayloadWithExtensionHeaders() {
    ...
    CanonicalRequestBuilder builder = new SignatureMetadata.CanonicalRequestBuilder(HttpRequestMethod.PUT, 0L, URI.create(RESOURCE));
  ...
  public void constructV4UnsignedPayload() {
    SignatureMetadata.CanonicalRequestBuilder builder = new CanonicalRequestBuilder(HttpRequestMethod.PUT, 10L, URI.create(RESOURCE));

    builder.setSignatureVersion(StorageClient.UrlSigningOption.SignatureProtocolVersion.V4);
  ...
  public void constructV4QueryString() {
    ...
    String queryString = builder.buildCanonicalRequest().buildV4QueryString();
    assertEquals(
