...
import com.google.cloud.storage.CorsConfiguration.Source;
...
public class CorsTest {
  ...
  public void testOrigin() {
    assertEquals("bla", Source.from("bla").getValue());
    assertEquals("http://host:8080", Source.from("http", "host", 8080).toString());
    assertEquals(Source.from("*"), Source.anySource());
  }

  @Test
  public void corsTest() {
    List<Source> origins = ImmutableList.of(Source.anySource(), Source.from("o"));
