...
public class BlobTest {
  ...
  public void testContentWithDecryptionKey() throws Exception {
    ...
    replay(storage);
    initializeBlob();
    assertArrayEquals(content, blob.getContent(StorageObject.BlobSourceOptions.customerSuppliedKey(BASE64_KEY)));
    assertArrayEquals(content, blob.getContent(StorageObject.BlobSourceOptions.customerSuppliedKey(KEY)));
  }
  ...
  public void testReloadWithOptions() throws Exception {
    ...
    replay(storage);
    initializeBlob();
    StorageObject updatedBlob = blob.refresh(StorageObject.BlobSourceOptions.ifMetagenerationMatch());
    assertEquals(expectedReloadedBlob, updatedBlob);
  }
  ...
  public void testReaderWithDecryptionKey() throws Exception {
    ...
    assertSame(channel, blob.getReader(StorageObject.BlobSourceOptions.customerSuppliedKey(KEY)));
  }
  ...
  public void testWriterWithEncryptionKey() throws Exception {
    ...
    replay(storage);
    initializeBlob();
    assertSame(channel, blob.getWriter(BlobWriteOption.encryptionKey(BASE64_KEY)));
    assertSame(channel, blob.getWriter(BlobWriteOption.encryptionKey(KEY)));
  }
  ...
  public void testWriterWithKmsKeyName() throws Exception {
    ...
    replay(storage);
    initializeBlob();
    assertSame(channel, blob.getWriter(BlobWriteOption.kmsKeyName(KMS_KEY_NAME)));
  }
  ...
  public void testDeleteAcl() throws Exception {
    ...
    replay(storage);
    initializeBlob();
    assertTrue(blob.removeAclEntry(User.ofAllAuthenticatedUsers()));
  }
  ...
  public void testCreateAcl() throws Exception {
    ...
    replay(storage);
    initializeBlob();
    assertEquals(returnedAcl, blob.createAclForBlob(ACL));
  }
