...
public final class DefaultRetryHandlingBehaviorTest {
  ...
  enum ThrowableCategory {
    ...
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_401(new StorageServiceException(C.HTTP_401)),
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_403(new StorageServiceException(C.HTTP_403)),
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_404(new StorageServiceException(C.HTTP_404)),
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_408(new StorageServiceException(C.HTTP_409)),
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_429(new StorageServiceException(C.HTTP_429)),
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_500(new StorageServiceException(C.HTTP_500)),
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_502(new StorageServiceException(C.HTTP_502)),
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_503(new StorageServiceException(C.HTTP_503)),
    STORAGE_EXCEPTION_HTTP_RESPONSE_EXCEPTION_504(new StorageServiceException(C.HTTP_504)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_401(new StorageServiceException(C.JSON_401)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_403(new StorageServiceException(C.JSON_403)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_404(new StorageServiceException(C.JSON_404)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_408(new StorageServiceException(C.JSON_408)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_429(new StorageServiceException(C.JSON_429)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_500(new StorageServiceException(C.JSON_500)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_502(new StorageServiceException(C.JSON_502)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_503(new StorageServiceException(C.JSON_503)),
    STORAGE_EXCEPTION_GOOGLE_JSON_ERROR_504(new StorageServiceException(C.JSON_504)),
    STORAGE_EXCEPTION_SOCKET_TIMEOUT_EXCEPTION(new StorageServiceException(C.SOCKET_TIMEOUT_EXCEPTION)),
    STORAGE_EXCEPTION_SOCKET_EXCEPTION(new StorageServiceException(C.SOCKET_EXCEPTION)),
    STORAGE_EXCEPTION_SSL_EXCEPTION(new StorageServiceException(C.SSL_EXCEPTION)),
    STORAGE_EXCEPTION_SSL_EXCEPTION_CONNECTION_SHUTDOWN(
        new StorageServiceException(C.SSL_EXCEPTION_CONNECTION_SHUTDOWN)),
    STORAGE_EXCEPTION_SSL_HANDSHAKE_EXCEPTION(new StorageServiceException(C.SSL_HANDSHAKE_EXCEPTION)),
    STORAGE_EXCEPTION_SSL_HANDSHAKE_EXCEPTION_CAUSED_BY_CERTIFICATE_EXCEPTION(
        new StorageServiceException(C.SSL_HANDSHAKE_EXCEPTION_CERTIFICATE_EXCEPTION)),
    STORAGE_EXCEPTION_INSUFFICIENT_DATA(new StorageServiceException(C.INSUFFICIENT_DATA_WRITTEN)),
    STORAGE_EXCEPTION_ERROR_WRITING_REQUEST_BODY(
        new StorageServiceException(C.ERROR_WRITING_REQUEST_BODY)),
    ILLEGAL_ARGUMENT_EXCEPTION(C.ILLEGAL_ARGUMENT_EXCEPTION),
    STORAGE_EXCEPTION_ILLEGAL_ARGUMENT_EXCEPTION(
        StorageServiceException.coalesceException(C.ILLEGAL_ARGUMENT_EXCEPTION)),
    STORAGE_EXCEPTION_0_INTERNAL_ERROR(
        new StorageServiceException(0, "internalError", "internalError", null)),
    ...
    STORAGE_EXCEPTION_0_JACKSON_EOF_EXCEPTION(
        new StorageServiceException(0, "parse error", C.JACKSON_EOF_EXCEPTION)),
    GSON_MALFORMED_EXCEPTION(C.GSON_MALFORMED_EXCEPTION),
    STORAGE_EXCEPTION_0_GSON_MALFORMED_EXCEPTION(
        new StorageServiceException(0, "parse error", C.GSON_MALFORMED_EXCEPTION)),
