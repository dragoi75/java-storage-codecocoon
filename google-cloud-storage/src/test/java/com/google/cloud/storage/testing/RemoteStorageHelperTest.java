...
public class RemoteStorageHelperTest {
  ...
  public void testForceDelete() throws InterruptedException, ExecutionException {
    ...
    EasyMock.expect(storageMock.list(BUCKET_NAME, Storage.BlobListOptions.includeVersions(true)))
        .andReturn(blobPage);
  ...
  public void testForceDeleteRetriesWithUserProject() throws Exception {
    ...
    EasyMock.expect(
        ...
        .andReturn(blobPage);
    EasyMock.expect(
            storageMock.delete(BUCKET_NAME, Storage.BucketRequestOption.ofUserProject(USER_PROJECT)))
        .andReturn(true);
    EasyMock.replay(storageMock, blob1, blob2);
    try {
