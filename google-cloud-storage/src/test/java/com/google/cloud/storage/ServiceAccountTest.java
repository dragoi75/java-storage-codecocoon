...
public class ServiceAccountTest {
  ...
  private static final ServiceAccountInfo SERVICE_ACCOUNT = ServiceAccountInfo.ofEmail("email");

  @Test
  public void testOf() {
    compareServiceAccount(SERVICE_ACCOUNT, ServiceAccountInfo.ofEmail("email"));
  }
