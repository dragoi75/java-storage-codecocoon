...
public class ServiceAccountTest {
  ...
  private static final ServiceAccountInfo SERVICE_ACCOUNT = ServiceAccountInfo.from("email");

  @Test
  public void testOf() {
    compareServiceAccount(SERVICE_ACCOUNT, ServiceAccountInfo.from("email"));
  }
