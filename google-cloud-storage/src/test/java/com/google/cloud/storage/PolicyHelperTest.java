...
public class PolicyHelperTest {
  ...
  public void testEquivalence() {
    ...
    Policy actualLibPolicy = PolicyConverter.convertPolicyFromApi(apiPolicy);
    com.google.api.services.storage.model.Policy actualApiPolicy =
        PolicyConverter.convertPolicyToApi(libPolicy);
  ...
  public void testApiPolicyWithoutBinding() {
    ...
    PolicyConverter.convertPolicyFromApi(apiPolicy);
  }
}
