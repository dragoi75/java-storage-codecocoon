...
public class SerializationTest extends BaseSerializationTest {
  ...
  private static final BucketMetadata BUCKET_INFO = BucketMetadata.from("b");
  private static final Blob BLOB = new Blob(STORAGE, new BlobInfo.BuilderImpl(BLOB_INFO));
  private static final Bucket BUCKET = new Bucket(STORAGE, new BucketMetadata.BucketBuilderImpl(BUCKET_INFO));
