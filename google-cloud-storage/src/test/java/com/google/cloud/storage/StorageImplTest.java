...
public class StorageImplTest {
  ...
  public void testUpdateBucket() {
    BucketMetadata updatedBucketInfo = BUCKET_INFO1.newBuilder().setIndexPage("some-page").buildBucket();
    ...
    assertEquals(new Bucket(storage, new BucketMetadata.BucketBuilderImpl(updatedBucketInfo)), bucket);
  }
  ...
  public void testDeleteBucket() {
    EasyMock.expect(storageRpcMock.delete(BucketMetadata.from(BUCKET_NAME1).toBucketPb(), EMPTY_RPC_OPTIONS))
        .andReturn(true);
    EasyMock.replay(storageRpcMock);
    initializeService();
  ...
  public void testDeleteBucketWithOptions() {
    EasyMock.expect(
            storageRpcMock.delete(BucketMetadata.from(BUCKET_NAME1).toBucketPb(), BUCKET_SOURCE_OPTIONS))
        .andReturn(true);
    EasyMock.replay(storageRpcMock);
    initializeService();
  ...
  public void testV2SignUrlWithQueryParams()
    ...
    signedMessageBuilder
        ...
        .append('\n')
        // No value for Content-VersionFilterType, blank
        .append('\n')
        // Expiration line:
        .append(42L + 1209600)
        .append('\n')
  ...
  public void testBucketLifecycleRules() {
            ...
            .setLifecycleRules(
                ImmutableList.of(
                    new BucketMetadata.LifecycleRuleEntry(
                        BucketMetadata.LifecycleRuleEntry.LifecycleRuleAction.createSetStorageClassAction(
                            StorageClass.COLDLINE),
                        BucketMetadata.LifecycleRuleEntry.LifecycleRuleCondition.newLifecycleConditionBuilder()
                            .setAge(1)
    ...
    BucketMetadata.LifecycleRuleEntry lifecycleRule = bucket.getLifecycleRules().get(0);
