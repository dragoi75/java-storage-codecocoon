...
import com.google.cloud.storage.CloudStorage.BlobUploadOption;
import com.google.cloud.storage.CloudStorage.BlobWriteOptions;
...
public class StorageImplTest {
  ...
  private static final CloudStorage.BucketTargetOptions BUCKET_TARGET_METAGENERATION =
      CloudStorage.BucketTargetOptions.ifMetagenerationMatch();
  private static final CloudStorage.BucketTargetOptions BUCKET_TARGET_PREDEFINED_ACL =
      CloudStorage.BucketTargetOptions.withPredefinedAcl(CloudStorage.PredefinedAccessControlList.PRIVATE);
  private static final CloudStorage.BucketTargetOptions BUCKET_TARGET_USER_PROJECT =
  ...
  private static final BlobUploadOption BLOB_TARGET_METAGENERATION =
      BlobUploadOption.ifMetagenerationMatch();
  private static final BlobUploadOption BLOB_TARGET_DISABLE_GZIP_CONTENT =
      BlobUploadOption.disableGzipCompression();
  private static final BlobUploadOption BLOB_TARGET_NOT_EXIST = BlobUploadOption.ifNotExists();
  private static final CloudStorage.BlobUploadOption BLOB_TARGET_PREDEFINED_ACL =
      BlobUploadOption.ofPredefinedAcl(CloudStorage.PredefinedAccessControlList.PRIVATE);
  ...
  private static final CloudStorage.BlobWriteOptions BLOB_WRITE_NOT_EXIST = CloudStorage.BlobWriteOptions.ifNotExists();
  private static final CloudStorage.BlobWriteOptions BLOB_WRITE_PREDEFINED_ACL =
      CloudStorage.BlobWriteOptions.withPredefinedAcl(CloudStorage.PredefinedAccessControlList.PRIVATE);
  private static final CloudStorage.BlobWriteOptions BLOB_WRITE_MD5_HASH = CloudStorage.BlobWriteOptions.requireMd5Match();
  private static final CloudStorage.BlobWriteOptions BLOB_WRITE_CRC2C = CloudStorage.BlobWriteOptions.requireCrc32cMatch();

  // Bucket get/source options
  private static final CloudStorage.BucketSourceOptions BUCKET_SOURCE_METAGENERATION =
      CloudStorage.BucketSourceOptions.withMetagenerationMatch(BUCKET_INFO1.getMetageneration());
  ...
  private static final CloudStorage.GetBucketOption BUCKET_GET_METAGENERATION =
      CloudStorage.GetBucketOption.ifMetagenerationMatch(BUCKET_INFO1.getMetageneration());
  private static final CloudStorage.GetBucketOption BUCKET_GET_FIELDS =
      CloudStorage.GetBucketOption.getFields(CloudStorage.BucketMetadataField.LOCATION, CloudStorage.BucketMetadataField.ACL);
  private static final CloudStorage.GetBucketOption BUCKET_GET_EMPTY_FIELDS =
  ...
  private static final CloudStorage.BlobGetOptions BLOB_GET_METAGENERATION =
      CloudStorage.BlobGetOptions.ifMetagenerationMatch(BLOB_INFO1.getMetageneration());
  private static final CloudStorage.BlobGetOptions BLOB_GET_GENERATION =
      CloudStorage.BlobGetOptions.ifGenerationMatch(BLOB_INFO1.getGeneration());
  private static final CloudStorage.BlobGetOptions BLOB_GET_GENERATION_FROM_BLOB_ID =
      CloudStorage.BlobGetOptions.ifGenerationMatch();
  private static final CloudStorage.BlobGetOptions BLOB_GET_FIELDS =
      CloudStorage.BlobGetOptions.withFields(CloudStorage.BlobMetadataField.CONTENT_TYPE, CloudStorage.BlobMetadataField.CRC32C);
  private static final CloudStorage.BlobGetOptions BLOB_GET_EMPTY_FIELDS = CloudStorage.BlobGetOptions.withFields();
  ...
  private static final CloudStorage.BlobSourceOptions BLOB_SOURCE_METAGENERATION =
      CloudStorage.BlobSourceOptions.ifMetagenerationMatch(BLOB_INFO1.getMetageneration());
  private static final CloudStorage.BlobSourceOptions BLOB_SOURCE_GENERATION =
      CloudStorage.BlobSourceOptions.ifGenerationMatch(BLOB_INFO1.getGeneration());
  private static final CloudStorage.BlobSourceOptions BLOB_SOURCE_GENERATION_FROM_BLOB_ID =
      CloudStorage.BlobSourceOptions.ifGenerationMatch();
  ...
  // Bucket list options
  private static final CloudStorage.BucketListOptions BUCKET_LIST_PAGE_SIZE =
      CloudStorage.BucketListOptions.maxResults(42L);
  private static final CloudStorage.BucketListOptions BUCKET_LIST_PREFIX =
      CloudStorage.BucketListOptions.withPrefix("withPrefix");
  private static final CloudStorage.BucketListOptions BUCKET_LIST_FIELDS =
      CloudStorage.BucketListOptions.withFields(CloudStorage.BucketMetadataField.LOCATION, CloudStorage.BucketMetadataField.ACL);
  private static final CloudStorage.BucketListOptions BUCKET_LIST_EMPTY_FIELDS =
  ...
  // Blob list options
  private static final CloudStorage.BlobListOptions BLOB_LIST_PAGE_SIZE =
      CloudStorage.BlobListOptions.pageLimit(42L);
  private static final CloudStorage.BlobListOptions BLOB_LIST_PREFIX =
      CloudStorage.BlobListOptions.withPrefix("withPrefix");
  private static final CloudStorage.BlobListOptions BLOB_LIST_FIELDS =
      CloudStorage.BlobListOptions.withFields(CloudStorage.BlobMetadataField.CONTENT_TYPE, CloudStorage.BlobMetadataField.MD5HASH);
  private static final CloudStorage.BlobListOptions BLOB_LIST_VERSIONS =
      CloudStorage.BlobListOptions.includeVersions(false);
  private static final CloudStorage.BlobListOptions BLOB_LIST_EMPTY_FIELDS =
  ...
  public void testCreateBlobWithEncryptionKey() throws IOException {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    Blob blob = storage.create(BLOB_INFO1, BLOB_CONTENT, CloudStorage.BlobUploadOption.getEncryptionKey(KEY));
    assertEquals(expectedBlob1, blob);
    ByteArrayInputStream byteStream = capturedStream.getValue();
    byte[] streamBytes = new byte[BLOB_CONTENT.length];
    assertEquals(BLOB_CONTENT.length, byteStream.read(streamBytes));
    assertArrayEquals(BLOB_CONTENT, streamBytes);
    assertEquals(-1, byteStream.read(streamBytes));
    blob = storage.create(BLOB_INFO1, BLOB_CONTENT, BlobUploadOption.getEncryptionKey(BASE64_KEY));
    assertEquals(expectedBlob1, blob);
  ...
  public void testCreateBlobWithKmsKeyName() throws IOException {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    Blob blob = storage.create(BLOB_INFO1, BLOB_CONTENT, BlobUploadOption.getKmsKeyName(KMS_KEY_NAME));
    assertEquals(expectedBlob1, blob);
    ByteArrayInputStream byteStream = capturedStream.getValue();
    byte[] streamBytes = new byte[BLOB_CONTENT.length];
    assertEquals(BLOB_CONTENT.length, byteStream.read(streamBytes));
    assertArrayEquals(BLOB_CONTENT, streamBytes);
    assertEquals(-1, byteStream.read(streamBytes));
    blob = storage.create(BLOB_INFO1, BLOB_CONTENT, BlobUploadOption.getKmsKeyName(KMS_KEY_NAME));
    assertEquals(expectedBlob1, blob);
    byteStream = capturedStream.getValue();
    streamBytes = new byte[BLOB_CONTENT.length];
    assertEquals(BLOB_CONTENT.length, byteStream.read(streamBytes));
  ...
  public void testCreateBlobFromStreamWithEncryptionKey() throws IOException {
    ...
    initializeService();
    Blob blob =
        storage.create(infoWithHashes, fileStream, BlobWriteOptions.customerSuppliedKey(BASE64_KEY));
    assertEquals(expectedBlob1, blob);
    blob = storage.create(infoWithHashes, fileStream, BlobWriteOptions.customerSuppliedKey(BASE64_KEY));
    assertEquals(expectedBlob1, blob);
  }
  ...
  public void testListBlobsCurrentDirectory() {
    ...
    initializeService();
    ImmutableList<Blob> blobList = ImmutableList.of(expectedBlob1, expectedBlob2);
    Page<Blob> page = storage.list(BUCKET_NAME1, CloudStorage.BlobListOptions.currentDirectoryOnly());
    assertEquals(cursor, page.getNextPageToken());
    assertArrayEquals(blobList.toArray(), Iterables.toArray(page.getValues(), Blob.class));
  }
  ...
  public void testCopyWithEncryptionKey() {
    CopyOperationRequest request =
        CloudStorage.CopyOperationRequest.newCopyOperationBuilder()
            .setSource(BLOB_INFO2.getBlobId())
            .setSourceOptions(CloudStorage.BlobSourceOptions.withDecryptionKey(KEY))
            .setTarget(BLOB_INFO1, BlobUploadOption.getEncryptionKey(BASE64_KEY))
            .buildRequest();
    StorageRpc.RewriteRequest rpcRequest =
        new StorageRpc.RewriteRequest(
            request.getSource().toPb(),
    ...
    request =
        CloudStorage.CopyOperationRequest.newCopyOperationBuilder()
            ...
            .setTarget(BLOB_INFO1, BlobUploadOption.getEncryptionKey(KEY))
            .buildRequest();
  ...
  public void testCopyFromEncryptionKeyToKmsKeyName() {
    CopyOperationRequest request =
        CloudStorage.CopyOperationRequest.newCopyOperationBuilder()
            .setSource(BLOB_INFO2.getBlobId())
            .setSourceOptions(CloudStorage.BlobSourceOptions.withDecryptionKey(KEY))
            .setTarget(BLOB_INFO1, CloudStorage.BlobUploadOption.getKmsKeyName(KMS_KEY_NAME))
            .buildRequest();
    StorageRpc.RewriteRequest rpcRequest =
        new StorageRpc.RewriteRequest(
            request.getSource().toPb(),
    ...
    request =
        CopyOperationRequest.newCopyOperationBuilder()
            .setSource(BLOB_INFO2.getBlobId())
            .setSourceOptions(CloudStorage.BlobSourceOptions.withDecryptionKey(BASE64_KEY))
            .setTarget(BLOB_INFO1, BlobUploadOption.getKmsKeyName(KMS_KEY_NAME))
            .buildRequest();
    writer = storage.copy(request);
    assertEquals(42L, writer.getBlobSize());
    assertEquals(21L, writer.getTotalBytesCopied());
  ...
  public void testCopyMultipleRequests() {
    CopyOperationRequest request = CloudStorage.CopyOperationRequest.from(BLOB_INFO1.getBlobId(), BLOB_INFO2.getBlobId());
    StorageRpc.RewriteRequest rpcRequest =
        new StorageRpc.RewriteRequest(
            request.getSource().toPb(),
            EMPTY_RPC_OPTIONS,
  ...
  public void testReadAllBytesWithDecriptionKey() {
    ...
    initializeService();
    byte[] readBytes =
        storage.readAllBytes(BUCKET_NAME1, BLOB_NAME1, CloudStorage.BlobSourceOptions.withDecryptionKey(KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
    readBytes =
        storage.readAllBytes(BUCKET_NAME1, BLOB_NAME1, CloudStorage.BlobSourceOptions.withDecryptionKey(BASE64_KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
  }
  ...
  public void testReadAllBytesFromBlobIdWithDecriptionKey() {
    ...
    initializeService();
    byte[] readBytes =
        storage.readAllBytes(BLOB_INFO1.getBlobId(), CloudStorage.BlobSourceOptions.withDecryptionKey(KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
    readBytes =
        storage.readAllBytes(BLOB_INFO1.getBlobId(), CloudStorage.BlobSourceOptions.withDecryptionKey(BASE64_KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
  }
  ...
  public void testReaderWithDecryptionKey() throws IOException {
    ...
    initializeService();
    ReadChannel channel =
        storage.reader(BUCKET_NAME1, BLOB_NAME2, CloudStorage.BlobSourceOptions.withDecryptionKey(KEY));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
    channel.read(ByteBuffer.allocate(42));
    channel = storage.reader(BUCKET_NAME1, BLOB_NAME2, CloudStorage.BlobSourceOptions.withDecryptionKey(BASE64_KEY));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
    channel.read(ByteBuffer.allocate(42));
  }
  ...
  public void testWriterWithEncryptionKey() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    WriteChannel channel = storage.writer(info, CloudStorage.BlobWriteOptions.customerSuppliedKey(KEY));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
    channel = storage.writer(info, CloudStorage.BlobWriteOptions.customerSuppliedKey(BASE64_KEY));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
  }
  ...
  public void testWriterWithKmsKeyName() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    WriteChannel channel = storage.writer(info, CloudStorage.BlobWriteOptions.getKmsKeyName(KMS_KEY_NAME));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
    channel = storage.writer(info, BlobWriteOptions.getKmsKeyName(KMS_KEY_NAME));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
  }
  ...
  public void testSignUrlWithHostName()
    ...
    URL url =
        storage.signUrl(
            ...
            14,
            TimeUnit.DAYS,
            CloudStorage.UrlSigningOption.setHostName("https://example.com"));
    String stringUrl = url.toString();
    String expectedUrl =
  ...
  public void testSignUrlWithOptions()
    ...
    URL url =
        storage.signUrl(
            ...
            CloudStorage.UrlSigningOption.withContentTypeEnabled(),
            CloudStorage.UrlSigningOption.withMd5Enabled());
    String stringUrl = url.toString();
    String expectedUrl =
        new StringBuilder("https://storage.googleapis.com/")
            .append(BUCKET_NAME1)
  ...
  public void testSignUrlWithExtHeaders()
    ...
    URL url =
        storage.signUrl(
            ...
            14,
            TimeUnit.DAYS,
            CloudStorage.UrlSigningOption.withHttpMethod(HttpMethod.PUT),
            CloudStorage.UrlSigningOption.withContentTypeEnabled(),
            CloudStorage.UrlSigningOption.withExternalHeaders(extHeaders));
    String stringUrl = url.toString();
    String expectedUrl =
        new StringBuilder("https://storage.googleapis.com/")
            .append(BUCKET_NAME1)
