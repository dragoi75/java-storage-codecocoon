...
import com.google.cloud.storage.CloudStorageClient.BucketOption;
...
public class StorageImplTest {
  ...
  private static final BlobMetadata BLOB_INFO1 =
      BlobMetadata.newBuilder(BUCKET_NAME1, BLOB_NAME1, 24L)
          ...
          .setMd5("md5string")
          .buildMetadata();
  private static final BlobMetadata BLOB_INFO2 = BlobMetadata.newBuilder(BUCKET_NAME1, BLOB_NAME2).buildMetadata();
  private static final BlobMetadata BLOB_INFO3 = BlobMetadata.newBuilder(BUCKET_NAME1, BLOB_NAME3).buildMetadata();
  ...
  private static final CloudStorageClient.BucketTargetOptions BUCKET_TARGET_PREDEFINED_ACL =
      CloudStorageClient.BucketTargetOptions.presetAcl(CloudStorageClient.PredefinedAccessControl.PRIVATE);
  ...
  private static final BlobUploadOption BLOB_TARGET_GENERATION = CloudStorageClient.BlobUploadOption.ifGenerationMatch();
  ...
  private static final BlobUploadOption BLOB_TARGET_NOT_EXIST = CloudStorageClient.BlobUploadOption.ifNotExists();
  private static final CloudStorageClient.BlobUploadOption BLOB_TARGET_PREDEFINED_ACL =
      BlobUploadOption.presetAcl(CloudStorageClient.PredefinedAccessControl.PRIVATE);
  ...
  private static final BlobWriteOptions BLOB_WRITE_PREDEFINED_ACL =
      BlobWriteOptions.presetAcl(CloudStorageClient.PredefinedAccessControl.PRIVATE);
  private static final CloudStorageClient.BlobWriteOptions BLOB_WRITE_MD5_HASH = CloudStorageClient.BlobWriteOptions.ifMd5Match();
  private static final CloudStorageClient.BlobWriteOptions BLOB_WRITE_CRC2C = CloudStorageClient.BlobWriteOptions.ifCrc32cMatch();

  // Bucket get/source options
  private static final BucketOption BUCKET_SOURCE_METAGENERATION =
      BucketOption.ifMetagenerationMatch(BUCKET_INFO1.getMetageneration());
  ...
  private static final CloudStorageClient.BucketGetOptions BUCKET_GET_FIELDS =
      CloudStorageClient.BucketGetOptions.selectedFields(CloudStorageClient.BucketMetadataField.LOCATION, CloudStorageClient.BucketMetadataField.ACL);
  ...
  private static final CloudStorageClient.BlobReadOption BLOB_SOURCE_METAGENERATION =
      CloudStorageClient.BlobReadOption.ifMetagenerationMatch(BLOB_INFO1.getMetageneration());
  private static final CloudStorageClient.BlobReadOption BLOB_SOURCE_GENERATION =
      CloudStorageClient.BlobReadOption.ifGenerationMatch(BLOB_INFO1.getGeneration());
  private static final CloudStorageClient.BlobReadOption BLOB_SOURCE_GENERATION_FROM_BLOB_ID =
      CloudStorageClient.BlobReadOption.ifGenerationMatch();
  ...
  private static final CloudStorageClient.BucketListOptions BUCKET_LIST_FIELDS =
      CloudStorageClient.BucketListOptions.selectFields(CloudStorageClient.BucketMetadataField.LOCATION, CloudStorageClient.BucketMetadataField.ACL);
  ...
  private void initializeServiceDependentObjects() {
    expectedBlob1 = new StorageObject(storage, new BlobMetadata.BlobMetadataBuilderImpl(BLOB_INFO1));
    expectedBlob2 = new StorageObject(storage, new BlobMetadata.BlobMetadataBuilderImpl(BLOB_INFO2));
    expectedBlob3 = new StorageObject(storage, new BlobMetadata.BlobMetadataBuilderImpl(BLOB_INFO3));
  ...
  public void testUpdateBlob() {
    BlobMetadata updatedBlobInfo = BLOB_INFO1.toBuilderCopy().setContentType("some-content-type").buildMetadata();
    ...
    assertEquals(new StorageObject(storage, new BlobMetadata.BlobMetadataBuilderImpl(updatedBlobInfo)), blob);
  }
  ...
  public void testDeleteBlob() {
    EasyMock.expect(
            storageRpcMock.delete(BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME1).toProto(), EMPTY_RPC_OPTIONS))
        .andReturn(true);
    EasyMock.replay(storageRpcMock);
    initializeService();
  ...
  public void testDeleteBlobWithOptions() {
    EasyMock.expect(
            storageRpcMock.delete(BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME1).toProto(), BLOB_SOURCE_OPTIONS))
        .andReturn(true);
    EasyMock.replay(storageRpcMock);
    initializeService();
    assertTrue(
  ...
  public void testCopy() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    BlobRewriteWriter writer = storage.copy(request);
  ...
  public void testCopyWithEncryptionKey() {
    CloudStorageClient.CopyOperationRequest request =
        CloudStorageClient.CopyOperationRequest.builder()
            .setSource(BLOB_INFO2.getBlobId())
            .setSourceOptions(CloudStorageClient.BlobReadOption.withDecryptionKey(KEY))
            .setTarget(BLOB_INFO1, CloudStorageClient.BlobUploadOption.customerSuppliedKey(BASE64_KEY))
            .buildRequest();
    StorageRpcClient.ObjectRewriteRequest rpcRequest =
        new StorageRpcClient.ObjectRewriteRequest(
            request.getSource().toProto(),
    ...
    request =
        CloudStorageClient.CopyOperationRequest.builder()
            ...
            .setTarget(BLOB_INFO1, CloudStorageClient.BlobUploadOption.customerSuppliedKey(KEY))
            .buildRequest();
  ...
  public void testCopyFromEncryptionKeyToKmsKeyName() {
    CloudStorageClient.CopyOperationRequest request =
        CloudStorageClient.CopyOperationRequest.builder()
            .setSource(BLOB_INFO2.getBlobId())
            .setSourceOptions(CloudStorageClient.BlobReadOption.withDecryptionKey(KEY))
            .setTarget(BLOB_INFO1, BlobUploadOption.kmsKey(KMS_KEY_NAME))
            .buildRequest();
    StorageRpcClient.ObjectRewriteRequest rpcRequest =
        new StorageRpcClient.ObjectRewriteRequest(
            request.getSource().toProto(),
  ...
  public void testCopyMultipleRequests() {
    CopyOperationRequest request = CloudStorageClient.CopyOperationRequest.create(BLOB_INFO1.getBlobId(), BLOB_INFO2.getBlobId());
    StorageRpcClient.ObjectRewriteRequest rpcRequest =
        new StorageRpcClient.ObjectRewriteRequest(
            request.getSource().toProto(),
            EMPTY_RPC_OPTIONS,
  ...
  public void testReadAllBytes() {
    EasyMock.expect(
            storageRpcMock.load(BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME1).toProto(), EMPTY_RPC_OPTIONS))
  ...
  public void testReadAllBytesWithOptions() {
    EasyMock.expect(
            storageRpcMock.load(BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME1).toProto(), BLOB_SOURCE_OPTIONS))
        .andReturn(BLOB_CONTENT);
    EasyMock.replay(storageRpcMock);
    initializeService();
    byte[] readBytes =
  ...
  public void testReadAllBytesWithDecriptionKey() {
    EasyMock.expect(
            storageRpcMock.load(BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME1).toProto(), ENCRYPTION_KEY_OPTIONS))
        .andReturn(BLOB_CONTENT)
        .times(2);
    EasyMock.replay(storageRpcMock);
    initializeService();
    byte[] readBytes =
        storage.readAllBytes(BUCKET_NAME1, BLOB_NAME1, CloudStorageClient.BlobReadOption.withDecryptionKey(KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
    readBytes =
        storage.readAllBytes(BUCKET_NAME1, BLOB_NAME1, CloudStorageClient.BlobReadOption.withDecryptionKey(BASE64_KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
  }
  ...
  public void testReadAllBytesFromBlobIdWithDecriptionKey() {
    ...
    initializeService();
    byte[] readBytes =
        storage.readAllBytes(BLOB_INFO1.getBlobId(), CloudStorageClient.BlobReadOption.withDecryptionKey(KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
    readBytes =
        storage.readAllBytes(BLOB_INFO1.getBlobId(), CloudStorageClient.BlobReadOption.withDecryptionKey(BASE64_KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
  }
  ...
  public void testSignUrlLeadingSlash()
    ...
    storage = options.toBuilder().setCredentials(credentials).build().getService();
    URL url =
        storage.signUrl(BlobMetadata.newBuilder(BUCKET_NAME1, blobName).buildMetadata(), 14, TimeUnit.DAYS);
  ...
  public void testSignUrlLeadingSlashWithHostName()
    ...
    URL url =
        storage.signUrl(
            BlobMetadata.newBuilder(BUCKET_NAME1, blobName).buildMetadata(),
            14,
            TimeUnit.DAYS,
            CloudStorageClient.UrlSigningOption.setHostName("https://example.com"));
  ...
  public void testSignUrlWithOptions()
    ...
    URL url =
        storage.signUrl(
            ...
            CloudStorageClient.UrlSigningOption.includeContentType(),
            CloudStorageClient.UrlSigningOption.includeMd5());
    String stringUrl = url.toString();
    String expectedUrl =
        new StringBuilder("https://storage.googleapis.com/")
            .append(BUCKET_NAME1)
  ...
  public void testSignUrlWithExtHeaders()
    ...
    URL url =
        storage.signUrl(
            ...
            CloudStorageClient.UrlSigningOption.includeContentType(),
            CloudStorageClient.UrlSigningOption.includeExtHeaders(extHeaders));
    String stringUrl = url.toString();
    String expectedUrl =
        new StringBuilder("https://storage.googleapis.com/")
            .append(BUCKET_NAME1)
  ...
  public void testGetAllArray() {
    BlobIdentifier blobId1 = BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME1);
    BlobIdentifier blobId2 = BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME2);
    ...
    assertEquals(new StorageObject(storage, new BlobMetadata.BlobMetadataBuilderImpl(BLOB_INFO1)), resultBlobs.get(0));
  ...
  public void testGetBucketAcl() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    AccessControlEntry acl = storage.getAcl(BUCKET_NAME1, UserIdentity.allAuthenticatedUsers());
  ...
  public void testGetDefaultBucketAcl() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    AccessControlEntry acl = storage.getDefaultAcl(BUCKET_NAME1, UserIdentity.allAuthenticatedUsers());
    assertEquals(ACL, acl);
  }
  ...
  public void testGetDefaultBucketAclNull() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    assertNull(storage.getDefaultAcl(BUCKET_NAME1, UserIdentity.allAuthenticatedUsers()));
  }
  ...
  public void testDeleteDefaultBucketAcl() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    assertTrue(storage.deleteDefaultAcl(BUCKET_NAME1, UserIdentity.allAuthenticatedUsers()));
  }
  ...
  public void testGetBlobAcl() {
    BlobIdentifier blobId = BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME1, 42L);
  ...
  public void testRetryableException() {
    BlobIdentifier blob = BlobIdentifier.from(BUCKET_NAME1, BLOB_NAME1);
  ...
  public void testV4PostPolicy() {
    ...
    S3PostPolicyV4.PostFieldsMapV4 fields =
        S3PostPolicyV4.PostFieldsMapV4.createBuilder().setAcl("public-read").buildMap();
    S3PostPolicyV4.PostConditionsVersion4 conditions =
        S3PostPolicyV4.PostConditionsVersion4.createBuilder()
            .addContentType(S3PostPolicyV4.ConditionV4Kind.MATCHES, "image/jpeg")
            .buildConditions();

    // test fields and conditions
    S3PostPolicyV4 policy =
        storage.generateSignedPostPolicyV4(
            BlobMetadata.newBuilder("my-bucket", "my-object").buildMetadata(),
            7,
            TimeUnit.DAYS,
            fields,
            conditions);
    ...
    policy =
        storage.generateSignedPostPolicyV4(
            BlobMetadata.newBuilder("my-bucket", "my-object").buildMetadata(), 7, TimeUnit.DAYS, conditions);
    ...
    policy =
        storage.generateSignedPostPolicyV4(
            BlobMetadata.newBuilder("my-bucket", "my-object").buildMetadata(), 7, TimeUnit.DAYS, fields);
    outputFields = policy.getFields();
    assertTrue(outputFields.containsKey("x-goog-date"));
    assertTrue(outputFields.containsKey("x-goog-credential"));
    assertTrue(outputFields.containsKey("x-goog-signature"));
    ...
    policy =
        storage.generateSignedPostPolicyV4(
            BlobMetadata.newBuilder("my-bucket", "my-object").buildMetadata(), 7, TimeUnit.DAYS);
    outputFields = policy.getFields();
    assertTrue(outputFields.containsKey("x-goog-date"));
    assertTrue(outputFields.containsKey("x-goog-credential"));
    assertTrue(outputFields.containsKey("x-goog-signature"));
            ...
            .setLifecycleRules(
                ImmutableList.of(
                    new BucketInfo.LifecycleRuleDefinition(
                        BucketInfo.LifecycleRuleDefinition.AbstractLifecycleAction.newUpdateStorageClassAction(
                            StorageClassType.COLDLINE),
