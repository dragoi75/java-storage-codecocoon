...
import com.google.cloud.storage.StorageClient.BucketSourceOptions;
import com.google.cloud.storage.StorageClient.CopyOperationRequest;
...
public class StorageImplTest {
  ...
  private static final BlobMetadata BLOB_INFO1 =
      BlobMetadata.newBuilder(BUCKET_NAME1, BLOB_NAME1, 24L)
          ...
          .setMd5("md5string")
          .buildStorageObject();
  private static final BlobMetadata BLOB_INFO2 = BlobMetadata.newBuilder(BUCKET_NAME1, BLOB_NAME2).buildStorageObject();
  private static final BlobMetadata BLOB_INFO3 = BlobMetadata.newBuilder(BUCKET_NAME1, BLOB_NAME3).buildStorageObject();
  ...
  private static final StorageClient.BucketTargetRequestOption BUCKET_TARGET_METAGENERATION =
      StorageClient.BucketTargetRequestOption.ifMetagenerationMatch();
  private static final StorageClient.BucketTargetRequestOption BUCKET_TARGET_PREDEFINED_ACL =
      StorageClient.BucketTargetRequestOption.withPredefinedAcl(StorageClient.PredefinedAccessControlList.PRIVATE);
  private static final StorageClient.BucketTargetRequestOption BUCKET_TARGET_USER_PROJECT =
      StorageClient.BucketTargetRequestOption.withUserProject(USER_PROJECT);
  private static final Map<CloudStorageRpc.StorageOption, ?> BUCKET_TARGET_OPTIONS =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH, BUCKET_INFO1.getMetageneration(),
          CloudStorageRpc.StorageOption.PREDEFINED_ACL, BUCKET_TARGET_PREDEFINED_ACL.getValue());
  private static final Map<CloudStorageRpc.StorageOption, ?> BUCKET_TARGET_OPTIONS_LOCK_RETENTION_POLICY =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH,
          BUCKET_INFO3.getMetageneration(),
          CloudStorageRpc.StorageOption.USER_PROJECT,
          USER_PROJECT);

  // Blob target options (create, update, compose)
  private static final BlobUploadOption BLOB_TARGET_GENERATION = BlobUploadOption.ifGenerationMatch();
  ...
  private static final StorageClient.BlobUploadOption BLOB_TARGET_NOT_EXIST = BlobUploadOption.ifDoesNotExist();
  ...
  private static final Map<CloudStorageRpc.StorageOption, ?> BLOB_TARGET_OPTIONS_CREATE =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH, BLOB_INFO1.getMetageneration(),
          CloudStorageRpc.StorageOption.IF_GENERATION_MATCH, 0L,
          CloudStorageRpc.StorageOption.PREDEFINED_ACL, BUCKET_TARGET_PREDEFINED_ACL.getValue());
  private static final Map<CloudStorageRpc.StorageOption, ?> BLOB_TARGET_OPTIONS_CREATE_DISABLE_GZIP_CONTENT =
      ImmutableMap.of(CloudStorageRpc.StorageOption.IF_DISABLE_GZIP_CONTENT, true);
  private static final Map<CloudStorageRpc.StorageOption, ?> BLOB_TARGET_OPTIONS_UPDATE =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH, BLOB_INFO1.getMetageneration(),
          CloudStorageRpc.StorageOption.PREDEFINED_ACL, BUCKET_TARGET_PREDEFINED_ACL.getValue());
  private static final Map<CloudStorageRpc.StorageOption, ?> BLOB_TARGET_OPTIONS_COMPOSE =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_GENERATION_MATCH, BLOB_INFO1.getGeneration(),
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH, BLOB_INFO1.getMetageneration());

  // Blob write options (create, writer)
  private static final StorageClient.BlobWriteSetting BLOB_WRITE_METAGENERATION =
      StorageClient.BlobWriteSetting.ifMetagenerationMatch();
  private static final StorageClient.BlobWriteSetting BLOB_WRITE_NOT_EXIST = StorageClient.BlobWriteSetting.ifDoesNotExist();
  private static final StorageClient.BlobWriteSetting BLOB_WRITE_PREDEFINED_ACL =
      BlobWriteSetting.withPredefinedAcl(StorageClient.PredefinedAccessControlList.PRIVATE);
  private static final StorageClient.BlobWriteSetting BLOB_WRITE_MD5_HASH = StorageClient.BlobWriteSetting.md5Equals();
  private static final StorageClient.BlobWriteSetting BLOB_WRITE_CRC2C = StorageClient.BlobWriteSetting.crc32cEquals();

  // Bucket get/source options
  private static final StorageClient.BucketSourceOptions BUCKET_SOURCE_METAGENERATION =
      BucketSourceOptions.withMetagenerationMatch(BUCKET_INFO1.getMetageneration());
  private static final Map<CloudStorageRpc.StorageOption, ?> BUCKET_SOURCE_OPTIONS =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH, BUCKET_SOURCE_METAGENERATION.getValue());
  ...
  private static final StorageClient.BucketGetOptions BUCKET_GET_FIELDS =
      StorageClient.BucketGetOptions.withFields(StorageClient.BucketMetadataField.LOCATION, StorageClient.BucketMetadataField.ACL);
  private static final StorageClient.BucketGetOptions BUCKET_GET_EMPTY_FIELDS =
      StorageClient.BucketGetOptions.withFields();
  private static final Map<CloudStorageRpc.StorageOption, ?> BUCKET_GET_OPTIONS =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH, BUCKET_SOURCE_METAGENERATION.getValue());
  ...
  private static final StorageClient.BlobGetOptions BLOB_GET_FIELDS =
      StorageClient.BlobGetOptions.fieldsSelector(StorageClient.BlobMetadataField.CONTENT_TYPE, StorageClient.BlobMetadataField.CRC32C);
  private static final StorageClient.BlobGetOptions BLOB_GET_EMPTY_FIELDS = StorageClient.BlobGetOptions.fieldsSelector();
  private static final Map<CloudStorageRpc.StorageOption, ?> BLOB_GET_OPTIONS =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH, BLOB_GET_METAGENERATION.getValue(),
          CloudStorageRpc.StorageOption.IF_GENERATION_MATCH, BLOB_GET_GENERATION.getValue());
  private static final BlobSourceOptions BLOB_SOURCE_METAGENERATION =
      BlobSourceOptions.ifMetagenerationMatch(BLOB_INFO1.getMetageneration());
  ...
  private static final Map<CloudStorageRpc.StorageOption, ?> BLOB_SOURCE_OPTIONS =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_METAGENERATION_MATCH, BLOB_SOURCE_METAGENERATION.getValue(),
          CloudStorageRpc.StorageOption.IF_GENERATION_MATCH, BLOB_SOURCE_GENERATION.getValue());
  private static final Map<CloudStorageRpc.StorageOption, ?> BLOB_SOURCE_OPTIONS_COPY =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.IF_SOURCE_METAGENERATION_MATCH, BLOB_SOURCE_METAGENERATION.getValue(),
          CloudStorageRpc.StorageOption.IF_SOURCE_GENERATION_MATCH, BLOB_SOURCE_GENERATION.getValue());
  ...
  private static final StorageClient.BucketListOptions BUCKET_LIST_PREFIX =
      StorageClient.BucketListOptions.namePrefix("prefix");
  private static final StorageClient.BucketListOptions BUCKET_LIST_FIELDS =
      StorageClient.BucketListOptions.fieldsSelector(StorageClient.BucketMetadataField.LOCATION, StorageClient.BucketMetadataField.ACL);
  ...
  private static final Map<CloudStorageRpc.StorageOption, ?> BUCKET_LIST_OPTIONS =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.MAX_RESULTS, BUCKET_LIST_PAGE_SIZE.getValue(),
          CloudStorageRpc.StorageOption.PREFIX, BUCKET_LIST_PREFIX.getValue());
  ...
  private static final StorageClient.BlobListOptions BLOB_LIST_PREFIX =
      StorageClient.BlobListOptions.namePrefix("prefix");
  private static final StorageClient.BlobListOptions BLOB_LIST_FIELDS =
      StorageClient.BlobListOptions.selectFields(StorageClient.BlobMetadataField.CONTENT_TYPE, StorageClient.BlobMetadataField.MD5HASH);
  ...
  private static final Map<CloudStorageRpc.StorageOption, ?> BLOB_LIST_OPTIONS =
      ImmutableMap.of(
          CloudStorageRpc.StorageOption.MAX_RESULTS, BLOB_LIST_PAGE_SIZE.getValue(),
          CloudStorageRpc.StorageOption.PREFIX, BLOB_LIST_PREFIX.getValue(),
          CloudStorageRpc.StorageOption.VERSIONS, BLOB_LIST_VERSIONS.getValue());
  ...
  private static final AccessControlEntry OTHER_ACL = AccessControlEntry.create(new AccessControlEntry.ProjectEntity(AccessControlEntry.ProjectEntity.ProjectMemberRole.OWNERS, "p"), AccessRole.READER);

  // Customer supplied encryption key options
  private static final Map<CloudStorageRpc.StorageOption, ?> ENCRYPTION_KEY_OPTIONS =
      ImmutableMap.of(CloudStorageRpc.StorageOption.CUSTOMER_SUPPLIED_KEY, BASE64_KEY);

  // Customer managed encryption key options
  private static final Map<CloudStorageRpc.StorageOption, ?> KMS_KEY_NAME_OPTIONS =
      ImmutableMap.of(CloudStorageRpc.StorageOption.KMS_KEY_NAME, KMS_KEY_NAME);
  // IAM policies
  ...
  public void testCreateBlob() throws IOException {
    ...
    StorageBlob blob = storage.create(BLOB_INFO1, BLOB_CONTENT);
  ...
  public void testCreateBlobWithSubArrayFromByteArray() throws IOException {
    ...
    StorageBlob blob = storage.create(BLOB_INFO1, BLOB_CONTENT, 1, 2);
  ...
  public void testCreateBlobRetry() throws IOException {
    ...
    StorageObject storageObject =
        BLOB_INFO1.toBlobInfoBuilder().setMd5(CONTENT_MD5).setCrc32c(CONTENT_CRC32C).buildStorageObject().toProto();
  ...
  public void testCreateEmptyBlob() throws IOException {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    StorageBlob blob = storage.create(BLOB_INFO1);
    assertEquals(expectedBlob1, blob);
    ByteArrayInputStream byteStream = capturedStream.getValue();
    byte[] streamBytes = new byte[BLOB_CONTENT.length];
    assertEquals(-1, byteStream.read(streamBytes));
  ...
  public void testCreateBlobWithDisabledGzipContent() throws IOException {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    StorageBlob blob = storage.create(BLOB_INFO1, BLOB_CONTENT, BLOB_TARGET_DISABLE_GZIP_CONTENT);
    assertEquals(expectedBlob1, blob);
    ByteArrayInputStream byteStream = capturedStream.getValue();
    byte[] streamBytes = new byte[BLOB_CONTENT.length];
    assertEquals(BLOB_CONTENT.length, byteStream.read(streamBytes));
  ...
  public void testCreateBlobWithEncryptionKey() throws IOException {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    StorageBlob blob = storage.create(BLOB_INFO1, BLOB_CONTENT, BlobUploadOption.withEncryptionKey(KEY));
    assertEquals(expectedBlob1, blob);
    ByteArrayInputStream byteStream = capturedStream.getValue();
    byte[] streamBytes = new byte[BLOB_CONTENT.length];
    assertEquals(BLOB_CONTENT.length, byteStream.read(streamBytes));
    assertArrayEquals(BLOB_CONTENT, streamBytes);
    assertEquals(-1, byteStream.read(streamBytes));
    blob = storage.create(BLOB_INFO1, BLOB_CONTENT, StorageClient.BlobUploadOption.withEncryptionKey(BASE64_KEY));
    assertEquals(expectedBlob1, blob);
  ...
  public void testCreateBlobWithKmsKeyName() throws IOException {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    StorageBlob blob = storage.create(BLOB_INFO1, BLOB_CONTENT, StorageClient.BlobUploadOption.withKmsKeyName(KMS_KEY_NAME));
    assertEquals(expectedBlob1, blob);
    ByteArrayInputStream byteStream = capturedStream.getValue();
    byte[] streamBytes = new byte[BLOB_CONTENT.length];
    assertEquals(BLOB_CONTENT.length, byteStream.read(streamBytes));
    assertArrayEquals(BLOB_CONTENT, streamBytes);
    assertEquals(-1, byteStream.read(streamBytes));
    blob = storage.create(BLOB_INFO1, BLOB_CONTENT, BlobUploadOption.withKmsKeyName(KMS_KEY_NAME));
    assertEquals(expectedBlob1, blob);
    byteStream = capturedStream.getValue();
    streamBytes = new byte[BLOB_CONTENT.length];
    assertEquals(BLOB_CONTENT.length, byteStream.read(streamBytes));
  ...
  public void testCreateBlobFromStream() throws IOException {
    ...
    BlobMetadata.StorageObjectBuilder infoBuilder = BLOB_INFO1.toBlobInfoBuilder();
    BlobMetadata infoWithHashes = infoBuilder.setMd5(CONTENT_MD5).setCrc32c(CONTENT_CRC32C).buildStorageObject();
    BlobMetadata infoWithoutHashes = infoBuilder.setMd5(null).setCrc32c(null).buildStorageObject();
    EasyMock.expect(
            storageRpcMock.create(
    ...
    StorageBlob blob = storage.create(infoWithHashes, fileStream);
  ...
  public void testCreateBlobFromStreamDisableGzipContent() throws IOException {
    ...
    StorageBlob blob = storage.create(infoWithHashes, fileStream, StorageClient.BlobWriteSetting.disableGzip());
  ...
  public void testCreateBlobFromStreamWithEncryptionKey() throws IOException {
    ...
    initializeService();
    StorageBlob blob =
        storage.create(infoWithHashes, fileStream, StorageClient.BlobWriteSetting.customerSuppliedKey(BASE64_KEY));
    assertEquals(expectedBlob1, blob);
    blob = storage.create(infoWithHashes, fileStream, BlobWriteSetting.customerSuppliedKey(BASE64_KEY));
    assertEquals(expectedBlob1, blob);
  }
  ...
  public void testGetBucket() {
    EasyMock.expect(storageRpcMock.get(BucketMetadata.ofName(BUCKET_NAME1).toProto(), EMPTY_RPC_OPTIONS))
        .andReturn(BUCKET_INFO1.toProto());
    EasyMock.replay(storageRpcMock);
    initializeService();
  ...
  public void testGetBucketWithOptions() {
    EasyMock.expect(storageRpcMock.get(BucketMetadata.ofName(BUCKET_NAME1).toProto(), BUCKET_GET_OPTIONS))
        .andReturn(BUCKET_INFO1.toProto());
    EasyMock.replay(storageRpcMock);
    initializeService();
  ...
  public void testGetBucketWithSelectedFields() {
    ...
    EasyMock.expect(
            storageRpcMock.get(
                EasyMock.eq(BucketMetadata.ofName(BUCKET_NAME1).toProto()), EasyMock.capture(capturedOptions)))
        .andReturn(BUCKET_INFO1.toProto());
    EasyMock.replay(storageRpcMock);
    initializeService();
  ...
  public void testGetBlob() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    StorageBlob blob = storage.get(BUCKET_NAME1, BLOB_NAME1);
    assertEquals(expectedBlob1, blob);
  }
  ...
  public void testGetBlobWithOptions() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    StorageBlob blob = storage.get(BUCKET_NAME1, BLOB_NAME1, BLOB_GET_METAGENERATION, BLOB_GET_GENERATION);
    assertEquals(expectedBlob1, blob);
  }
  ...
  public void testListBuckets() {
    ...
    Tuple<String, Iterable<com.google.api.services.storage.model.Bucket>> result =
        Tuple.of(cursor, Iterables.transform(bucketInfoList, BucketMetadata.TO_PROTO_FUNCTION));
  ...
  public void testListBlobs() {
    ...
    Tuple<String, Iterable<com.google.api.services.storage.model.StorageObject>> result =
        Tuple.of(cursor, Iterables.transform(blobInfoList, BlobMetadata.INFO_TO_PB_MAPPER));
    EasyMock.expect(storageRpcMock.list(BUCKET_NAME1, EMPTY_RPC_OPTIONS)).andReturn(result);
    EasyMock.replay(storageRpcMock);
    initializeService();
    ImmutableList<StorageBlob> blobList = ImmutableList.of(expectedBlob1, expectedBlob2);
    Page<StorageBlob> page = storage.list(BUCKET_NAME1);
    assertEquals(cursor, page.getNextPageToken());
    assertArrayEquals(blobList.toArray(), Iterables.toArray(page.getValues(), StorageBlob.class));
  }
  ...
  public void testListBlobsEmpty() {
    ...
    assertNull(page.getNextPageToken());
    assertArrayEquals(
        ImmutableList.of().toArray(), Iterables.toArray(page.getValues(), StorageBlob.class));
  }
  ...
  public void testListBlobsCurrentDirectory() {
    String cursor = "cursor";
    Map<CloudStorageRpc.StorageOption, ?> options = ImmutableMap.of(CloudStorageRpc.StorageOption.DELIMITER, "/");
    ImmutableList<BlobMetadata> blobInfoList = ImmutableList.of(BLOB_INFO1, BLOB_INFO2);
    Tuple<String, Iterable<com.google.api.services.storage.model.StorageObject>> result =
        Tuple.of(cursor, Iterables.transform(blobInfoList, BlobMetadata.INFO_TO_PB_MAPPER));
    ...
    initializeService();
    ImmutableList<StorageBlob> blobList = ImmutableList.of(expectedBlob1, expectedBlob2);
    Page<StorageBlob> page = storage.list(BUCKET_NAME1, StorageClient.BlobListOptions.currentDir());
    assertEquals(cursor, page.getNextPageToken());
    assertArrayEquals(blobList.toArray(), Iterables.toArray(page.getValues(), StorageBlob.class));
  }
  ...
  public void testListBlobsDelimiter() {
    String cursor = "cursor";
    String delimiter = "/";
    Map<CloudStorageRpc.StorageOption, ?> options = ImmutableMap.of(CloudStorageRpc.StorageOption.DELIMITER, delimiter);
    ImmutableList<BlobMetadata> blobInfoList = ImmutableList.of(BLOB_INFO1, BLOB_INFO2);
    Tuple<String, Iterable<com.google.api.services.storage.model.StorageObject>> result =
        Tuple.of(cursor, Iterables.transform(blobInfoList, BlobMetadata.INFO_TO_PB_MAPPER));
    EasyMock.expect(storageRpcMock.list(BUCKET_NAME1, options)).andReturn(result);
    ...
    initializeService();
    ImmutableList<StorageBlob> blobList = ImmutableList.of(expectedBlob1, expectedBlob2);
    Page<StorageBlob> page = storage.list(BUCKET_NAME1, StorageClient.BlobListOptions.withDelimiter(delimiter));
    assertEquals(cursor, page.getNextPageToken());
    assertArrayEquals(blobList.toArray(), Iterables.toArray(page.getValues(), StorageBlob.class));
  }
  ...
  public void testUpdateBlob() {
    BlobMetadata updatedBlobInfo = BLOB_INFO1.toBlobInfoBuilder().setContentType("some-content-type").buildStorageObject();
  ...
  public void testCopy() {
    StorageClient.CopyOperationRequest request = CopyOperationRequest.create(BLOB_INFO1.getBlobId(), BLOB_INFO2.getBlobId());
    CloudStorageRpc.RewriteOperationRequest rpcRequest =
        new CloudStorageRpc.RewriteOperationRequest(
            ...
            EMPTY_RPC_OPTIONS,
            null);
    CloudStorageRpc.RewriteOperationResponse rpcResponse =
        new CloudStorageRpc.RewriteOperationResponse(rpcRequest, null, 42L, false, "token", 21L);
  ...
  public void testCopyWithEncryptionKey() {
    CopyOperationRequest request =
        StorageClient.CopyOperationRequest.newCopyOperationBuilder()
            .setSource(BLOB_INFO2.getBlobId())
            .setSourceOptions(BlobSourceOptions.decryptionKeyBase64(KEY))
    ...
    request =
        CopyOperationRequest.newCopyOperationBuilder()
            .setSource(BLOB_INFO2.getBlobId())
            .setSourceOptions(BlobSourceOptions.decryptionKeyBase64(BASE64_KEY))
            .setTarget(BLOB_INFO1, StorageClient.BlobUploadOption.withEncryptionKey(KEY))
            .buildCopyOperation();
  ...
  public void testCopyMultipleRequests() {
    StorageClient.CopyOperationRequest request = StorageClient.CopyOperationRequest.create(BLOB_INFO1.getBlobId(), BLOB_INFO2.getBlobId());
    CloudStorageRpc.RewriteOperationRequest rpcRequest =
        new CloudStorageRpc.RewriteOperationRequest(
            request.getSource().toProto(),
            EMPTY_RPC_OPTIONS,
            ...
            EMPTY_RPC_OPTIONS,
            null);
    CloudStorageRpc.RewriteOperationResponse rpcResponse1 =
        new CloudStorageRpc.RewriteOperationResponse(rpcRequest, null, 42L, false, "token", 21L);
    CloudStorageRpc.RewriteOperationResponse rpcResponse2 =
        new CloudStorageRpc.RewriteOperationResponse(rpcRequest, BLOB_INFO1.toProto(), 42L, true, "token", 42L);
  ...
  public void testReadAllBytesWithDecriptionKey() {
    ...
    initializeService();
    byte[] readBytes =
        storage.readAllBytes(BUCKET_NAME1, BLOB_NAME1, StorageClient.BlobSourceOptions.decryptionKeyBase64(KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
    readBytes =
        storage.readAllBytes(BUCKET_NAME1, BLOB_NAME1, StorageClient.BlobSourceOptions.decryptionKeyBase64(BASE64_KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
  }
  ...
  public void testReadAllBytesFromBlobIdWithDecriptionKey() {
    ...
    initializeService();
    byte[] readBytes =
        storage.readAllBytes(BLOB_INFO1.getBlobId(), BlobSourceOptions.decryptionKeyBase64(KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
    readBytes =
        storage.readAllBytes(BLOB_INFO1.getBlobId(), BlobSourceOptions.decryptionKeyBase64(BASE64_KEY));
    assertArrayEquals(BLOB_CONTENT, readBytes);
  }
  ...
  public void testReaderWithDecryptionKey() throws IOException {
    ...
    initializeService();
    ReadChannel channel =
        storage.reader(BUCKET_NAME1, BLOB_NAME2, StorageClient.BlobSourceOptions.decryptionKeyBase64(KEY));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
    channel.read(ByteBuffer.allocate(42));
    channel = storage.reader(BUCKET_NAME1, BLOB_NAME2, BlobSourceOptions.decryptionKeyBase64(BASE64_KEY));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
    channel.read(ByteBuffer.allocate(42));
  }
  ...
  public void testWriterWithOptions() {
    BlobMetadata info = BLOB_INFO1.toBlobInfoBuilder().setMd5(CONTENT_MD5).setCrc32c(CONTENT_CRC32C).buildStorageObject();
  ...
  public void testWriterWithEncryptionKey() {
    BlobMetadata info = BLOB_INFO1.toBlobInfoBuilder().setMd5(null).setCrc32c(null).buildStorageObject();
    EasyMock.expect(storageRpcMock.open(info.toProto(), ENCRYPTION_KEY_OPTIONS))
        .andReturn("upload-id")
        .times(2);
    EasyMock.replay(storageRpcMock);
    initializeService();
    WriteChannel channel = storage.writer(info, StorageClient.BlobWriteSetting.customerSuppliedKey(KEY));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
    channel = storage.writer(info, StorageClient.BlobWriteSetting.customerSuppliedKey(BASE64_KEY));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
  }
  ...
  public void testWriterWithKmsKeyName() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    WriteChannel channel = storage.writer(info, StorageClient.BlobWriteSetting.kmsKey(KMS_KEY_NAME));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
    channel = storage.writer(info, BlobWriteSetting.kmsKey(KMS_KEY_NAME));
    assertNotNull(channel);
    assertTrue(channel.isOpen());
  }
  ...
  public void testSignUrlLeadingSlash()
    ...
    storage = options.toBuilder().setCredentials(credentials).build().getService();
    URL url =
        storage.signUrl(BlobMetadata.newBuilder(BUCKET_NAME1, blobName).buildStorageObject(), 14, TimeUnit.DAYS);
  ...
  public void testSignUrlLeadingSlashWithHostName()
    ...
    URL url =
        storage.signUrl(
            BlobMetadata.newBuilder(BUCKET_NAME1, blobName).buildStorageObject(),
            14,
            TimeUnit.DAYS,
            StorageClient.UrlSigningOption.setHostName("https://example.com"));
  ...
  public void testSignUrlWithOptions()
    ...
    URL url =
        storage.signUrl(
            ...
            14,
            TimeUnit.DAYS,
            StorageClient.UrlSigningOption.setHttpMethod(HttpRequestMethod.POST),
  ...
  public void testSignUrlWithExtHeaders()
    ...
    URL url =
        storage.signUrl(
            ...
            14,
            TimeUnit.DAYS,
            StorageClient.UrlSigningOption.setHttpMethod(HttpRequestMethod.PUT),
            StorageClient.UrlSigningOption.includeContentType(),
  ...
  public void testGetAllArray() {
    ...
    Capture<RpcRequestBatch.ResultHandler<StorageObject>> callback1 = Capture.newInstance();
    Capture<RpcRequestBatch.ResultHandler<StorageObject>> callback2 = Capture.newInstance();
  ...
  public void testDeleteAllArray() {
    ...
    BlobIdentifier blobId2 = BlobIdentifier.create(BUCKET_NAME1, BLOB_NAME2);
    RpcRequestBatch batchMock = EasyMock.createMock(RpcRequestBatch.class);
    Capture<RpcRequestBatch.ResultHandler<Void>> callback1 = Capture.newInstance();
    Capture<RpcRequestBatch.ResultHandler<Void>> callback2 = Capture.newInstance();
  ...
  public void testGetBucketAcl() {
    EasyMock.expect(
            storageRpcMock.getAcl(
                BUCKET_NAME1, "allAuthenticatedUsers", new HashMap<CloudStorageRpc.StorageOption, Object>()))
        .andReturn(ACL.toBucketProto());
    EasyMock.replay(storageRpcMock);
    initializeService();
    AccessControlEntry acl = storage.getAcl(BUCKET_NAME1, AccessControlEntry.UserPrincipal.allAuthenticatedUsers());
  ...
  public void testCreateBucketAcl() {
    ...
    EasyMock.expect(
            storageRpcMock.createAcl(
                ACL.toBucketProto().setBucket(BUCKET_NAME1), new HashMap<CloudStorageRpc.StorageOption, Object>()))
  ...
  public void testListBucketAcl() {
    EasyMock.expect(storageRpcMock.listAcls(BUCKET_NAME1, new HashMap<CloudStorageRpc.StorageOption, Object>()))
  ...
  public void testDeleteDefaultBucketAcl() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    assertTrue(storage.deleteDefaultAcl(BUCKET_NAME1, AccessControlEntry.UserPrincipal.allAuthenticatedUsers()));
  }
  ...
  public void testGetBlobAcl() {
    ...
    EasyMock.replay(storageRpcMock);
    initializeService();
    AccessControlEntry acl = storage.getAcl(blobId, AccessControlEntry.UserPrincipal.allAuthenticatedUsers());
    assertEquals(ACL, acl);
  }
