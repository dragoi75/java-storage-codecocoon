...
public class BlobInfoTest {
  ...
  private static final List<AccessControlEntry> ACL =
      ImmutableList.of(
          AccessControlEntry.create(UserPrincipal.allAuthenticatedUsers(), READER),
  ...
  private void compareCustomerEncryptions(BlobMetadata.CustomerEncryptionSettings expected, BlobMetadata.CustomerEncryptionSettings value) {
    assertEquals(expected, value);
  ...
  public void testToPbAndFromPb() {
    compareCustomerEncryptions(
        CUSTOMER_ENCRYPTION, BlobMetadata.CustomerEncryptionSettings.fromProto(CUSTOMER_ENCRYPTION.toProto()));
