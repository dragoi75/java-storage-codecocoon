...
public class BlobInfoTest {
  ...
  public void testToBuilderSetMd5FromHexStringLeadingZeros() {
    BlobMetadata blobInfo =
        BlobMetadata.newBuilder(BlobIdentifier.create("b2", "n2"))
  ...
  private void compareCustomerEncryptions(CustomerEncryptionInfo expected, CustomerEncryptionInfo value) {
    assertEquals(expected, value);
