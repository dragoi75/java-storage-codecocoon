...
import static com.google.cloud.storage.Storage.PredefinedAclEntry.PUBLIC_READ;
...
public class CopyRequestTest {
  ...
  public void testCopyRequest() {
    ...
    assertEquals(
        Storage.BlobUploadOption.withPredefinedAcl(PUBLIC_READ), copyRequest1.getTargetOptions().get(0));
    ...
    Storage.CopyOperationRequest copyRequest3 =
        Storage.CopyOperationRequest.newCopyOperationBuilder()
            .setSource(SOURCE_BLOB_ID)
            .setTarget(
                TARGET_BLOB_INFO, ImmutableList.of(Storage.BlobUploadOption.withPredefinedAcl(PUBLIC_READ)))
            .buildCopyOperationRequest();
    ...
    assertEquals(
        ImmutableList.of(Storage.BlobUploadOption.withPredefinedAcl(PUBLIC_READ)),
  ...
  public void testCopyRequestOf() {
    ...
    Storage.CopyOperationRequest copyRequest5 = Storage.CopyOperationRequest.copyOf(SOURCE_BLOB_ID, TARGET_BLOB_ID);
