  ...
  public void testCopyRequest() {
    Storage.CopyOperationRequest copyRequest1 =
        Storage.CopyOperationRequest.builder()
            ...
            .setSourceOptions(Storage.BlobReadOption.ifGenerationMatch(1))
    ...
    assertEquals(Storage.BlobReadOption.ifGenerationMatch(1), copyRequest1.getSourceOptions().get(0));
