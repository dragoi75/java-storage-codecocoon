  ...
  public void testCopyRequest() {
    Storage.CopyOperationRequest copyRequest1 =
        Storage.CopyOperationRequest.newCopyJobBuilder()
            ...
            .setTarget(TARGET_BLOB_INFO, Storage.BlobTargetOptions.withPredefinedAcl(PUBLIC_READ))
    ...
    assertEquals(
        Storage.BlobTargetOptions.withPredefinedAcl(PUBLIC_READ), copyRequest1.getTargetOptions().get(0));
    ...
    Storage.CopyOperationRequest copyRequest3 =
        Storage.CopyOperationRequest.newCopyJobBuilder()
            .setSource(SOURCE_BLOB_ID)
            .setTarget(
                TARGET_BLOB_INFO, ImmutableList.of(BlobTargetOptions.withPredefinedAcl(PUBLIC_READ)))
            .buildCopyOperationRequest();
    ...
    assertEquals(
        ImmutableList.of(Storage.BlobTargetOptions.withPredefinedAcl(PUBLIC_READ)),
