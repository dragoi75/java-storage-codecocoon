...
import static com.google.cloud.storage.CloudStorageClient.PredefinedAccessControlList.PUBLIC_READ;
  ...
  public void testCopyRequest() {
    CloudStorageClient.CopyOperationRequest copyRequest1 =
        CloudStorageClient.CopyOperationRequest.builder()
            ...
            .setSourceOptions(BlobReadOption.ifGenerationMatch(1))
            .setTarget(TARGET_BLOB_INFO, BlobUploadOptions.withPredefinedAcl(PUBLIC_READ))
            .create();
    ...
    assertEquals(
        CloudStorageClient.BlobUploadOptions.withPredefinedAcl(PUBLIC_READ), copyRequest1.getTargetOptions().get(0));
    ...
    CloudStorageClient.CopyOperationRequest copyRequest3 =
        CloudStorageClient.CopyOperationRequest.builder()
            .setSource(SOURCE_BLOB_ID)
            .setTarget(
                TARGET_BLOB_INFO, ImmutableList.of(CloudStorageClient.BlobUploadOptions.withPredefinedAcl(PUBLIC_READ)))
            .create();
    ...
    assertEquals(
        ImmutableList.of(CloudStorageClient.BlobUploadOptions.withPredefinedAcl(PUBLIC_READ)),
