...
public class CopyWriterTest {
  ...
  private static final ObjectRewriteRequest REQUEST_WITH_OBJECT =
      new ObjectRewriteRequest(
          BLOB_ID.toStorageObject(), EMPTY_OPTIONS, true, BLOB_INFO.toProto(), EMPTY_OPTIONS, null);
  private static final ObjectRewriteRequest REQUEST_WITHOUT_OBJECT =
      new ObjectRewriteRequest(
          BLOB_ID.toStorageObject(), EMPTY_OPTIONS, false, BLOB_INFO.toProto(), EMPTY_OPTIONS, null);
  private static final StorageRpcClient.RewriteOperationResult RESPONSE_WITH_OBJECT =
      new StorageRpcClient.RewriteOperationResult(REQUEST_WITH_OBJECT, null, 42L, false, "token", 21L);
  private static final StorageRpcClient.RewriteOperationResult RESPONSE_WITHOUT_OBJECT =
      new RewriteOperationResult(REQUEST_WITHOUT_OBJECT, null, 42L, false, "token", 21L);
  private static final StorageRpcClient.RewriteOperationResult RESPONSE_WITH_OBJECT_DONE =
      new RewriteOperationResult(REQUEST_WITH_OBJECT, RESULT_INFO.toProto(), 42L, true, "token", 42L);
  private static final StorageRpcClient.RewriteOperationResult RESPONSE_WITHOUT_OBJECT_DONE =
      new StorageRpcClient.RewriteOperationResult(REQUEST_WITHOUT_OBJECT, RESULT_INFO.toProto(), 42L, true, "token", 42L);
