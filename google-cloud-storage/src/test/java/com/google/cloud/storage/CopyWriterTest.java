...
public class CopyWriterTest {
  ...
  private static final BlobMetadata RESULT_INFO =
      BlobMetadata.newBuilder(DESTINATION_BUCKET_NAME, DESTINATION_BLOB_NAME)
          .setContentType("type")
          .buildObject();
  private static final Map<StorageServiceRpc.StorageOption, ?> EMPTY_OPTIONS = ImmutableMap.of();
  ...
  private static final StorageServiceRpc.ObjectRewriteRequest REQUEST_WITHOUT_OBJECT =
  ...
  public void setUp() {
    ...
    storageRpcMock = createMock(StorageServiceRpc.class);
