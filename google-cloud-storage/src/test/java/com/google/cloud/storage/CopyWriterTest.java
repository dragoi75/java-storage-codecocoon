...
public class CopyWriterTest {
  ...
  private static final StorageRpc.RewriteResult RESPONSE_WITH_OBJECT =
      new StorageRpc.RewriteResult(REQUEST_WITH_OBJECT, null, 42L, false, "token", 21L);
  private static final StorageRpc.RewriteResult RESPONSE_WITHOUT_OBJECT =
  ...
  private static final RewriteResult RESPONSE_WITH_OBJECT_DONE =
      new StorageRpc.RewriteResult(REQUEST_WITH_OBJECT, RESULT_INFO.toPb(), 42L, true, "token", 42L);
