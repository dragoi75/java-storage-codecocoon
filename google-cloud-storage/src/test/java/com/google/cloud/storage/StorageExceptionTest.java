...
public class StorageExceptionTest {
  ...
  public void testStorageException() {
    StorageOperationException exception = new StorageOperationException(500, "message");
    assertEquals(500, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageOperationException(502, "message");
    assertEquals(502, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageOperationException(503, "message");
    assertEquals(503, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageOperationException(504, "message");
    assertEquals(504, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageOperationException(429, "message");
    assertEquals(429, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageOperationException(408, "message");
    assertEquals(408, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageOperationException(400, "message");
    ...
    exception = new StorageOperationException(cause);
    assertNull(exception.getReason());
    ...
    exception = new StorageOperationException(error);
    assertEquals(503, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertTrue(exception.isRetryable());

    exception = new StorageOperationException(400, "message", cause);
    assertEquals(400, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertFalse(exception.isRetryable());
    ...
    exception = new StorageOperationException(httpResponseException);
  ...
  public void testTranslateConnectionReset() {
    StorageOperationException exception =
        StorageOperationException.translateException(
            new SSLException(
  ...
  public void testTranslateAndThrow() throws Exception {
    Exception cause = new StorageOperationException(503, "message");
    RetryHelperException exceptionMock = createMock(RetryHelperException.class);
    expect(exceptionMock.getCause()).andReturn(cause).times(2);
    replay(exceptionMock);
    try {
      StorageOperationException.translateAndRethrow(exceptionMock);
    ...
    try {
      ...
      assertEquals(StorageOperationException.UNKNOWN_CODE, ex.getCode());
      assertEquals("message", ex.getMessage());
