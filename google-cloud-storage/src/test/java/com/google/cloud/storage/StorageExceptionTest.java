...
public class StorageExceptionTest {
  ...
  public void testStorageException() {
    StorageServiceException exception = new StorageServiceException(500, "message");
    assertEquals(500, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageServiceException(502, "message");
    assertEquals(502, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageServiceException(503, "message");
    assertEquals(503, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageServiceException(504, "message");
    assertEquals(504, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageServiceException(429, "message");
    assertEquals(429, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageServiceException(408, "message");
    assertEquals(408, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertTrue(exception.isRetryable());

    exception = new StorageServiceException(400, "message");
    ...
    exception = new StorageServiceException(cause);
    assertNull(exception.getReason());
    ...
    exception = new StorageServiceException(error);
    assertEquals(503, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertTrue(exception.isRetryable());

    exception = new StorageServiceException(400, "message", cause);
    assertEquals(400, exception.getCode());
    assertEquals("message", exception.getMessage());
    assertNull(exception.getReason());
    assertFalse(exception.isRetryable());
    ...
    exception = new StorageServiceException(httpResponseException);
  ...
  public void testTranslateConnectionReset() {
    StorageServiceException exception =
        StorageServiceException.translateToStorageException(
            new SSLException(
  ...
  public void testTranslateAndThrow() throws Exception {
    Exception cause = new StorageServiceException(503, "message");
    RetryHelperException exceptionMock = createMock(RetryHelperException.class);
    expect(exceptionMock.getCause()).andReturn(cause).times(2);
    replay(exceptionMock);
    try {
      StorageServiceException.translateThenThrow(exceptionMock);
    ...
    try {
      ...
      assertEquals(StorageServiceException.UNKNOWN_CODE, ex.getCode());
      assertEquals("message", ex.getMessage());
