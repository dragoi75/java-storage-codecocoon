...
public class StorageRpcTestBaseTest {
  ...
  private static final StorageServiceRpc STORAGE_RPC = new StorageRpcTestBase();
  private static final Map<StorageServiceRpc.StorageOption, Object> OPTIONS = new HashMap<>();
