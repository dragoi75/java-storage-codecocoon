...
public class V4SigningTest {
  ...
  public void test() {
    ...
    BlobMetadata blob = BlobMetadata.newBuilder(testData.getBucket(), testData.getObject()).buildStorageObject();
    ...
    if (testData.getUrlStyle().equals(UrlStyle.VIRTUAL_HOSTED_STYLE)) {
      ...
      style = UrlSigningOption.usePathStyle();
    ...
    final String signedUrl =
        storage
            .signUrl(
                ...
                TimeUnit.SECONDS,
                UrlSigningOption.setHttpMethod(HttpRequestMethod.fromValue(testData.getMethod())),
                UrlSigningOption.withExtraHeaders(testData.getHeadersMap()),
                UrlSigningOption.useV4Signature(),
                UrlSigningOption.withQueryParameters(testData.getQueryParametersMap()),
                style)
            .toString();
