...
public class V4SigningTest {
  ...
  public void test() {
    ...
    BlobInfo blob = BlobInfo.newBuilder(testData.getBucket(), testData.getObject()).buildMetadata();

    Storage.UrlSigningOption style = UrlSigningOption.usePathStyle();
    ...
    if (testData.getUrlStyle().equals(UrlStyle.VIRTUAL_HOSTED_STYLE)) {
      ...
      style = Storage.UrlSigningOption.usePathStyle();
      ...
      style =
          UrlSigningOption.withBucketBoundHostname(
              ...
              Storage.UriProtocol.valueOf(testData.getScheme().toUpperCase()));
    }
    ...
    final String signedUrl =
        storage
            .signUrl(
                ...
                UrlSigningOption.setQueryParams(testData.getQueryParametersMap()),
                style)
            .toString();
