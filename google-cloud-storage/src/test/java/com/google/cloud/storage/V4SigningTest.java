...
public class V4SigningTest {
  ...
  public void test() {
    ...
    UrlSigningOption style = Storage.UrlSigningOption.usePathStyle();

    if (testData.getUrlStyle().equals(UrlStyle.VIRTUAL_HOSTED_STYLE)) {
      style = Storage.UrlSigningOption.usingVirtualHostedStyle();
      ...
      style =
          UrlSigningOption.withBucketBoundHostName(
              ...
              Storage.UrlScheme.valueOf(testData.getScheme().toUpperCase()));
    }
    ...
    final String signedUrl =
        storage
            .signUrl(
                ...
                TimeUnit.SECONDS,
                Storage.UrlSigningOption.withHttpMethod(HttpMethod.valueOf(testData.getMethod())),
                UrlSigningOption.withExternalHeaders(testData.getHeadersMap()),
