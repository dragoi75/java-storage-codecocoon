...
public class V4SigningTest {
  ...
  public void test() {
    ...
    Storage.UrlSigningOption style = Storage.UrlSigningOption.usePathStyle();
    ...
    final String signedUrl =
        storage
            .signUrl(
                ...
                TimeUnit.SECONDS,
                UrlSigningOption.withHttpMethod(HttpMethod.valueOf(testData.getMethod())),
                Storage.UrlSigningOption.withExternalHeaders(testData.getHeadersMap()),
                UrlSigningOption.withV4SignatureScheme(),
