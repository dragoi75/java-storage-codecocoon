...
public class V4SigningTest {
  ...
  public void test() {
    ...
    Storage.UrlSigningOption style = UrlSigningOption.pathStyle();
    ...
    if (testData.getUrlStyle().equals(UrlStyle.VIRTUAL_HOSTED_STYLE)) {
      ...
      style = Storage.UrlSigningOption.pathStyle();
    ...
    final String signedUrl =
        storage
            .signUrl(
                ...
                Storage.UrlSigningOption.withExtraHeaders(testData.getHeadersMap()),
                UrlSigningOption.withSignatureV4(),
                Storage.UrlSigningOption.withQueryParameters(testData.getQueryParametersMap()),
                style)
            .toString();
